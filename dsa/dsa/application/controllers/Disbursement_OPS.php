 ...
 */
  ...
  function save_disbursement_amount_details()
		...
		//echo $_FILES["file"]["name"];
			...
			//==============================================send email to accounts
                       ...
                       //$send_email_to_3_HR='shiv@finaleap.com,priyanka.abdagire@finaleap.com,amit@finaleap.com,vipul@finaleap.com,sachin.kardile@finaleap.com,'.$CM_MAil.',sunil.kalan@finaleap.com';
						$send_email_to_3_HR="suhanidhokrat209@gmail.com";
						...
						$this->email->bcc('info@finaleap.com');
							...
							//echo $mail_data['ModeOfPayment'] ;
							//exit();
							$mail_data['PayeeName']=$customer_name;
							if($mode_of_payment == 'CHEQUE')
		            	{
	...
	public function Customer_view()
		{
			if($this->session->userdata("USER_TYPE") == ''){
				...
				$this->load->view('header', $data);
				$this->load->view('customer/customer_summary');	
			}
		}
	...
	public function signature_D()
	{
		echo $this->input->post('signature_declaration_for');
	...
	public function birth_D()
	{
		echo "birth_D";
	}
	public function language_D()
	{
		echo "language_D";
	}
}
