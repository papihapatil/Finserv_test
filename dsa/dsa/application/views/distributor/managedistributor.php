									   ...
									   <div>
										   <div class="">
											   <div class="row">
												   ...
												   <div class="col-sm-3">
													   <lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Add Distributor&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=distributor">
                                                   ...
                                                   <input type="text" hidden value="<?php echo $s;?>" id="filter">
													   ...
													   <select class="form-control" aria-label="Default select example" name="select_filters" id="select_dropdown_filters_distributors">
...
swal({
  ...
  text: "<?php echo $_SESSION['message'];  unset($_SESSION['title']); unset($_SESSION['message'])   ?>",
  icon: "success",
});
	   ...
	   <script>
        ...
        buttons: [
            'copy', 'csv', 'excel', 'pdf', 'print'
                ...
                'ajax': {
                    //'url':'ajaxfile.php'
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/distributor/listdistributor",
					'data':{filter:filter},
                },
		...
		function approve_status($this)
		{
			...
			var distributor=$('#product_id_'+$this.name).val();
