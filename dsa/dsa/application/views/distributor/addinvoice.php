	...
	<div class="margin-10 padding-5">
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
				<textarea name="remark" id="remark*" class="input-cust-name" readonly><?php echo $Request->remark;?></textarea>
  			...
  			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
				<textarea  class="input-cust-name" readonly><?php echo $Request->remark_by_scfo;?></textarea>
	   ...
	   <?php if($Request->status=="" || $Request->status=="SendBack Action Taken By Retailer" || $Request->status=="Created" ||$Request->status=="SendBack By SCFO")
		{?>
				<div >
		  ...
		  $("#SendBack").click(function(e) 
		        {
					...
					var url = window.location.origin+"/finserv_test/dsa/dsa/index.php/distributor/update_request_status";
					$.ajax({
						type:'POST',
						url:url,
						data:{reques_id:reques_id,status:'SendBack By Distributor',remark:remark},
		  ...
		  $("#reject").click(function(e) 
		        {
					...
					$.ajax({
						type:'POST',
						url:url,
						data:{reques_id:reques_id,status:'Reject By Distributor',remark:remark},
						success:function(data)
						{
							location.reload(true)
							var parsed_data = JSON.parse(data);
