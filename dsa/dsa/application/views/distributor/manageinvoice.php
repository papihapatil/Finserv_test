									   ...
									   <div>
										   <div class="">
											   <div class="row">
												   ...
												   <div class="col-sm-3">
													   <lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Add Invoice&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/distributor/addinvoice?type=invoice">
        ...
        $(document).ready(function(){
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
                    ...
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/distributor/listinvoice",
					'data':{filter:filter},
                },
