...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-118965717-1"></script>
	   ...
	   <form  action="<?= base_url('index.php/credit_manager_user/save_eligibility_salaried')?>"  method="post" enctype="multipart/form-data">
	    <div class="row">
		<div class="col-sm-3"></div>
		<div class="col-sm-6  shadow bg-white" style="padding:20px;border:1px solid black;">
			<center><h3>Salaried</h3></center>
			<br>
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group" style="width:80%;margin-left:40px;">
					<label style="width:80%;margin-left:10px;color:black;">Salary for the month</label>
					<input type="text" class="form-control" name="salary_for_the_month" id ="assessed_income_per_month_salaried" value=""  placeholder="">
					</div>
					<div class="form-group" style="width:80%;margin-left:40px;">
					<label style="width:80%;margin-left:10px;color:black;">Type of salary</label>
					<select class="form-control" name="type_of_salary" id="type_of_salary_salaried">
					...
					<div class="form-group" style="width:80%;margin-left:40px;">
					<label style="width:80%;margin-left:10px;color:black;">FOIR Income</label>
					<input type="text" class="form-control" name="applicable_foir" id ="applicable_foir_salaried" value=""  placeholder="">
					</div>
					<div class="form-group" style="width:80%;margin-left:40px;">
					<label style="width:80%;margin-left:10px;color:black;">Existing Liabilities</label>
					<input type="text" class="form-control" name="existing_liabilities" id ="existing_liabilities_salaried" value=""  placeholder="">
					</div>
					 <div class="form-group" style="width:80%;margin-left:40px;">
					<label style="width:80%;margin-left:10px;color:black;">Property Value</label>
					<input type="text" class="form-control" name="property_value" id ="property_value_salaried" value="" placeholder="">
					</div>
					 	<div class="form-group" style="width:80%;margin-left:40px;">
					LTV(B)
					 <select  id="LTV_dropdown_salaried">
					...
					<input type="text" class="form-control" id ="LTV_B_salaried" name= "LTV_B_salaried" value="" placeholder="">
			        </div>
				...
				<div class="col-sm-6">
				    <div class="form-group" style="width:80%;margin-left:40px;">
					<input type="hidden" name="total_days" id = "perlakh_salaried" value="100000" />
					<label style="width:80%;margin-left:10px;color:black;">ROI</label>
					<input type="text" class="form-control" name="roi"  id ="rate_of_intrest_salaried" value=""  placeholder="" >
					</div>
					<div class="form-group" style="width:80%;margin-left:40px;">
					<label style="width:80%;margin-left:10px;color:black;">Tenure</label>
					<input type="text" class="form-control" name="tenure" id ="tenure_salaried" value=""  placeholder="" >
					</div>
					<div class="form-group" style="width:80%;margin-left:40px;">
					 <label style="width:80%;margin-left:10px;color:black;">EMI Per Lakh </label><span id="total">
					 <input type="text" class="form-control" name="emi_per_lakh" id ="EMI_salaried" value="" placeholder="">
			         </div>
					 <div class="form-group" style="width:80%;margin-left:40px;">
					<label style="width:80%;margin-left:10px;color:black;">Net Income</label>
					<input type="text" class="form-control" name="net_income" id ="net_amount_salaried" value="" placeholder="">
			        </div>
					<div class="form-group" style="width:80%;margin-left:40px;">
					<label style="width:80%;margin-left:10px;color:black;">Loan Amount (A)</label>
					<input type="text" class="form-control" name="loan_amount" id ="Loan_amount_salaried" value=""  placeholder="">
			        </div>
					<div class="form-group" style="width:80%;margin-left:40px;">
					<label style="width:80%;margin-left:10px;color:black;">Minimum of (A) or (B) </label>
					<input type="text" class="form-control" name="minimum_a_b" id ="minimum_a_b_salaried" value="" placeholder="">
					</div>
					 <div class="form-group" style="width:80%;margin-left:40px;">
						<label style="width:80%;margin-left:10px;color:black;">Upload Excel</label>
				</div>
