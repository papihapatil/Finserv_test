...
<?php ini_set('short_open_tag', 'On'); ?>
 <?php
	...
	<div class="margin-10 padding-5">
		...
		<form method="POST" action="<?php echo base_url(); ?>index.php/credit_manager_user/Update_Document_verification" id="">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<?php if(!empty($row_more)){ if($row_more->Vechical_NO_available=='yes'){?>
				       <div style=" margin-top: 8px;" class="col">
						...
						<div class="w-100"></div>
						<div style="margin-left: 35px;  margin-top: 8px;" class="col">
							<input disabled placeholder="" class="input-cust-name" type="text" name="passport_no"   value="<?php if(!empty($row_more)){ echo $row_more->Vechical_Number;}?>">
						</div> 	
					<div style="margin-top: 0px;" class="col">
