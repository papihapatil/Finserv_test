                                ...
                                <div class="row">
                                    <div class="col-sm-12">
											...
											<div class="container">
												...
												<Form action="<?php echo base_url('index.php/Credit_manager_user/do_upload_Technical_doc');?>" method="post" enctype="multipart/form-data" id="Technical_doc_upload">
												<div class="row">
												...
												<?php  foreach($documents as $row){?>
													...
													<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" >
														<div class="row " style="border: 1px solid #edeff1; margin-left:13px; margin-right:13px">
															...
															<div class="col-sm-1"> 	
															<a style="margin-left: 8px; " href="<?php echo base_url();?>index.php/customer/delete_vendor_doc_Technical/<?php echo $row->id; ?>"><i class="fa fa-trash text-right" style="color:red;"></i></a>
												...
												<Form action="<?php echo base_url('index.php/Credit_manager_user/do_upload_Technical_doc');?>" method="post" enctype="multipart/form-data">
												<div class="row">
												...
												<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
													...
													<?php if(!empty($Legal_docs)){if($Legal_docs->Technical_status!='')
													{?>
													...
													<option value="<?php if(!empty($Legal_docs)){ echo $Legal_docs->Technical_id; }?>" selected ><?php if(!empty($cust_info))echo $Legal_docs->Technical_name;?></option>
													  ...
													  <input type="text" id="RCU_name_1" name="RCU_name_1"  value="<?php if(!empty($Legal_docs))echo $Legal_docs->Technical_name; ?>" hidden >
													<?php }else{?>
												...
												<?php if(!empty($Legal_docs)){if($Legal_docs->Technical_status=='Revert From Technical'){?>
													<div class="row">
														<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
														<div style=" margin-top: 8px;" class="col">
															 <label for="email" style="font-size: 16px; color: black; font-weight: bold;"> Technical Comment </label>
															<textarea name="comment_technical" class="form-control"><?php echo $Legal_docs->Technical_comment; ?> </textarea>
												...
												<?php if(!empty($Legal_docs)){if($Legal_docs->Technical_status=='Document Received From Technical')
													{ ?>
												<div class="text-center">
												...
												<?php if(isset($Legal_docs))
																   {
																	   ...
																	   $Conditions_to_Loan_Sanction_2= json_decode($Legal_docs->additional_comments);
																				   ...
																				   <div class="row">
																						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
																						    <div style=" margin-top: 8px;" class="col">
																							<label for="email" style="font-size: 16px; color: black; font-weight: bold;"> Comments From Technical </label>
												...
												<?php }
													...
													<?php	}
													else if($Legal_docs->Technical_status=='Send TO Technical')
														{?>
                                                                <button type="submit" name="revert_action " class="btn btn-primary disabled" >Wating For Technical Reports</button>
														<?php 
														}
														else if($Legal_docs->Technical_status=='Revert Action Taken')
														{?>
                                                                <button type="submit" name="revert_action " class="btn btn-primary disabled" >Revert Action Taken</button>
														<?php
														}
														else if($Legal_docs->Technical_status=='Accepted from Finaleap')
														{?>
                                                                <button type="submit" name="revert_action " class="btn btn-primary disabled" >Accepted from Finaleap</button>
														<?php
														}
														else if($Legal_docs->Technical_status=='Revert From Finaleap')
														{?>
...
$(document).ready(function () {
  ...
  if(comment=='' || comment==' ')
  {
	...
	$("#Technical_doc_upload").submit(function(e) {
									...
									var content='<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">'+
														'<div class="row " style="border: 1px solid #edeff1; margin-left:13px; margin-right:13px">'+
															'<div class="col-sm-10"><a href="'+value.path+'" target="_blank">  <i class="fa fa-file-text" style="color:green" aria-hidden="true"></i> &nbsp; <label for="email" style="font-size: 13px; color: black; font-weight: bold;">'+ value.Doc_name +'</label></a></div>'+
																...
																'<div class="col-sm-1">'+	
															       '<a style="margin-left: 8px; " href="'+window.location.origin+'/finserv_test/dsa/dsa/index.php/customer/delete_vendor_doc_Technical/'+value.id+'"><i class="fa fa-trash text-right" style="color:red;"></i></a>'+
															'</div>'+			
														'</div></div></div>';
