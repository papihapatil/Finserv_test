...
<?php
	...
	<div class="margin-10 padding-5">
		...
		<div style="margin-left: 10px; margin-top: 4px;" class="row">
			<div style="color: black; font-size: 1$data_credit_analysis->verify_obligation =='yes'4px;" class="font-poppins-regular col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">			
			</div>
			<div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
				<div class="row justify-content-center">
	...
	<form method="POST" action="<?php echo base_url(); ?>index.php/credit_manager_user/Update_Credit_Analysis" id="">
				 ...
				 <div class="w-100"></div>
					...
					<div class="row col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="col">
							...
							<div style="margin-left: 35px;  margin-top: 8px;" class="col">
								<input readonly required  class="input-cust-name" type="text" name="foir" id="foir"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->foir;}?>">
							</div>
						</div>							  				
					</div>	
					<div class="row col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="col">
							...
							<div style="margin-left: 35px;  margin-top: 8px;" class="col">
								<input readonly required  class="input-cust-name" type="text" name="eligibility"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->eligibility;}?>">
							</div>
						</div>							  				
					</div>	
			...
			<div class="container">
				<table class="table table-responsive">
					...
					<tbody>
					  <tr>
						<td><b>Month 1</b></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="gross_salary_1" id="gross_salary_1"  value="<?php if(!empty($income_details)){ echo $income_details->ORG_SALARY_1;}?>" onkeyup="cal_avg_salary(); cal_net_salary1() "></td>
						...
						<td><input  required  class="input-cust-name" type="number" step="any" name="any_other_deduction_1" id="any_other_deduction_1"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->any_other_deduction_1;}else{echo '0';}?>" onkeyup="cal_net_salary1()"></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="net_salary_1" id="net_salary_1"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->net_salary_1;}else{echo '0';}?>"></td>
					  </tr>
					  <tr>
						<td><b>Month 2</b></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="gross_salary_2" id="gross_salary_2"  value="<?php if(!empty($income_details)){ echo $income_details->ORG_SALARY_2;}?>" onkeyup="cal_avg_salary(); cal_net_salary2()"></td>
						...
						<td><input  required  class="input-cust-name" type="number" step="any" name="any_other_deduction_2" id="any_other_deduction_2"  value="<?php if(!empty($data_credit_analysis)){ echo  $data_credit_analysis->any_other_deduction_2;}else{echo '0';}?>"  onkeyup="cal_net_salary2()" ></td>
					    <td><input  required  class="input-cust-name" type="number" step="any" name="net_salary_2" id="net_salary_2"  value="<?php if(!empty($data_credit_analysis)){ echo  $data_credit_analysis->net_salary_2;}else{echo '0';}?>" oninput="cal_avg_net_sal()"></td>
					  </tr>
					  <tr>
						<td><b>Month 3</b></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="gross_salary_3" id="gross_salary_3"  value="<?php if(!empty($income_details)){ echo $income_details->ORG_SALARY_3;}?>" onkeyup="cal_avg_salary(); cal_net_salary3()"></td>
						...
						<td><input  required  class="input-cust-name" type="number" step="any" name="any_other_deduction_3" id="any_other_deduction_3"  value="<?php if(!empty($data_credit_analysis)){ echo  $data_credit_analysis->any_other_deduction_3;}else{echo '0';}?>" onkeyup="cal_net_salary3()"></td>
					    <td><input  required  class="input-cust-name" type="number" step="any" name="net_salary_3" id="net_salary_3"  value="<?php if(!empty($data_credit_analysis)){ echo  $data_credit_analysis->net_salary_3;}else{echo '0';}?>"></td>
					  </tr>
					   <tr>
						<td><b>Avrage salary</b></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="avg_salary" id="avg_salary"  value="<?php if(!empty($data_credit_analysis)){ echo  $data_credit_analysis->avg_salary;}?>"></td>
						<td></td>
						...
						<td></td>
					    <td><input  required  class="input-cust-name" type="number" step="any"  name="avg_net_salary" id="avg_net_salary"  value="<?php if(!empty($data_credit_analysis)){ echo  $data_credit_analysis->avg_net_salary;}?>"></td>
					  </tr>
					</tbody>
				</table>
			</div>
					...
					<tbody>
					  <tr class="d-flex">
					   ...
					   <tr class="d-flex">
						...
						<td class="col-2"><input  required  class="input-cust-name" type="number" step="any" name="Fixed_Assets_2" id="Fixed_Assets_2"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->Debtors_2;} else{echo '0';}?>" ></td>
					...
					<table class="table table-responsive justify-content-center">
						...
						?>
						                    <tr>
												...
												<td></td>
												<td>Total</td>
												<td><input disabled readonly  class="input-cust-name" type="text" name="obligation_self"  value="<?php if(!empty($total_obligation)){ echo $total_obligation;}?>"></td>
				...
				<span style="margin-top: 15px; font-size: 16px; color: black; font-weight: bold; margin-bottom: 10px;">Bureau Analysis</span>
				 ...
				 <div class="w-100"></div>
					<div class="row col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="col">
							<div style="margin-left: 35px;  margin-top: 8px;" class="col">
							  <span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-user"></i></span> <span style="color: black; font-size: 12px; font-weight: bold; margin-left: 8px;">	</span>
							</div>
							<div style="margin-left: 35px;  margin-top: 8px;" class="col">
				...
				<table class="table table-responsive">
					...
					<tbody>
					  <tr>
						...
						<td><input  required  class="input-cust-name" type="number" step="any" name="b_s_avg_balance"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->b_s_avg_balance;}?>"></td>
						<td><b>Total Credits</b></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="b_s_total_credits"  value="<?php if(!empty($data_credit_analysis)){echo $data_credit_analysis->b_s_total_credits;}?>"></td>
						<td><b>Total Debits</b></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="b_s_total_debits"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->b_s_total_debits;}?>"></td>
					  </tr>
					  <tr >
						<td><b>Credit Analysis</b></td>
						<td><b>Salary</b></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="b_s_salary"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->b_s_salary;}?>"></td>
						<td><b>Reimbursements</b></td>
						<td><input  required  class="input-cust-name"type="number" step="any" name="b_s_reimbursements"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->b_s_reimbursements;}?>"></td>
					    <td></td>
					  </tr>
					  <tr>
						<td><b>Debit Analysis</b></td>
						<td><b>Household</b></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="b_s_houshold"  value="<?php if(!empty($data_credit_analysis)){echo $data_credit_analysis->b_s_houshold;}?>"></td>
						<td><b>EMI</b></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="b_s_emi"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->b_s_emi;}?>"></td>
					    <td><b>Charges</b></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="b_s_charges"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->b_s_charges;}?>"></td>
						<td><b>Cheque bounce charges</b></td>
						<td><input  required  class="input-cust-name" type="number" step="any" name="b_s_cheque_bounce_charges"  value="<?php if(!empty($data_credit_analysis)){ echo $data_credit_analysis->b_s_cheque_bounce_charges;}?>"></td>
					  </tr>
					...
					<div class="row col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="col">
							...
							<div class="input-cust-name" style=" margin-top: 8px;">
									<div class="row">
										<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
											<input  type="radio" name="verify_residual_income_<?php echo $i; ?>" value="yes" <?php if(!empty($coapp_data_credit_analysis_array)){  if(!empty($coapp_data_credit_analysis_array[$i])){if ($coapp_data_credit_analysis_array[$i]->verify_residual_income == 'yes') echo ' checked="true"';} }?>> yes
										</div>
										<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
											<input  type="radio" name="verify_residual_income_<?php echo $i; ?>" value="no" <?php if(!empty($coapp_data_credit_analysis_array)){ if(!empty($coapp_data_credit_analysis_array[$i])){ if ($coapp_data_credit_analysis_array[$i]->verify_residual_income == 'no' || $coapp_data_credit_analysis_array[$i]->verify_residual_income == '' || $coapp_data_credit_analysis_array[$i]->verify_residual_income == 'NULL') echo ' checked="true"'; }else{echo ' checked="true"';}} else{  echo ' checked="true"'; }?>> No
										</div>
									</div>						
								</div>  					
							</div>
				...
				<table class="table table-responsive">
					...
					<tbody>
					  <tr>
						...
						<td><input  required  class="input-cust-name" type="number" step="any" name="net_salary_1_<?php echo $i;?>" id="net_salary_1_<?php echo $i;?>"   value="<?php if(!empty($coapp_data_credit_analysis_array)){if(!empty($coapp_data_credit_analysis_array[$i])){echo $coapp_data_credit_analysis_array[$i]->net_salary_1;}else{echo 0; }}?>"></td>
					  </tr>
					  <tr>
						<td><b>Month 2</b></td>
						...
						<td><input  required  class="input-cust-name" type="number" step="any" name="net_salary_2_<?php echo $i;?>" id="net_salary_2_<?php echo $i;?>"  value="<?php if(!empty($coapp_data_credit_analysis_array)){if(!empty($coapp_data_credit_analysis_array[$i])){echo $coapp_data_credit_analysis_array[$i]->net_salary_2;}else{echo 0; }}?>"></td>
					  </tr>
					  <tr>
						<td><b>Month 3</b></td>
						...
						<td><input  required  class="input-cust-name" type="number" step="any" name="net_salary_3_<?php echo $i;?>" id="net_salary_3_<?php echo $i;?>"  value="<?php if(!empty($coapp_data_credit_analysis_array)){if(!empty($coapp_data_credit_analysis_array[$i])){echo $coapp_data_credit_analysis_array[$i]->net_salary_3;}else{echo 0; }}?>" ></td>
					  </tr>
					   <tr>
						<td><b>Avrage salary</b></td>
