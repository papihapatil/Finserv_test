										...
										<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" style="border: 1px solid #969696;">
                                            ...
                                            <?php
                                                  ...
                                                  { 
                                                    ...
                                                    {?>
														<?php if($document->doc_cloud_name == '') {  ?>
															<a href="<?php echo base_url();?>images/documents/<?php echo $document->DOC_NAME;?>">View</a>
															<a href="<?php echo base_url();?>images/documents/<?php echo $document->DOC_NAME;?>" target='_blank' download>Download</a>
														<?php } else { ?>
															<a href="<?php echo base_url();?>index.php/customer/view_cloud_file/<?php echo $document->ID; ?>" target='_blank' >View</a> 

															<a href="<?php echo base_url();?>index.php/customer/download_cloud_file/<?php echo $document->ID; ?>" target='_blank' >Download</a> 
														<?php } ?>
                                                     <?php 
                                                     }
                                                   } 
