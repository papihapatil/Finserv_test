	...
	<div >
		<div style="line-height: 40px; margin-left: 10px; margin-top: 20px;" class="row">
			<div style="color: black; font-size: 14px;" class="font-poppins-regular col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
				Tell us about Co-Applicant income
			</div>
									...
									<div class="emis_wrapper">
				  						<fieldset id="emisS_row">
											<div class="emis_row" id="line_1">
										        ...
										        <input min="0" placeholder="Loan Amount" class="other-income-select emis-loan-data" type="number" name="emis_loan_amount" style="width: 17%;" value="<?php if(!empty($row))echo $data_array[$i]->loan_amount;?>">
										        <input min="0" placeholder="Outstanding Loan" class="other-income-select emis-outstanding-data" type="number" name="emis_outstanding_amount" style="width: 17%;" value="<?php if(!empty($row))echo $data_array[$i]->outstanding_amount;?>">
										        <input min="0" placeholder="EMI" class="other-income-select emis-emi-data" type="number" name="emis_emi_amount" style="width: 17%;" value="<?php if(!empty($row))echo $data_array[$i]->emi_amount;?>">
										        <input min="0"  placeholder="Balance Term in Months" class="other-income-select emis-bal_from-data" type="number" name="emis_bal_from_amount" style="width: 17%;" value="<?php if(!empty($row))echo $data_array[$i]->bal_from_amount;?>">
										        <input class="emis_remove other-income-select" type="button" value="DELETE" style="width: 8%; color: red;" >
										    </div>	
										</fieldset>
									</div>
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			...
			<div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<div class="justify-content-center row col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" >
					...
					<div style="margin-left: 35px; margin-top: 8px;" class="col">
						<input maxlength="15" oninput="maxLengthCheck(this)" placeholder="Enter GST number" class="input-cust-name" type="text" <?php if(!empty($row)){if($row->verify_GST_status=='true'){echo 'readonly';}}?> id="business_gst_no" name="business_gst_no" value="<?php if(!empty($row))echo $row->BIS_GST?>">

						<input type="text" id="verify_GST_status" name="verify_GST_status" value="<?php if(!empty($row)){echo $row->verify_GST_status;} ?>" hidden>
					...
					<div class="w-100"></div>
						...
						<div style="margin-left: 35px; margin-top: 8px;" class="col">
							...
							<input  placeholder="Enter PAN" class="input-cust-name" type="text" maxlength="10" <?php if(!empty($row)){if($row->verify_Bis_Pan_status=='true'){echo 'readonly';}}?> name="business_pan" id="business_pan" oninput="maxLengthCheck(this)" value="<?php if(!empty($row))echo $row->BIS_PAN?>">

							<input type="text" id="verify_Bis_Pan_status" name="verify_Bis_Pan_status" value="<?php if(!empty($row)){echo $row->verify_Bis_Pan_status;} ?>" hidden>
				...
				<div class="justify-content-center row col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" >
					...
					<div class="w-100"></div>
					<?php if(!empty($row)){ if( $row->verify_GST_status=='true')
					                                    { ?> 
												 ...
												 <?php   } 
												       elseif( $row->verify_Bis_Pan_status=='true')
													   {?>
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					...
					<div class="w-100"></div>
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  					...
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "01 - ".date('m-Y', strtotime('-3 month'));?>" class="input-cust-name" type="number" name="business_income_1" id="business_income_1" value="<?php if($jsonData!='')echo $jsonData->amount_1;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "07 - ".date('m-Y', strtotime('-3 month'));?>" class="input-cust-name" type="number" name="business_income_2" id="business_income_2" value="<?php if($jsonData!='')echo $jsonData->amount_2;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "14 - ".date('m-Y', strtotime('-3 month'));?>" class="input-cust-name" type="number" name="business_income_3" id="business_income_3" value="<?php if($jsonData!='')echo $jsonData->amount_3;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "21 - ".date('m-Y', strtotime('-3 month'));?>" class="input-cust-name" type="number" name="business_income_4" id="business_income_4" value="<?php if($jsonData!='')echo $jsonData->amount_4;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "28 - ".date('m-Y', strtotime('-3 month'));?>" class="input-cust-name" type="number" name="business_income_5" id="business_income_5" value="<?php if($jsonData!='')echo $jsonData->amount_5;?>">
	  				</div>  
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					...
					<div class="w-100"></div>
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  					...
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "01 - ".date('m-Y', strtotime('-2 month'));?>" class="input-cust-name" type="number" name="business_income_6" id="business_income_6" value="<?php if($jsonData!='')echo $jsonData->amount_6;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "07 - ".date('m-Y', strtotime('-2 month'));?>" class="input-cust-name" type="number" name="business_income_7" id="business_income_7" value="<?php if($jsonData!='')echo $jsonData->amount_7;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "14 - ".date('m-Y', strtotime('-2 month'));?>" class="input-cust-name" type="number" name="business_income_8" id="business_income_8" value="<?php if($jsonData!='')echo $jsonData->amount_8;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "21 - ".date('m-Y', strtotime('-2 month'));?>" class="input-cust-name" type="number" name="business_income_9" id="business_income_9" value="<?php if($jsonData!='')echo $jsonData->amount_9;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "28 - ".date('m-Y', strtotime('-2 month'));?>" class="input-cust-name" type="number" name="business_income_10" id="business_income_10" value="<?php if($jsonData!='')echo $jsonData->amount_10;?>">
	  				</div>  
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					...
					<div class="w-100"></div>
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  					...
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "01 - ".date('m-Y', strtotime('-1 month'));?>" class="input-cust-name" type="number" name="business_income_11" id="business_income_11" value="<?php if($jsonData!='')echo $jsonData->amount_11;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "07 - ".date('m-Y', strtotime('-1 month'));?>" class="input-cust-name" type="number" name="business_income_12" id="business_income_12" value="<?php if($jsonData!='')echo $jsonData->amount_12;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "14 - ".date('m-Y', strtotime('-1 month'));?>" class="input-cust-name" type="number" name="business_income_13" id="business_income_13" value="<?php if($jsonData!='')echo $jsonData->amount_13;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "21 - ".date('m-Y', strtotime('-1 month'));?>" class="input-cust-name" type="number" name="business_income_14" id="business_income_14" value="<?php if($jsonData!='')echo $jsonData->amount_14;?>">
	  					<input min="0" style=" margin-bottom: 10px;" required="true" maxlength="10" oninput="maxLengthCheck(this)" placeholder="<?php echo "28 - ".date('m-Y', strtotime('-1 month'));?>" class="input-cust-name" type="number" name="business_income_15" id="business_income_15" value="<?php if($jsonData!='')echo $jsonData->amount_15;?>">
	  				</div>  
...
$('#continue1').on('click',function(e)
                        {
							...
							{
								e.preventDefault();
								swal("Warning!", "Please Verify PAN OR GSTIN", "warning");
