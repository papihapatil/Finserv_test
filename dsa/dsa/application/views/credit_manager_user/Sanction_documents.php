 ...
 foreach ($employee_arr as $employee)
{
 ...
 if( strlen($employee) !=1 && strlen($employee) !=0) 
 {
...
//print_r($sanction_conditions);
//print_r($sanction_conditions_done);
$legal_conditions_pending = array_diff($legal_conditions,$legal_conditions_done);
//exit();
//=============================================================================================
...
<html>
	...
	<body >
							...
							<section id="section1">
								<div class="col-sm-12">
									<table class="table table-bordered" style="margin-left:-15px;">
										<thead>
											<td style="width:15px">DOCUMENT TYPE</td>
											<td style="width:35px"><?php echo strtoupper($row->FN.' '.$row->LN); ?></td>
											 <?php $i=1; 
													 Foreach($Coapplicant_Doacuments AS $Coapplicant_docs)
														 { 
											 ?>
											<td style="width:30px"><?php echo strtoupper($Coapplicant_docs['FN'].' '.$Coapplicant_docs['LN']);?></td>
											<?php 
											 }?>
										<thead> 
										<tbody>
										<tr>
											...
											{
												?>
												  <span class="glyphicon glyphicon-open" data-toggle="modal" data-target="#myModal2" ></span>&nbsp;&nbsp;
												<?php
											}
											?>
														 BUREAU REPORTS</td>
											...
											{
												?>
												 <span class="glyphicon glyphicon-open" data-toggle="modal" data-target="#myModal" ></span>&nbsp;&nbsp;
												<?php
											}
											?>
																REPORTS</td>
																		...
																		<?php
																		   if(!empty($find_my_legal_documents))
																		   {
																			   ...
																			   ?>
																				...
																				<h5><a href="<?php echo base_url();?>index.php/customer/view_vendors_cloud_file/<?php echo $d->id; ?>" target="_blank"> <i class="fa fa-file-pdf-o text-right" aria-hidden="true" style="color:blue; text-align:right !important "></i>	</a>&nbsp;&nbsp;<?php echo ucwords($d->Doc_name); ?></h5>
											...
											{
												?>
												<span class="glyphicon glyphicon-open" data-toggle="modal" data-target="#myModal3" >&nbsp;&nbsp;
												<?php
											}
											?>
																CAM</td>
											...
											{
												?>
											<span class="glyphicon glyphicon-open" data-toggle="modal" data-target="#myModal6" >&nbsp;
												<?php
											}
											?>
																INCOME DOCUMENTS</td>
											...
											{
												?>
												<span class="glyphicon glyphicon-open" data-toggle="modal" data-target="#myModal3" ></span>&nbsp;&nbsp;
												<?php
											}
											?>
															INCOME ANALYSIS BANK STATEMENT</td>
																<td><?php
											...
											{
												?>
												 <span class="glyphicon glyphicon-open" data-toggle="modal" data-target="#myModal5" ></span>&nbsp;&nbsp;
												<?php
											}
											?>
															PROPERTY DOCUMEENT</td>
																<td>
																<?php 
																	foreach($get_documents  as $value)
																	{
																...
																if(!empty($Sanction_letter_details))
																{
																	if($Sanction_letter_details->Status == "Approved")
																	{
																		if(isset($userType))
																		{
																			...
																			{
																				?>
																					<span class="glyphicon glyphicon-open" data-toggle="modal" data-target="#myModal5_" ></span>&nbsp;&nbsp;<?php
																			}
																		}
																	}
																}
																?>POST SANCTION DOCUMENTS</td>
																<td>
																<lable id="lable_loan_application_form"></lable>
																						<?php
																					  ...
																					  <?php
																					   ...
																					   <?php
																						...
																						?>
																				<lable id="lable_loan_agreement"></lable>
																						<?php
																					  ...
																					  <?php
																						...
																						?>
																					<lable id="lable_loan_signed_sanction_letter"></lable>
																					<?php
																						//print_r($find_my_loan_agreement);
																				 ...
																				 <?php
																				   ...
																				   <?php
																					...
																					?>
																				<lable id="lable_signed_MITC_letter"></lable>
																					<?php
																						//print_r($find_my_loan_agreement);
																				   ...
																				   <?php
																					...
																					?>
																				<lable id="lable_signature_varification"></lable>
																					<?php
																						//print_r($find_my_loan_agreement);
																				  ...
																				  <?php
																				   ...
																				   <?php
																					...
																					?>
																			 <lable id="lable_vernacular_declaration"></lable>
																					<?php
																						//print_r($find_my_loan_agreement);
																				  ...
																				  <?php
																					...
																					?>
																				<lable id="lable_dual_name"></lable>
																					<?php
																						//print_r($find_my_loan_agreement);
																			...
																			<lable id="lable_end_use"></lable>
																				...
																				<lable id="lable_pre_emi"></lable>
																				  ...
																				  <?php
																					...
																					<lable id="lable_pre_emi"></lable>
																					<?php
																					if(!empty($find_my_Pre_CERSAI_letter))
																						{
																							foreach($find_my_Pre_CERSAI_letter as $d)
																							{
																					?>
																					<div id="div_Pre_CERSAI">
																								<a href="<?php echo base_url();?>index.php/customer/view_vendors_cloud_file/<?php echo $d->id; ?>" target="_blank"> <i class="fa fa-file-pdf-o text-right" aria-hidden="true" style="color:blue; text-align:right !important "></i>	</a>&nbsp;&nbsp;<?php echo $d->Doc_name; ?>
																				   	</div>
																				   <?php
																							}
																					...
																					?>
																								<div id="div_Pre_CERSAI">
																								<a> <i class="fa fa-file-pdf-o text-right"aria-hidden="true" style="color:gray; text-align:right !important "></i>	</a>	&nbsp;Pre CERSAI
																								</div>
																				  <?php
																						}
																					?>
											...
											{
												?>
												 <span class="glyphicon glyphicon-open" data-toggle="modal" data-target="#myModal7" ></span>&nbsp;&nbsp;
												<?php
											}
											?>
																...
																<?php $i=1;
																	...
																	?>
																			<i class="fa fa-info-circle" aria-hidden="true" style="color:blue;"   onclick="show_sanction_condition_info(<?php echo $i;?>)"></i>&nbsp;&nbsp;<lable style="font-size:12px;"><?php echo ucwords($SD);?></lable>&nbsp;&nbsp; <span class="glyphicon glyphicon-ok" style="color:green;"></span><br>
																	...
																	if(!empty($sanction_conditions_pending))
																	{
																		foreach($sanction_conditions_pending  as $Sp)
																		{
																			...
																			{
																		?>
																				<i class="fa fa-info-circle" aria-hidden="true" style="color:gray;"></i>&nbsp;&nbsp;<lable style="font-size:12px;"><?php echo ucwords($Sp);?></span> <br>
											...
											{
												?>
												 	<span class="glyphicon glyphicon-open" data-toggle="modal" data-target="#myModal7_" ></span>&nbsp;&nbsp;
												<?php
											}
											?>
																...
																<?php $i=1;
																	...
																	?>
																			<i class="fa fa-info-circle" aria-hidden="true" style="color:blue;"   onclick="show_legal_condition_info(<?php echo $i;?>)"></i>&nbsp;&nbsp;<lable style="font-size:12px;"><?php echo ucwords($SD);?></span>&nbsp;&nbsp; <span class="glyphicon glyphicon-ok" style="color:green;"></span><br>
																			<input hidden type="text" id="legal_condition_for_info_<?php echo $i;?>" value="<?php echo $SD ;?>">
																	<?php
																	$i++;
																    }
																	if(!empty($legal_conditions_pending))
																	{
																		foreach($legal_conditions_pending  as $Sp)
																		{
																			if(!empty($Sp))
																			{
																		?>
																				<i class="fa fa-info-circle" aria-hidden="true" style="color:gray;"></i>&nbsp;&nbsp;<lable style="font-size:12px;"><?php echo ucwords($Sp);?></lable> <br>
																				<input hidden type="text" id="check_pendings_legal" value="False">
																	
																		<?php
																			}
																			else
																			{
																				?><input hidden type="text" id="check_pendings_legal" value="True">
																				<?php
																			}
		...
		<div class="modal fade" id="myModal5" role="dialog">
				...
				<div class="modal fade" id="myModal5_" role="dialog">
					<div class="modal-dialog">
					<!-- Modal content-->
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-body">
							    ...
							    <p>Upload Post Sanction Document:</p>
								<select class="form-control"  id="select_post_sanction_doc_name">
								    <option value="">--Select--</option>
								
									<?php 
										foreach($post_sanction_document_list as $c)
										{
											?>
											<option value="<?php echo $c->Doc_name; ?>" data-toggle="modal" data-target="#loan_application_form_model"><?php echo $c->Doc_name; ?></option>
											<?php
										}
								...
								<br>
							     <p>Select File</p>
								<input type="file"name="selected_property_doc_document" id="selected_post_sanction_document">
								<br>
								<button type="button" class="btn btn-primary" onclick="uplod_post_sanction_documents();">Upload</button>
		...
		<!---------------- added by priya 03-02-2023-------------------------------------------------------------------------------- -->
		<div class="modal fade" id="myModal7_" role="dialog">
			<div class="modal-dialog modal-lg">
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						...
						<select class="form-control"  id="select_legal_condition_name">
						    <option value="">--Select--</option>
							<?php
							$a= $getCustomerSanction_recommendation_details->legal_conditions;
							$employee_arr = explode(PHP_EOL, $a);
						...
						<table class="table table-bordered">
							...
							<tbody>
							  <tr>
								<td><input type="file" id="select_legal_condition_file"></td>
								<td><input type="checkbox" id="is_otc_"></td>
								<td><input type="checkbox" id="is_pdd_"></td>
								<td><input type="checkbox" id="not_applicable_"></td>
							  </tr>
							</tbody>
						</table>
							<lable>OTC date</lable>
							<?php
								...
								$date = date('Y-m-d', strtotime($Date. ' + 15 days'));
							?>
							<input class="form-control" type="date" id="otc_date_" name="otc_date" value="<?php echo $date ;?>">
							<br>
							<lable>Approval Email(OTC/PDD)</lable>
							<input type="file" class="form-control" id="OTC_PDD_document_" name="OTC_PDD_document">
							<br>
							<button type="file" class="btn btn-primary" onclick="uplod_legal_condition_documents();">Save</button>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					</div>
...
function uplod_legal_condition_documents()
{
	//alert("hii");
	var customer_id =document.getElementById('customer_id').value;
	var dsa_id =document.getElementById('dsa_id').value;
	var otc_date =document.getElementById('otc_date_').value;
	var OTC_PDD_document =document.getElementById('OTC_PDD_document_').value;
	var select_legal_condition_name =document.getElementById('select_legal_condition_name').value;
	var otc_date =document.getElementById('otc_date_').value;
		
    var select_legal_condition_file=$('#select_legal_condition_file').val();
	
	
	if(select_legal_condition_name == '')
	{
		swal( "Warning!","Please select legal condition","warning");
		exit();
	}
	if ($('#is_otc_').is(':checked')) 
		{
		  var is_otc = "yes";
	...
	if ($('#not_applicable_').is(':checked')) 
	...
	else
		{
		  var not_applicable = "no";
			...
			if(select_legal_condition_file == '')
			{
				if(OTC_PDD_document == '')
				{
					swal( "Warning!","Please Select Document","warning");
	...
	var fileSelect1 = document.getElementById('select_legal_condition_file');
	var select_legal_condition_file = fileSelect1.files[0];
	
	var OTC_PDD_document=$('#OTC_PDD_document_').val();
	var fileSelect2 = document.getElementById('OTC_PDD_document_');
	var OTC_PDD_document = fileSelect2.files[0];
	
	 let formData = new FormData(); 
	 formData.append("customer_id",customer_id);
	 formData.append("dsa_id",dsa_id);
	 formData.append("select_legal_condition_name",select_legal_condition_name);
	 formData.append("is_otc",is_otc);
	 formData.append("is_pdd",is_pdd);
	 formData.append("not_applicable",not_applicable);
	 formData.append("otc_date",otc_date);
	 formData.append("file1",select_legal_condition_file); 
	 formData.append("file2",OTC_PDD_document);
	 
	  $.ajax({
                     type: "POST",
                     url:'<?php echo base_url("index.php/Credit_manager_user/save_legal_conditions_details"); ?>',
                     data:formData,
                     processData: false,
                     contentType: false,
                     success: function (response) 
								...
								if(obj.Not_applicable  == 'yes')
								 ...
								 if(obj.OTC == 'yes')
								 {
									 if(obj.OTC_PDD_document != '')
									 {
										 if(obj.Documnt_name != '')
										{
											form.innerHTML ='<table class="table table-bordered"><th>Paramenters</th><th>Info.</th><tbody><tr><td>Document</td><td><a href="<?php echo base_url();?>index.php/customer/view_legal_document/'+obj.ID+'" target="_blank" ><i class="fa fa-file-pdf-o text-right" style="color:blue;"></i></a>&nbsp;&nbsp;'+obj.Documnt_name+'</td></tr><tr><td>Is OTC</td><td>'+obj.OTC+'</td></tr><tr><td>OTC Date</td><td>'+obj.OTC_Date+'</td></tr><tr><td>Approval Email(OTC/PDD)</td><td><a href="<?php echo base_url();?>index.php/customer/view_legal_document_approval_email/'+obj.ID+'" target="_blank" ><i class="fa fa-file-pdf-o text-right" style="color:blue;"></i></a>&nbsp;&nbsp;'+obj.OTC_PDD_document+'</td></tr></tbody></table>';
...
function credit_proceed_status()
{
    ...
    var check_pendings_legal = document.getElementById('check_pendings_legal').value;
    if(check_pendings == 'False')
	{
		 swal( "Warning!","Please check all the sanction conditions","warning");
		 exit();
	}
	if(check_pendings_legal == 'False')
	{
		 swal( "Warning!","Please check all the Legal conditions","warning");
		 exit();
	}
	 var customer_id =document.getElementById('customer_id').value;
	 var dsa_id =document.getElementById('dsa_id').value;
...
function uplod_post_sanction_documents()
{

	var select_document_name =document.getElementById('select_post_sanction_doc_name').value;
	var customer_id =document.getElementById('customer_id').value;
	var loan_application_id =document.getElementById('loan_application_id').value;
	var selected_document=  $('#selected_post_sanction_document').val();

	
    var fileSelect = document.getElementById('selected_post_sanction_document');
	var selected_document_ = fileSelect.files[0];
    let formData = new FormData(); 
		formData.append("loan_application_id",loan_application_id);
		formData.append("customer_id",customer_id);
