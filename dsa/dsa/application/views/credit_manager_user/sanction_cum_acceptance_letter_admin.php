												      ...
												      <tr>
												        ...
												        <td>
												        	<select class="form-control" id="nature_of_facility" name="nature_of_facility">
																	  <option value="Msme Term Loan" <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->nature_of_facility == 'Msme Term Loan') echo ' selected="selected"'; ?>>MSME Term Loan</option>
												       ...
												       <tr>
												        ...
												        <td>
												        		<select  name="purpose_of_loan" id="purpose_of_loan" class="form-control"> 
																		  ...
																		  <option value="House Owner (Home Renovation)" <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->purpose_of_loan == 'House Owner (Home Renovation)') echo ' selected="selected"'; ?>>House Owner (Home Renovation)</option>
																		  ...
																		  <option value="Property from Developer / Builder" <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->purpose_of_loan == 'Property from Developer / Builder') echo ' selected="selected"'; ?>>Property from Developer / Builder</option>
																		  <option value="Property from Development Authority" <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->purpose_of_loan == 'Property from Development Authority') echo ' selected="selected"'; ?>>Property from Development Authority</option>
																		  <option value="Resale/ Pre-owned Flat/ Rowhouse" <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->purpose_of_loan == 'Resale/ Pre-owned Flat/ Rowhouse') echo ' selected="selected"'; ?>>Resale/ Pre-owned Flat/ Rowhouse</option>
																		  <option value="Construction of Standalone House on a Plot" <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->purpose_of_loan == 'Construction of Standalone House on a Plot') echo ' selected="selected"'; ?>>Construction of Standalone House on a Plot</option>
																		  <option value="Resale/ Pre-owned Bungalow" <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->purpose_of_loan == 'Resale/ Pre-owned Bungalow') echo ' selected="selected"'; ?>>Resale/ Pre-owned Bungalow</option>
																		   <option value="Business Expand" <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->purpose_of_loan == 'Business Expand') echo ' selected="selected"'; ?>>Business Expand</option>
																	    ...
																	    <tbody>
																	      ...
																	      <tr>
																	      	 ...
																	      	 <td>
																	      	 		<table class="table table-bordered ">
																						    <tbody>
																						      <tr><td><input type="text" class="form-control" id="CERSAI_1" name="CERSAI_1" value="<?php if(!empty($Sanction_letter_details)) {echo $Sanction_letter_details->CERSAI_1 ;} else { echo "₹250/- for loan amount up to ₹5 lakhs"; }?>"></td></tr>
																						      <tr><td><input type="text" class="form-control" id="CERSAI_2" name="CERSAI_2" value="<?php if(!empty($Sanction_letter_details)) {echo $Sanction_letter_details->CERSAI_2 ;} else { echo "₹500/- for loan amount above ₹5 lakhs" ;} ?>"></td></tr>
																	    					</tbody>
																	  					</table>
																	      	 </td>
																	      </tr>
