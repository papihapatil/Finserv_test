						...
						<div class="wizard-header"style="padding:20px;">
		        	  	...
		        	  	<input hidden type="text" name="customer_id" id="customer_id"  value="<?php echo $row->UNIQUE_CODE;?>">
                 			...
                 			<div class="row shadow bg-white rounded margin-10 padding-15 " style="padding:25px;" >
								    		<div class="col-sm-4" >
						        			<h4 style="font-weight:800"><b style="font-size:medium">SANCTION CUM ACCEPTANCE LETTER </b></h4><hr>
				            		</div>
				            		<?php
														if(!empty($Sanction_letter_details))
														{
																...
																if($Sanction_letter_details->Letter_ID!=="")
																{
																	...
																	{
																		?>
																			<p style="color:orange;">Status : Waiting for approval from Finaleap Admin</p>
				            		...
				            		?>
										...
										<!----------------------------------------------------------------------------------------------------------------------- -->
												<div class="col-sm-12">
								   				<div class="col-sm-10">
					        					<h4 style="font-weight:800"><b>APPLICANT NAME</b></h4><hr>
  			            		  </div>
												</div>
												<div class="col-sm-12">
												<div class="col-sm-3">
												...
												<div class="col-sm-12">
								   				<div class="col-sm-10">
					        					<h4 style="font-weight:800"><b>CO-APPLICANT NAME</b></h4><hr>
 			            		   </div>
												</div>
												<div class="col-sm-12">
												<?php
												...
												<div class="col-sm-12">
												    ...
												    <tbody>
												        ...
												        <td>
												        		...
												        		<select class="form-control" id="Branch" name="Branch" >
												        			<option value="" >Select Branch</option>
																	  <option value="HO" <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->Branch == 'HO') echo ' selected="selected"'; ?>>HO</option>
																	  <option value="DHANKAVDI"  <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->Branch == 'DHANKAVDI') echo ' selected="selected"'; ?>>DHANKAVDI</option>
																	  <option value="TALEGAON"  <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->Branch == 'TALEGAON') echo ' selected="selected"'; ?>>TALEGAON</option>
																	   <option value="NAGAR ROAD"  <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->Branch == 'NAGAR ROAD') echo ' selected="selected"'; ?>>NAGAR ROAD</option>
																	   	<option value="BADLAPUR"  <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->Branch == 'BADLAPUR') echo ' selected="selected"'; ?>>BADLAPUR</option>
																	   	<option value="THANE"  <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->Branch == 'THANE') echo ' selected="selected"'; ?>>THANE</option>
																	   		<option value="PANVEL"  <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->Branch == 'PANVEL') echo ' selected="selected"'; ?>>PANVEL</option>
									   								   		<option value="SANGLI"  <?php if(!empty($Sanction_letter_details))if ($Sanction_letter_details->Branch == 'SANGLI') echo ' selected="selected"'; ?>>SANGLI</option>
												      ...
												      <tr>
												        ...
												        <td><input type="number" step="any" class="form-control" id="ffpl_plr" name="ffpl_plr" value="<?php if(!empty($Sanction_letter_details)) echo $Sanction_letter_details->ffpl_plr; ?>"></td>
												      </tr>
												       <tr>
												        <td><b>Rate of Interest (in %)</b></td>
												        <td><input type="number" step="any" class="form-control" id="rate_of_interest" name="rate_of_interest" value="<?php if(!empty($Sanction_letter_details)) echo $Sanction_letter_details->rate_of_interest; ?>"></td>
												      </tr>
												       <tr>
																    ...
																    <tbody>
																      <tr>
																       ...
																       <tr>
																        ...
																        <td><input type="number" class="form-control" id="total_loan_amount" name="total_loan_amount"  value="<?php if(!empty($Sanction_letter_details)) {echo round($Sanction_letter_details->total_loan_amount) ;}?>"></td>
																      </tr>
												        		</tbody>
												        	</table>
												        </td>
												      ...
												      <tr>
												       ...
												       <tr>
												        ...
												        <td><input type="text" class="form-control" id="processing_fees" name="processing_fees"  value="<?php if(!empty($Sanction_letter_details)) {echo round($Sanction_letter_details->processing_fees) ;}?>"></td>
												      </tr>
												       <tr>
																	    ...
																	    <tbody>
																	      <tr>
																	        ...
																	        <td><input type="text" class="form-control" id="MODT" name="MODT" value="<?php if(!empty($Sanction_letter_details)) {echo $Sanction_letter_details->MODT ;} else {echo "As per prevailing State Government Charges" ;}?>"></td>
																						      	...
																						      	<input  hidden type="text" class="form-control" id="CERSAI_1" name="CERSAI_1" value="<?php if(!empty($Sanction_letter_details)) {echo $Sanction_letter_details->CERSAI_1 ;} else { echo "₹250/- for loan amount up to ₹5 lakhs"; }?>">
																												<input hidden type="text" class="form-control" id="CERSAI_2" name="CERSAI_2" value="<?php if(!empty($Sanction_letter_details)) {echo $Sanction_letter_details->CERSAI_2 ;} else { echo "₹500/- for loan amount above ₹5 lakhs" ;} ?>">
												      ...
												      <tr>
												        ...
												        <td><input type="text" class="form-control" id="property_address" name="property_address" value="<?php if(!empty($Sanction_letter_details)) {echo $Sanction_letter_details->property_address ;}  else if(!empty($data_row_applied_loan)) {echo $data_row_applied_loan->PROP_ADD_LINE_1." ".$data_row_applied_loan->PROP_ADD_LINE_2." ".$data_row_applied_loan->PROP_ADD_LINE_3;} ?>"></td>
												      </tr>
												    </tbody>
												  </table>
												  <hr>
														...
														if(!empty($Sanction_letter_details))
														{
																...
																if($Sanction_letter_details->Letter_ID!=="")
																{
																	...
																	<div class="col-sm-12" style="">
																		...
																		<a class="dropdown-item" href="<?php echo base_url()?>index.php/credit_manager_user/Sanction_cum_acceptance_letter_F2?ID=<?php echo $row->UNIQUE_CODE;?>&CM=<?php echo $CM_ID;?>"><button class="login100-form-btn" style="font-weight:700;background-color:#3760e5;color:white;padding:15px;padding-left:55px;padding-right:55px;border-radius:25px;border:none;">Approved by Admin </button></a>
																	...
																	else if($Sanction_letter_details->Status == "Revert")
																	{
																		?>
																		<div class="col-sm-12" style="">
																					<button class="login100-form-btn" style="font-weight:700;background-color:orange;color:white;padding:15px;padding-left:55px;padding-right:55px;border-radius:25px;border:none;" name="save_and_continue_sanction_form_1" id="save_and_continue_sanction_form_1">SAVE AND CONTINUE</button>
								     										</div>
																		<?php
																	}
																	else if($Sanction_letter_details->Status == "Rejected")
																	{
																		?>
																			<a class="dropdown-item" href="<?php echo base_url()?>index.php/credit_manager_user/Sanction_cum_acceptance_letter_F2?ID=<?php echo $row->UNIQUE_CODE;?>&CM=<?php echo $CM_ID;?>"><button class="login100-form-btn" style="font-weight:700;background-color:red;color:white;padding:15px;padding-left:55px;padding-right:55px;border-radius:25px;border:none;">Rejected by Admin </button></a>
																		<?php
																	}
																	else if($Sanction_letter_details->Status == "Submited for Approval")
																	{
...
<script>
        ...
        document.getElementById('total_loan_amount').value= total_loan_amount;
    			...
    			$("#emi").val(emi.toFixed(2));
     			document.getElementById('EMI').value= Math.round(emi.toFixed(2));
															...
															// $('#VERIFY_KYC').removeClass('disabled');
															 swal("success!",obj.response, "success").then(function() { 
															 	//window.location.reload();
															 	  window.location.replace("/finserv_test/dsa/dsa/index.php/credit_manager_user/Sanction_cum_acceptance_letter_F2?ID="+obj.customer_id+"&CM="+obj.CM_ID);  
															 	 });
