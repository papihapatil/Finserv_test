...
<div >
        <div class="container">
            <div class="row">
				...
				<a style="margin-left: 9px; background-color: #25a6c6;margin :-4px;padding:6px;" href="<?php echo base_url()?>index.php/admin/new_loan_type"  class="btn btn-info" style="background-color: #25a6c6;">Add New Loan Type</a>
          	</div>
				...
				<div class="card mb-3">
				  <div class="row no-gutters" style="padding: 10px;">
				    ...
				    <div class="col-xl-9 col-lg-8.5 col-md-8.5 col-sm-8.5 col-8 align-self-center" style="margin-left: 10px;">
				      Loan Type : <b><?php echo $Loan_type->loan_type;  ?></b>				        
				    </div>
				    <div class="col-xl-0.5 col-lg-0.5 col-md-0.5 col-sm-0.5 col-0.5 align-self-center">
				    	<button data-toggle="modal" data-id = "<?php echo $Loan_type->id;?>" data-target="#deleteModel"><i class="fa fa-trash"></i></button>
				    </div>
				  </div>
				</div>	
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                ...
	                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/admin/delete_Loan_type" method="POST" id="admin_loan_type_delete_form">
	                  <div class="form-group">
	                    <label  class="col-12 control-label padding-10">Are you sure you want to DELETE this Loan type ?</label>	                    
