...
-->
						...
						<div class="row col-md-12 col-sm-12 col-xs-12 col-lg-12 col-xl-12 ">
							<div class="container">
								<div class="row col-md-12 col-sm-12 col-xs-12 col-lg-12 col-xl-12 main">
									...
									<div class="row col-md-4 col-sm-4 col-xs-4 col-lg-4 col-xl-4 Internal_nav" id="UPI">UPI / Net Banking Payment</div>
									<div class="row col-md-4 col-sm-4 col-xs-4 col-lg-4 col-xl-4 Internal_nav" id="Cheque">	Cheque Payment</div>
									<div class="row col-md-4 col-sm-4 col-xs-4 col-lg-4 col-xl-4 Internal_nav" id="Cash">Cash Payment</div>
											...
											<div class="row no-gutters">			    
												<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 col-xl-12">
															  ...
															  <?php if(isset($payment_details))
																	{ 
																		if($payment_details->payment_status=='Successful')
																		{
															  ?>  <div class="card-body">
													
																		<div class="row justify-content-center">
																			<h2 class="text-center" style="color:#28a745;"> Payment is Done Successfully</h2>
																				</div>
																					</div>
															  <?php 	}
																		else
															   ...
															   <div class="card-body">
																		...
																		<div class="row justify-content-center">
																			<h2 class="text-center" style="color:#d62122;">Your Payment is Fail</h2>
																			</div>
																					</div>
															   <?php 	} 
																	}?>
															  ...
															  <?php if(isset($result))
															   ...
															   ?>  
															    <div class="card-body">
																<div class="row justify-content-center">
															   <h2 class="text-center" style="color:#28a745;"> Cheque details are save successfully Do not Proceed till Payment recieved date not updated by Accounts Department </h2>
															   	</div>
																					</div>
															   <?php 	}
																		else
																		{  
																		   ...
																		   <div class="card-body">
																<div class="row justify-content-center">
																				<h2 class="text-center" style="color:#d62122;">Something get Wrong in saving data</h2>
																					</div>
																					</div>
															  <?php 		} 
																		} 
 ...
 <div class="card-body">
																<div class="row justify-content-center">															  
															  <h2 class="text-center" style="color:#28a745;"> payment details are save successfully Do not Proceed till Payment recieved date not updated by Accounts Department</h2>
															  	</div>
																					</div>
															  <?php 				}
																					else
	   ...
	   <form action="<?php echo base_url(); ?>index.php/admin/offline_payment" method="POST"  style="margin-left:auto; margin-right:auto;" id="offline_payment">
		...
		<div id="upi_mode" style="display:none;">
					...
					<form action="<?php echo base_url(); ?>index.php/admin/offline_payment_upi" method="POST"  style="margin-left:auto; margin-right:auto;" id="upi_payment">
	                  ...
	                  <!-- Modal Footer -->
			           <?php
					   if(isset($get_payment_deteils_offline))
					      {
						        if(!empty($get_payment_deteils_offline))
								{
									?>
									 <button class="btn btn-primary" >
									   verification is pending from accounts department
									</button>
									<?php
								}
								else
