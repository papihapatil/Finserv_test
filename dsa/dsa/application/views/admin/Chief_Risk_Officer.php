															...
															<div class="row">
																<?php if(isset($data))
						 										 ...
						 										 if(count($data) != 0) 
																	...
																	<div class="add">
																		<lable style=" padding: 7px;border:1px solid #ccc;font-weight:bold;">  Add Chief Risk Officer Head&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=Chief_Risk_Officer">
