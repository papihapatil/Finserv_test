										   ...
										   <div class="">
											   <div class="row">
													 ...
													 <div class="col-sm-3" style="padding-left:-1px;">
													   <label style=" padding: 7px;border:1px solid #ccc;font-weight:bold;">Total&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=customer_consent">
																...
																<thead>
																	<tr>
																	  <th>Sr No.</th>
																	   ...
																	   <th>Dsa /Connector Mobile No</th>
																	 
																	   <th>Dsa /Connector Office Name</th>
																	   <th>Dsa /Connector Address</th>
																	   <th>Any file disbussed</th>
																	 
																	   <th>Name reffered by Dsa</th>
																	   <!-- <th>GONOGO</th> -->
																	   <th>Dsa Onboarding</th>
																	   <th>Meeting Photo</th>
																	   <th>Revisit date</th>
																	   <th>Remarks</th>
																	  <!--  <th>loan</th>-->
	   ...
	   <script>
        $(document).ready(function(){
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
                    //'url':'ajaxfile.php'
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/Admin/Branch_dsavisit_PG",
					'data':{filter:filter},
                },
