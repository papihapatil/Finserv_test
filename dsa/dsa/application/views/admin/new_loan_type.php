...
<title>Finaleap | Add Loan Type</title>
...
<div class="col-sm-12">
	...
	<div class="row justify-content-center">
		<div >
			<div >
				<form class="login100-form validate-form" action="<?php echo base_url(); ?>index.php/admin/new_loan_type_action" method="POST" id="new_loan_type_form">
					...
					<div class="wrap-edit validate-input" >
						<input class="input100" type="text" name="loan_type" placeholder="Enter Loan Type" required>
