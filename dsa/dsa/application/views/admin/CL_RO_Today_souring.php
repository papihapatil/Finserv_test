...
<div class="c-body">
																...
																<?php if(isset($customers))
						 										 ...
						 										 if($customers != 0) 
						  											...
						  											<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right:0px;margin-right:0px;">
						   												<lable style=" padding: 7px;border:1px solid #ccc;font-weight:bold;">  Total <?php echo $today; ?>&nbsp;&nbsp;<a href="<?=base_url('index.php/BranchManager/save_excel')?>">
						  												 <i class="fa fa-download "style='font-size:20px; color:green;'></i></a></lable>
						   												<?php $excelData = json_decode(json_encode($today), true);?>
						  											</div>
						 									 		<?php  } 
				         											 else
						 											 {?>
						   											<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right:0px;margin-right:0px;" >
						   												<lable style=" padding: 7px;border:1px solid #ccc;font-weight:bold;">  Total <?php if(isset($today)) {echo $today;}else {echo 0;} ?>&nbsp;&nbsp;<a href="<?=base_url('index.php/BranchManager/save_excel')?>">
						   												<i class="fa fa-download "style='font-size:20px; color:green;'></i></a></lable>
																	</div>
																	<?php     } 
			           												} 
					                                      ...
					                                      <!-- <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
					                                           <div style=" margin-top: 8px;" class="col">
					                                            <label for="email" style="font-size: 16px; color: black; font-weight: bold;">Start Date</label>
					                                             <input  class="form-control Start_Date"  type="date" name="Start_Date" id="Start_Date_filters"   value="<?php if(isset($_GET['Start_Date'])){echo $_GET['Start_Date'];}else{echo  date('01-m-Y');}?>" >
					                                          </div>  
					                                       </div> -->
					                                    ...
					                                    <!--   <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
					                                           <div style=" margin-top: 8px;" class="col">
					                                            <label for="email" style="font-size: 16px; color: black; font-weight: bold;">End Date</label>
					                                             <input  class="form-control"  type="date" name="End_Date" id="End_Date_filters"  value="<?php  if(isset($_GET['End_Date'])){echo $_GET['End_Date'];}else{echo  date('t-m-Y');}?>" >
					                                          </div>  
					                                       </div>--> 
																		...
																		<table id="empTable" class="display" style="width:100%">
																			<thead>
																				<tr>
																					...
																					<th>Employee Name</th>
																					<th>Meeting date</th>
																			<th>Dsa /Connector Name</th>
																		   
																		  <th>Dsa /Connector Mobile</th>
																		   <th>Dsa /Connector Office Name</th>
       ...
       $(document).ready(function(){
		   var Start_Date=document.getElementById("start_date1").value;
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
                    //'url':'ajaxfile.php'
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/Cluster_Manager/CL_RO_today_sourings",
		  ...
		  $( "#Start_Date_filters" ).change(function()
      {
       ...
       var range=$('#Billing_months').val();
         ...
         window.location.replace("/finserv_test/dsa/dsa/index.php/Cluster_Manager/Today_souring?Start_Date="+Start_Date+"&End_Date="+End_Date+"&range="+range);
  ...
  
      {
        ...
        var el_down = document.getElementById("Start_Date");
          ...
          //$('#End_Date').prop('readonly', true);
                  window.location.replace("/finserv_test/dsa/dsa/index.php/Cluster_Manager/Today_souring?Start_Date="+firstDay+"&End_Date="+lastDay+"&range="+range);
      }
      if(value=='Previous_Month')
    ...
    $( "#select_filters_customers_admins" ).change(function()
      ...
      {
         $("#Billing_months").val("Current_Month");
        var el_down = document.getElementById("Start_Date");
           var date = new Date();
          // document.write("Current Date: " + date );
           var firstDay = new Date(date.getFullYear(), date.getMonth(), 1);
