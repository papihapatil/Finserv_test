  ...
  function get_area_managers_CM($id)
	...
	//----------------------added by pooja----------------------//
	  ...
	  public function update_leadform($id,$data)
	  {
		...
		public function get_all_dsavisit()
	{
		    $this->db->select('count(*) as count ');
		...
		public function get_all_customers_Admin_filters($searchValue,$Start_Date,$End_Date)
			{
            $this->db->select('count(*) as count');
		 ...
		 public function get_all_customers_Admin_filter_paginations($searchValue,$columnName,$columnSortOrder,$row,$rowperpage,$Start_Date,$End_Date)
			{
              $this->db->select('*');
             $this->db->from('dsavisit');
		...
		public function current_month($Start_Date,$End_Date){
