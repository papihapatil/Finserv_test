							...
							<div class="card-body">
							    <div class="row"  style="font-size:13px;margin-bottom:1%;" >
									...
									<div class="col-sm-2" ><u>Updated on: </u>&nbsp;<?php $d1=date("d-m-Y", strtotime($row_more->last_updated_date)); echo $d1;?></div>
									    ...
									    <div class="col-sm-3" ><u>Login Fees: </u>&nbsp;
											<?php
												if(!empty($payments))
												{
													if(!empty($payments->Payment_Recived_date))
														{
															...
															echo "Rs.".preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",round($payments->Amount))." (".$d.")";
														}
													else
														{
											?>
										...
										<div class="col-sm-3" ><u>Processing Fees: </u>&nbsp;
											<?php
												if(!empty($getCustomerSanction_letter_details))
												{
													if(!empty($getCustomerSanction_letter_details->payment_recived_date))
													{
														...
														echo "Rs.".preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",$getCustomerSanction_letter_details->processing_fee_amount)." (".$d.")";
													}
													else
													{
											?>
								...
								<div class="row"  style="font-size:13px;border-bottom:1px solid black;border-top:1px solid black;" >
									...
									<div class="col-sm-2" style="border-right:1px solid gray;">
										<u><p>Stage</p></u>
										<h6><b><?php if(!empty($row)) { if(!empty($row->Stage)) {echo $row->Stage;  }else { echo "NA";}}?></b></h6>
									</div>
									<div class="col-sm-2" style="border-right:1px solid gray;">
										<u><p>Sub Stage</p></u>
										<h6><b><?php if(!empty($row)) { if(!empty($row->Sub_Stage)) {echo $row->Sub_Stage;  }else { echo "NA";}}?></b></h6>
									...
									<div id="document_vault_" style="display:none;border-top:1px solid black;">
										<h5 id="">Document Vault</h5>
											<div class="tab">
											  ...
											  <button class="tablinks" onclick="openCity(event, 'AssetDocuments')">Case Reports</button>
																		...
																		<br>
																		   ...
																		   if(!empty($find_my_Court_case_documents))
																		   {
																				foreach($find_my_Court_case_documents as $d)
																					{
																						echo ucwords("Court case /Background Verification documents"); 
																						break;
																					}
																		   }
																		   else
																		...
																		<br>
																		   ...
																		   if(!empty($find_my_Legal_Document_Search_documents))
																		   {
																				foreach($find_my_Legal_Document_Search_documents as $d)
																					{
																					echo ucwords("Legal Document Search"); 
																					break;
																					}
																		   }
																		   else
																  ...
																  if(!empty($find_my_legal_documents))
																   {
																	foreach($find_my_legal_documents as $d)
																		{
															?>
															<span style="color:green;font-size:9px;">Available</span>	
														  <?php
														  break;
																			}
																	   }
															     ...
															     if(!empty($find_my_technical_documents))
																   {
															 		foreach($find_my_technical_documents as $d)
																		{
															  ?>
															<span style="color:green;font-size:9px;">Available</span>	 <?php
															             break;
																		}
																   }
																		   else
																		...
																		<tbody>
																		  ...
																		  ?>
																			<tr>
																				...
																				<td>
																				<?php
																					if($data_row_more->STATUS == 'Loan Sanctioned' && $data_row_more->STATUS == 'Disbursed')
																					{
																				?>
																				...
																				<?php																				
																					...
																					{
																				?>
																				   <span style="color:red;font-size:9px;">Not Generated</span>
																					<br>
																					<span style="color:red;font-size:9px;">Not Generated</span>
																					<br>
																					<span style="color:red;font-size:9px;">Not Generated</span>
																			...
																			?>
																				...
																				<?php
																					...
																					{
																				?>
																					<span style="color:green;font-size:9px;">Generated</span>
																					<br>
																					<span style="color:green;font-size:9px;">Generated</span>
																					<br>
																					<span style="color:green;font-size:9px;">Generated</span>
