        									...
        									<div class="">
												<div class="row">
                                                    ...
                                                    <input type="text" hidden value="<?php echo $s;?>" id="filter">
														...
														<select class="form-control" aria-label="Default select example" name="select_filters" id="select_dropdown_filters_dsa_branch">
	   ...
	   <script>
        $(document).ready(function(){
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
                    //'url':'ajaxfile.php'
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/Admin/Branch_dsa_PG",
					'data':{filter:filter},
                },
