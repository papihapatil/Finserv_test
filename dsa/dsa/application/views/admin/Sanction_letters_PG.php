												...
												<div class="row">
					                                ...
					                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
					                                     <div style=" margin-top: 8px;" class="col">
					                                         ...
					                                         <select class="form-control" aria-label="Default select example" name="select_filters" id="select_filters_for_sanction_files">
																<option>Select Filter</option>
																<option value="All" <?php if(isset($filter_by)){if($filter_by=='All'){echo 'selected';}} ?>>All</option> 
																<option value="SubmitedforApproval" <?php if(isset($filter_by)){if($filter_by=='SubmitedforApproval'){echo 'selected';}} ?>>Submited for Approval</option>
																<option value="Approved" <?php if(isset($filter_by)){if($filter_by=='Approved'){echo 'selected';}} ?>>Approved</option> 
															 </select>
					                                     </div> 
                                                         <input type="text"  hidden  value="<?php if(isset($filter_by)){echo $filter_by;}?>" id="filter" name="filter">															  
					                                 </div> 
