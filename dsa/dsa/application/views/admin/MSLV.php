									...
									<div class="col-sm-12">
											...
											<table class="table">
											  ...
											  <tbody>
												...
												<tr>
											      <td></td>
											      <td style="text-align:center;"><button type="submit" value="submit" name="submit" class="btn btn-info" style="margin-top:14%;" >Update</button> 
												  &nbsp; &nbsp; <a href="https://finaleap.com/finserv_test/dsa/dsa/index.php/admin/dashboard"> <button type="button" value="Back" name="back"  class="btn btn-info" style="margin-top:14%;" >Back</button></a>
												  </td>
												<td></td>
											    </tr>
											  </tbody>
