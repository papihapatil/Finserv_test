...
<div >
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12 margin-top-15" style="margin-bottom:18px;">
                	Filter By : 
                	
                	<?php if($userType != 'NONE') { ?>
						<a  href="<?php echo base_url()?>index.php/Admin/loan_application_status?s=all"  style="margin-left: 9px; background-color: #25a6c6;margin :2px;padding:6px;"  class="btn btn-info" style="background-color: #25a6c6;">ALL</a>
						<a   href="<?php echo base_url()?>index.php/Admin/loan_application_status?s=Accepted"  style="margin-left: 9px; background-color: #25a6c6;margin :2px;padding:6px;"  class="btn btn-info" style="background-color: #25a6c6;">Accepted</a>
						<a  href="<?php echo base_url()?>index.php/Admin/loan_application_status?s=Rejected"  style="margin-left: 9px; background-color: #25a6c6;margin :2px;padding:6px;"  class="btn btn-info" style="background-color: #25a6c6;">Rejected</a>
						<a  href="<?php echo base_url()?>index.php/Admin/loan_application_status?s=Progress"  style="margin-left: 9px; background-color: #25a6c6;margin :2px;padding:6px;"  class="btn btn-info" style="background-color: #25a6c6;">In Progress</a>
						<a  href="<?php echo base_url()?>index.php/Admin/loan_application_status?s=hold"  style="margin-left: 9px; background-color: #25a6c6;margin :2px;padding:6px;"  class="btn btn-info" style="background-color: #25a6c6;">On Hold</a>
...
<?php foreach($customers as $row){?>
	...
	<div class="row justify-content-center">
		...
		<div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9" style="margin-bottom:10px;">
		...
		<?php if(isset($row->loan_status))
			...
			<?php	
				...
				{
			?>
			<a style="margin-left: 8px; margin-top:10px;" target='_blank'  class="btn border border-danger">Rejected</a>
			...
			<?php		
				...
				{
			?>
			 <a style="margin-left: -17px; margin-top:10px;" target='_blank' class="btn border border-primary">On Hold</a>
      		<?php	
				}
		?>
	  ...
	  <?php
		...
		{
		?>
		 <a style="margin-left:-16px; margin-top:10px;" target='_blank' class="btn border border-primary">Not Checked</a>
