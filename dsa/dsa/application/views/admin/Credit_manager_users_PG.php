										...
										<div >
        												<div class="">
															...
															<div class="col-sm-3" style ="margin-bottom:35px;">
																		<lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Add Credit Manager<a  href="<?php echo base_url()?>index.php/dsa/new_customer?type=credit_manager_user" >
...
<script >
   ...
   var select_dropdown_filters_credit_managers_admin = document.getElementById('select_dropdown_filters_credit_managers_admin').value;
       // alert(select_dropdown_filters_HR_admin);
		   ...
		   {
	         window.location.replace("/finserv_test/dsa/dsa/index.php/admin/credit_manager_user?s=all");
		   }
		   else if(select_dropdown_filters_credit_managers_admin == 'Complete')
		   {
			       window.location.replace("/finserv_test/dsa/dsa/index.php/admin/credit_manager_user?s=Complete");
		   }
		   else if((select_dropdown_filters_credit_managers_admin == 'Incomplete'))
		   {
			       window.location.replace("/finserv_test/dsa/dsa/index.php/admin/credit_manager_user?s=Incomplete");
         ...
         $(document).ready(function(){
			var filter = document.getElementById("filter").value;
             ...
             $('#empTable').DataTable({
                 ...
                 'ajax': {
                     //'url':'ajaxfile.php'
                     'url':window.location.origin+"/finserv_test/dsa/dsa/index.php/Admin/customer_with_paginations_Credit",
					 'data':{filter:filter},
                 },
                 'columns': [
