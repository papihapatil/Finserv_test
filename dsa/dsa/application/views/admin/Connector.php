																...
																<?php if(isset($data))
						 										 ...
						 										 if(count($data) != 0) 
						  											...
						  											<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right:0px;margin-right:0px;">
						   													<?php if($row->ROLE ==5) {?>
																	  <lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  TOTAL <?php echo count($data); ?>&nbsp;&nbsp;<a href="<?=base_url('index.php/admin/download_Excel_user?data_for=Connector')?>">
																	...
																	<div class="col-sm-2" >
																		<select class="form-control" aria-label="Default select example" name="select_filters" id="select_dropdown_filters_connector_admin">
					...
					<?php if($row->ROLE != 8) {?>
						<div class="col-sm-3">
                            <form id="credit_saction_form" method="post">
	     			                    <select class="form-control" aria-label="Default select example" name="" id="select_category" >
						...
						<div class="col-sm-3">
                            <form id="credit_saction_form" method="post">
										...
										<select class="form-control" aria-label="Default select example"  id="options_display">
																		...
																		<table id="example" class="display" style="width:100%">
																			...
																			<tbody>
																				...
																				<tr>
																					...
																					<td><?php echo $row->Refer_By_Name."[".$row->Refer_By_Category."]"; ?></td>
																					...
																					<?php  
																						...
																						{
																							?>
																								<a href="<?php echo base_url()?>index.php/dsa/profile?id=<?php echo $row->UNIQUE_CODE;?>" class="btn modal_test"><i class="fa fa-eye text-right" style="color:blue;"></i></a>
																					&nbsp;&nbsp;
																						...
																						{
																							?>
																								<a  class="btn "><i class="fa fa-eye text-right" style="color:gray;"></i></a>
																					&nbsp;&nbsp;
																								<a style="margin-left: 8px; " class="btn "><i class="fa fa-trash text-right" style="color:gray;"></i></a>
