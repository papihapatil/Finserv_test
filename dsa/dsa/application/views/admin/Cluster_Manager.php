															...
															<div class="row">
																<?php if(isset($data))
						 										 ...
						 										 if(count($data) != 0) 
																	...
																	<div class="col-sm-2" >
																		<select class="form-control" aria-label="Default select example"  id="select_dropdown_filters_admin" onchange="select_dropdown_filters_admin();">
...
<script type="text/javascript">
   ...
   var select_dropdown_filters_admin = document.getElementById('select_dropdown_filters_admin').value;
       // alert(select_dropdown_filters_HR_admin);
		   ...
		   {
	         window.location.replace("/dsa/dsa/index.php/admin/Cluster_Manager?s=all");
		   }
		   else if(select_dropdown_filters_admin == 'Complete')
		   {
			       window.location.replace("/dsa/dsa/index.php/admin/Cluster_Manager?s=Complete");
		   }
		   else if((select_dropdown_filters_admin == 'Incomplete'))
		   {
			       window.location.replace("/dsa/dsa/index.php/admin/Cluster_Manager?s=Incomplete");
