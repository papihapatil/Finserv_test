															...
															<div class="row">
																<?php if(isset($data))
						 										 ...
						 										 if(count($data) != 0) 
																	...
																	<div class="add">
																		<lable style=" padding: 7px;border:1px solid #ccc;font-weight:bold;">  Add Regional Manager&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=Regional_Manager">
