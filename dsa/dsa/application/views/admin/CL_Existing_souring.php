...
<div class="c-body">
																...
																<?php if(isset($customers))
						 										 ...
						 										 if($customers != 0) 
						  											...
						  											<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right:0px;margin-right:0px;">
						   												<lable style=" padding: 7px;border:1px solid #ccc;font-weight:bold;">  Total <?php echo $customers; ?>&nbsp;&nbsp;<a href="<?=base_url('index.php/BranchManager/Existing_excel')?>">
       ...
       $(document).ready(function(){
		   var Start_Date=document.getElementById("start_date1").value;
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
                    //'url':'ajaxfile.php'
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/Cluster_Manager/CL_Existing_sourings",
		  ...
		  $( "#Start_Date_filters" ).change(function()
      {
       ...
       var range=$('#Billing_months').val();
         ...
         window.location.replace("/finserv_test/dsa/dsa/index.php/Cluster_Manager/CL_Existing_souring?Start_Date="+Start_Date+"&End_Date="+End_Date+"&range="+range);
  ...
  
      {
        ...
        var el_down = document.getElementById("Start_Date");
          ...
          //$('#End_Date').prop('readonly', true);
                  window.location.replace("/finserv_test/dsa/dsa/index.php/Cluster_Manager/CL_Existing_souring?Start_Date="+firstDay+"&End_Date="+lastDay+"&range="+range);
      }
      if(value=='Previous_Month')
