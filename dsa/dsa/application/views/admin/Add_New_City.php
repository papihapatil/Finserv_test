...
<title>Finaleap | Add New City</title>
...
<div class="col-sm-12">
	...
	<div class="row justify-content-center">
		<div >
			<div >
				<form class="login100-form validate-form" action="<?php echo base_url(); ?>index.php/admin/add_new_city_action" method="POST" id="add_new_city_action">
					...
					<div class="wrap-edit validate-input" >
						<input class="form-control" type="text" name="city_name" placeholder="Enter City Name" required>
