...
<div class="col-sm-12">
	...
	<div class="row justify-content-center">
		<div >
			<div >
				<form class="login100-form validate-form" action="<?php echo base_url(); ?>index.php/admin/new_admin_bank_action" method="POST" id="new_admin_bank_form">
					...
					<div class="wrap-edit validate-input" >
						<input class="input100" type="text" name="bank_name" placeholder="Enter bank name" required>
