	...
	<div >
		...
		<?php if($type == 'salaried') { ?>
			...
			<div class="row shadow bg-white rounded margin-10 padding-15">
				...
				<!-- <div class="row justify-content-center col-12">
					<span style="margin-top: 15px; font-size: 16px; color: black; font-weight: bold;">Are you working at client location?</span>

				</div>
				<div class="row justify-content-center col-12">
					<span style="margin-top: 15px; font-size: 14px; color: black; font-weight: bold;" >Yes <input type="radio"  <?php if(!empty($row) && $row->clientlocation == 'Yes') { echo "checked"; } ?> name="clientlocation" value="Yes"> No <input type="radio" name="clientlocation" <?php if(!empty($cust_row) && $row->clientlocation == 'No') { echo "checked"; } ?> value="No"></span>
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					...
					<div class="w-100"></div>
	  				...
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  					<input placeholder="Enter landmark" class="input-cust-name" type="text" name="salaried_org_landmark"   value="<?php if(!empty($row))echo $row->ORG_LANDMARK?>">
	  				</div>  
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-top: 10px;" class="col">
					<span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-map-signs"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Are you working with third party? *</span>
				</div>			
				<div class="w-100"></div>
  				
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					Yes <input type="radio"  <?php if(!empty($row) && $row->clientlocation == 'Yes') { echo "checked"; } ?> name="clientlocation" value="Yes"> No <input type="radio" name="clientlocation" <?php if(!empty($row) && $row->clientlocation == 'No') { echo "checked"; } ?> value="No">
  				</div> 
				
				
				<div <?php if(!empty($row) && $row->clientlocation == 'Yes') { $display = "block"; } else { $display = "none"; } ?> style="margin-top: 10px;display: <?php echo $display; ?>;" class="col" id="clientnamediv" >
					<span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-map-signs"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Third party payroll </span>
				</div>			
				<div class="w-100"></div>
  				
  				<div <?php if(!empty($row) && $row->clientlocation == 'Yes') { $display = "block"; } else { $display = "none"; } ?> style="margin-left: 35px; margin-top: 8px;display: <?php echo $display; ?>;" id="clientnameinputdiv" class="col" style="display: block;" >
  					<input  placeholder="Client Name" style="s" class="input-cust-name" name="clientname" id="clientname" value="<?php if(!empty($row))echo $row->clientname;?>">
  				</div> 
		...
		<?php if($type == 'business') { ?>	
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input   placeholder="Enter landmark " class="input-cust-name" type="text" name="business_landmark" id="business_landmark" value="<?php if(!empty($row))echo $row->ORG_LANDMARK?>">
  				</div>  			  				
...
<div class="row shadow bg-white rounded margin-10 padding-15"  id="ITR_no_div">
				...
				<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" >
					...
					<div class="w-100"></div>
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  					...
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_1" id="NO_itr_value_1" value="<?php if(!empty($row))echo $row->sales_per_month_1?>">
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_1" id="NO_itr_value_1" value="<?php if(!empty($row))echo $row->sales_per_month_1?>">
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_2" id="NO_itr_value_2" value="<?php if(!empty($row))echo $row->sales_per_cust_1?>">
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_3" id="NO_itr_value_3" value="<?php if(!empty($row))echo $row->cust_per_day_1?>">
	  					<input required min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_4" id="NO_itr_value_4" value="<?php if(!empty($row))echo $row->total_chachement_1?>">
	  				</div>  
				...
				<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" >
					...
					<div class="w-100"></div>
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  					...
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_5" id="NO_itr_value_5" value="<?php if(!empty($row))echo $row->sales_per_month_2?>">
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_6" id="NO_itr_value_6" value="<?php if(!empty($row))echo $row->sales_per_cust_2?>">
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_7" id="NO_itr_value_7" value="<?php if(!empty($row))echo $row->cust_per_day_2?>">
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_8" id="NO_itr_value_8" value="<?php if(!empty($row))echo $row->total_chachement_2?>">
	  				</div>  
				...
				<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" >
					...
					<div class="w-100"></div>
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  					...
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_9" id="NO_itr_value_9" value="<?php if(!empty($row))echo $row->sales_per_month_3?>">
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_10" id="NO_itr_value_10" value="<?php if(!empty($row))echo $row->sales_per_cust_3?>">
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_11" id="NO_itr_value_11" value="<?php if(!empty($row))echo $row->cust_per_day_3?>">
	  					<input required  min="0" style=" margin-bottom: 10px;"  maxlength="10" oninput="maxLengthCheck(this)" placeholder="" class="input-cust-name" type="number" name="NO_itr_value_12" id="NO_itr_value_12" value="<?php if(!empty($row))echo $row->total_chachement_3?>">
	  				</div>  
	...
	<div class="col" style="margin-top: 0px;">
					...
					<div style="margin-left: 35px; margin-top: 8px;" class="col">	
	  					...
	  					<input  required min="0" style=" margin-bottom: 10px;"  placeholder="" class="input-cust-name" type="number" name="total_gross_margin" id="total_gross_margin" value="<?php if(!empty($row))echo $row->total_gross_margin?>">
	  					...
	  					<input  required  min="0" style=" margin-bottom: 10px;"  placeholder="" class="input-cust-name" type="number" name="total_expenses_utilities" id="total_expenses_utilities" value="<?php if(!empty($row))echo $row->total_utilities?>">
	  					<input  required  min="0" style=" margin-bottom: 10px;"  placeholder="" class="input-cust-name" type="number" name="total_expenses_salaries" id="total_expenses_salaries" value="<?php if(!empty($row))echo $row->total_salaries?>">
	  					<input  required  min="0" style=" margin-bottom: 10px;"  placeholder="" class="input-cust-name" type="number" name="total_expenses_rentals" id="total_expenses_rentals" value="<?php if(!empty($row))echo $row->total_rental?>">
	  					<input required   min="0" style=" margin-bottom: 10px;"  placeholder="" class="input-cust-name" type="number" name="total_additional_recurring_expenses" id="total_additional_recurring_expenses" value="<?php if(!empty($row))echo $row->total_recurring?>">
	  					<input  required  min="0" style=" margin-bottom: 10px;"  placeholder="" class="input-cust-name" type="number" name="gross_profit" id="gross_profit" value="<?php if(!empty($row))echo $row->gross_profit?>">
	  				</div>  
	</div>
		...
		<?php if($type == 'notworking') { ?>
			...
			<div class="row shadow bg-white rounded margin-10 padding-15">
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="" class="col">
	  				...
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
						...
						$retire = $row->retiredorhomemaker;
						if(!empty($row) && $retire == 'Retired') { echo 'checked'; } ?> value="Retired"> Retired
						<input required type="radio" name="retiredorhomemaker"  <?php if(!empty($row) && $retire == 'Homemaker') { echo 'checked'; } ?> value="Homemaker"> Homemaker
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="retiredwithdiv" <?php if($retire == 'Homemaker') { ?> style="display:none;" <?php } ?> >
					<div style="" class="col">
	  				...
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
						...
						$retire = $row->retiredwith;
						if(!empty($row) && $retire == 'withincome') { echo 'checked'; } ?> value="withincome"> With income
						<input required type="radio" name="retiredwith"  <?php if(!empty($row) && $retire == 'withoutincome') { echo 'checked'; } ?> value="withoutincome"> Without income
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
	  				...
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  					<input required readonly placeholder="Customer type" class="input-cust-name" type="text" name="customertype" id="customertype" value="<?php echo $row->customertype; ?>" >
