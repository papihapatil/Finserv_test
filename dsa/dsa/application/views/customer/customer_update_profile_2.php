		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input  placeholder="Enter landmark " class="input-cust-name" type="text" name="resi_landmark" id="resi_landmark" value="<?php if(!empty($row_more))echo $row_more->RES_ADDRS_LANDMARK;?>" >
  				</div>  			  				
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input  placeholder="Enter landmark"  class="input-cust-name" type="text" name="per_landmark" id="per_landmark" value="<?php if(!empty($row_more))echo $perAddPresent? $row_more->PER_ADDRS_LANDMARK : $row_more->RES_ADDRS_LANDMARK ;?>">
  				</div>  			  				
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<!---- Declarations -----------------------------------added by priya 10-01-2023 --> 
		<div class="row shadow bg-white rounded margin-10 padding-15">
			<div class="row shadow bg-white rounded margin-10 padding-15">
			<div class="row col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-left:10px;"><span style="margin-top: 15px; font-size: 16px; color: black; font-weight: bold;">Dual Signature Declaration Details</span></div>
			<div class="row col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-left:10px;"><span style="margin-top: 15px; font-size: 16px; color: black; font-weight: bold;">Dual Name Declaration Details</span></div>

			<div class="row col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 shadow bg-white rounded " style="margin:10px;margin-left:20px">
				<div id="DUAL_SIGNATURE" class="tabcontent">								
					<div class="row">
						<div class="col-sm-5">	1.	That my signature is 
											</div>
											<div class="col-sm-7">
										...
										<div class="row">
											...
											<div class="col-sm-5">
												<input type="text" name="signature_name_want" class="form-control">
											</div>
										</div>
									<span>3.	That for mortgage operation, apart from the aforesaid signature, I would not sign in any other manner. </span>
									<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;a)	That I hereby agree and undertake to hold the FFPL and its officers and Directors harmless and indemnified for any loss, damage, costs and charges incurred or suffered by the PFSPL and against any claims, suits, proceedings and actions instituted against the Bank due to acceptance of my request to honour instruments and instructions bearing the above-mentioned signature.</span>

							</div>	
			</div>	
				
		<div class="row col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 shadow bg-white rounded " style="margin:10px;margin-left:20px">
			<div id="DUAL_NAME" class="tabcontent">
			<br>
				<div class="row">
					<div class="col-sm-5">1.	That my actual full name is</div>
					<div class="col-sm-7">
						<input type="text" name="name_d_actual_name" class="form-control">
					</div>
					<div class="col-sm-6">2.	That my full name is as per PAN Card</div>
					<div class="col-sm-6">
							<input type="text" name="name_d_pan" class="form-control">
					</div>
						<div class="col-sm-6">3.	That my full name is as per Aadhar Card</div>
					<div class="col-sm-6">
							<input type="text" name="name_d_aadhar" class="form-control">
					</div>
						<div class="col-sm-6">4.	That my full name is as per Property Document Card</div>
					<div class="col-sm-6">
							<input type="text" name="name_d_property" class="form-control">
					</div>
				</div>
			    <span >5.	That the correct spelling of my full name is as above.</span>
				...
				<div class="row">
					...
					<div class="col-sm-4">Before marriage my name was
					</div>
					<div class="col-sm-4">
							<input type="text" name="name_d_befor_marriage" class="form-control">
					</div>
				</div>
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			...
			<div class="row col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 shadow bg-white rounded " style="margin:10px;margin-left:20px">
				<div id="DUAL_SIGNATURE" class="tabcontent">								
										<div class="row">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" name="birth_D_actual_dob" >
											</div>
											<div class="col-sm-8">
												2. That my date of birth is on Pan Card
											</div>
											<div class="col-sm-4">
													<input type="text" class="form-control" name="birth_D_pan_dob" >
											</div>
											<div class="col-sm-8">
												3. That my date of birth is on Aadhar Card 
											</div>
											<div class="col-sm-4">
													<input type="text" class="form-control" name="birth_D_aadhar_dob"  >
											</div>
										</div>
										<div class="row">
											<div class="col-sm-8">
												4. That my date of birth is inadvertently recorded as 
											</div>
											<div class="col-sm-4">
													<input type="text" class="form-control" name="birth_D_inadvertently_dob" >
											</div>
										</div>
			...
			<div class="row col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 shadow bg-white rounded " style="margin:10px;margin-left:20px">
				<div id="DUAL_NAME" class="tabcontent">
					<br>
					<div class="row">
						<div class="col-sm-2">I the Applicant(s)</div>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="language_D_applicant" >
						</div>
						<div class="col-sm-7">	have understood the document (LAF/ Loan Agreement,Sanction  </div>
						<div class="col-sm-6"> & MITC etc)  as explained to me by the declarant </div>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="language_D_declarant">
							</div>
						<div class="col-sm-12">
						and agree to abide by all theterms and conditions of the Loan Disbursement Kit.
						</div>
					</div>
					<br>
				    <div class="row">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="language_D_employee_name">
						</div>
						<div class="col-sm-3">
							Employee Code
						</div>
							<div class="col-sm-3">
							<input type="text" class="form-control" name="language_D_employee_code">
						</div>
					 ...
					 <div class="row">
						...
						<div class="col-sm-3">
							declarant recident at
						</div>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="language_D_declarant_recident_at">
						</div>
							<div class="col-sm-6">
							have read out and  explained the contents that
						</div>
						<div class="col-sm-12">
					     he/she/they has/have read out and explained the contents of this Loan Application Form to the Applicants Mr./Ms</div>
						</div>
					<br>
				    <div class="row">
						<div class="col-sm-4">
						  		<input type="text" class="form-control" name="language_D_Mr_Ms">
						</div>
							<div class="col-sm-1">
							 in 
						</div>
							<div class="col-sm-4">
						  		<input type="text" class="form-control" name="language_D_in">
						</div>
						<div class="col-sm-3">
							 language and he/she 
						</div>
							<div class="col-sm-12"> /they have confirmed that he/she/they has/have understood the same and have agreed to abide by all the terms and conditions of the said Loan Application Form .I confirmed that whatever I have started here in above is true and correct to the best of my knowledge and belief.
						</div>
