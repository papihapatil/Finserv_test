...
<div style="line-height: 40px; margin-left: 10px; margin-top: 20px;" class="row">
			...
			<div class="margin-10 padding-5">
				...
				<div class="row shadow bg-white rounded margin-10 padding-15">
					<div class="row justify-content-center col-12">
						<span style="margin-top: 15px; font-size: 16px; color: black; font-weight: bold;">Please tell us a bit about the Co-Applicant</span>
		
					</div>
					<div class="row justify-content-center col-12">
						<span style="margin-bottom: 45px; font-size: 12px; color: #bfbbbb;">Please fill Co-Applicant personal details. If required our Representative may get in touch to verify them.</span>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
						...
						<div class="w-100"></div>
						  <div style="margin-left: 35px;  margin-top: 8px;" class="col">
							  <input minlength="3" maxlength="30" placeholder="Enter email-Id *" class="input-cust-name" type="email" name="email" value="<?php if(!empty($row_more))echo $row_more->EMAIL;?>">
						  </div> 
				...
				<div class="row shadow bg-white rounded margin-10 padding-15">
					...
					<div class="row justify-content-center col-12">
						<span style="margin-bottom: 35px; font-size: 12px; color: #bfbbbb;">Please provide Co-Applicant family details for further processing.</span>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="col" style="margin-top: 0px;">
							<span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:15px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-female"></i></span> <span style="color: black; font-size: 12px; font-weight: bold; margin-left: 8px;">Mother's Middle Name *</span>
						</div>			
						<div class="w-100"></div>
						  <div style="margin-left: 35px; margin-top: 8px;" class="col">
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
						...
						<div class="w-100"></div>
						  <div style="margin-left: 35px; margin-top: 8px;" class="col">
							  ...
							  <option value="0" <?php if(!empty($row_more))if ($row_more->TOTAL_BRO_SIS == '0') echo ' selected="selected"'; ?>>0</option>
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div class="col" style="margin-top: 0px;">
			<span class="align-middle dot-light-theme"></span> <span style="color: black; font-size: 12px; font-weight: bold; margin-left: 8px;"><i style=" font-size:11px;color:#25a6c6;" class="fa fa-user-plus"></i>&nbsp;&nbsp;Co-Applicants Relation With The Applicant</span>
		</div>	
		...
		<div style="margin-left: 35px;  margin-top: 8px;" class="col">
				  ...
				  <option value="" >Select *</option>
				  <option value="Spouse"       <?php if(isset($row_more))if ($row_more->relation == 'Spouse') echo ' selected="selected"'; ?>>Spouse</option>
				  <option value="Brother"  <?php if(isset($row_more))if ($row_more->relation == 'Brother') echo ' selected="selected"'; ?>>Brother</option>
				  <option value="Father"       <?php if(isset($row_more))if ($row_more->relation == 'Father') echo ' selected="selected"'; ?>>Father</option>
				    <option value="Mother"       <?php if(isset($row_more))if ($row_more->relation == 'salaried') echo ' selected="selected"'; ?>>Mother</option>
				  <option value="Sister"  <?php if(isset($row_more))if ($row_more->relation == 'Sister') echo ' selected="selected"'; ?>>Sister</option>
				  <option value="Son"       <?php if(isset($row_more))if ($row_more->relation == 'Son') echo ' selected="selected"'; ?>>Son</option>
				   <option value="Daughter"       <?php if(isset($row_more))if ($row_more->relation == 'Daughter') echo ' selected="selected"'; ?>>Daughter</option>
				   <option value="Mother-in-law"       <?php if(isset($row_more))if ($row_more->relation == 'Mother-in-law') echo ' selected="selected"'; ?>>Mother-in-law</option>
				    <option value="Father-in-law"       <?php if(isset($row_more))if ($row_more->relation == 'Father-in-law') echo ' selected="selected"'; ?>>Father-in-law</option>
					 <option value="Brother-in-law"       <?php if(isset($row_more))if ($row_more->relation == 'Brother-in-law') echo ' selected="selected"'; ?>>Brother-in-law</option>
					  <option value="Sister-in-law"       <?php if(isset($row_more))if ($row_more->relation == 'Sister-in-law') echo ' selected="selected"'; ?>>Sister-in-law</option>
			</select>
		</div>
					</div>
				</div>
				...
				<div class="row shadow bg-white rounded margin-10 padding-15">
					<div class="row justify-content-center col-12">
						<span style="margin-top: 15px; font-size: 16px; color: black; font-weight: bold;">Tell us where Co-Applicant live</span>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
						...
						<div class="w-100"></div>
						  ...
						  <div style="margin-top: 10px;" class="col">
							<span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:15px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-map-pin"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">No Of Years At The Present Address *</span>
						</div>			
						<div class="w-100"></div>
					...
					<div class="row col-12" style="padding-top: 10px; margin: 10px; color: black; font-size: 14px;">
						...
						<div style="margin-left: 20px;" class="custom-control custom-switch">				  
						  ...
						  <label class="custom-control-label" for="customSwitches">Is Co-Applicant's Permanent Address Same As Present Address ?</label>				  
						</div>
					</div>
					...
					<div class="row shadow bg-white rounded margin-10 padding-15">
																...
																<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
																	...
																	<div class="w-100"></div>
  																	<div style="margin-left: 35px; margin-top: 8px;" class="col">
																		...
																		<?php if(isset($row_more)){ if( $row_more->VERIFY_KYC=='true'){?>
																			<option value="<?php if(isset($row_more)){echo $row_more->KYC_doc; }?>"><?php if(isset($row_more)){echo $row_more->KYC_doc; } ?></option>
																		<?php }else{?>
						  													<option value="">Select KYC Document *</option>
						  													
						  													<option value="Aadhar" <?php if(isset($row_more))if ($row_more->KYC_doc== 'Aadhar') echo ' selected="selected"'; ?>>Aadhar Card</option>
						  													<option value="Pan card" <?php if(isset($row_more))if ($row_more->KYC_doc== 'Pan card') echo ' selected="selected"'; ?>>Pan card</option>
						  													<option value="Driving Licence" <?php if(isset($row_more))if ($row_more->KYC_doc == 'Driving Licence') echo ' selected="selected"'; ?>>Driving Licence</option>
						  													<option value="Passport" <?php if(isset($row_more))if ($row_more->KYC_doc == 'Passport') echo ' selected="selected"'; ?>>Passport</option>
						  													<option value="VoterId" <?php if(isset($row_more))if ($row_more->KYC_doc == 'VoterId') echo ' selected="selected"'; ?>>VoterId</option>
																		<?php }}else{ ?>
					 														<option value="">Select KYC Document *</option>
						 													<option value="Aadhar" <?php if(isset($row_more))if ($row_more->KYC_doc == 'Aadhar') echo ' selected="selected"'; ?>>Aadhar Card</option>
						  													<option value="Pan card" <?php if(isset($row_more))if ($row_more->KYC_doc == 'Pan card') echo ' selected="selected"'; ?>>Pan card</option>
																...
																<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
																	...
																	<div class="w-100"></div>
  												  					<div style="margin-left: 35px; margin-top: 8px;" class="col">
  																		<input  required placeholder="" class="form-control" type="text" name="KYC" id="KYC"  <?php if(isset($row_more)){ if( $row_more->VERIFY_KYC=='true'){echo 'readonly ';} }?> value="<?php  if(isset($row_more)){ echo trim($row_more->KYC);}?>"  >
  				  														<input type="text" id="verify_kyc_status" name="verify_kyc_status" value="<?php if(isset($row_more)){echo $row_more->VERIFY_KYC;}?>"  hidden >
																	</div>  			  				
																</div>
																<?php if(isset($row_more)){ if( $row_more->VERIFY_KYC=='true'){ ?> 
																<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
															 ...
															 <div class="w-100"></div>
																...
																<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="passport_file_no" style="display:none">
													  				<div style="margin-top: 0px;" class="col">
																...
																<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="date_of_issue" style="display:none">
													  				<div style="margin-top: 0px;" class="col">
															 ...
															 <div class="w-100"></div>
																...
																<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
																	...
																	<div class="w-100"></div>
  																	<div style="margin-left: 35px; margin-top: 8px;" class="col">
																		...
																		<?php if(isset($row_more)){ if( $row_more->VERIFY_PAN=='true'){?>
																			<option value="<?php if(isset($row_more)){echo $row_more->KYC_doc_1; }?>"><?php if(isset($row_more)){echo $row_more->KYC_doc_1; } ?></option>
																		<?php }else{?>
						  													<option >Select KYC Document *</option>
						  													<option value="Aadhar" <?php if(isset($row_more))if ($row_more->KYC_doc_1 == 'Aadhar') echo ' selected="selected"'; ?>>Aadhar Card</option>
						  													<option value="Pan card" <?php if(isset($row_more))if ($row_more->KYC_doc_1 == 'Pan card') echo ' selected="selected"'; ?>>Pan card</option>
						  													<option value="Driving Licence" <?php if(isset($row_more))if ($row_more->KYC_doc_1 == 'Driving Licence') echo ' selected="selected"'; ?>>Driving Licence</option>
						  													<option value="Passport" <?php if(isset($row_more))if ($row_more->KYC_doc_1 == 'Passport') echo ' selected="selected"'; ?>>Passport</option>
						  													<option value="VoterId" <?php if(isset($row_more))if ($row_more->KYC_doc_1 == 'VoterId') echo ' selected="selected"'; ?>>VoterId</option>
																			  <?php }}else{ ?>
					 														<option >Select KYC Document *</option>
						 													<option value="Aadhar" <?php if(isset($row_more))if ($row_more->KYC_doc_1 == 'Aadhar') echo ' selected="selected"'; ?>>Aadhar Card</option>
						 													<option value="Pan card" <?php if(isset($row_more))if ($row_more->KYC_doc_1 == 'Pan card') echo ' selected="selected"'; ?>>Pan card</option>
																...
																<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
																	...
																	<div class="w-100"></div>
  												  					<div style="margin-left: 35px; margin-top: 8px;" class="col">
  																		<input    class="form-control"  type="text" name="pan" id="pan"   <?php if(isset($row_more)){ if( $row_more->VERIFY_PAN=='true'){echo 'readonly ';} }?> value="<?php if(isset($row_more) ){echo $row_more->PAN_NUMBER;}?>"  >
  				   													    <input type="text" id="verify_pan_status" name="verify_pan_status" value="<?php if(isset($row_more)){echo $row_more->VERIFY_PAN;} ?>"  hidden >
																	</div>  			  				
																</div>
																<?php if(isset($row_more)){ if( $row_more->VERIFY_PAN=='true'){ ?> 
																...
																<div style="margin-top: 20px;" class="row col-12 justify-content-center">
																		...
																		<div style="margin-top: 20px;" class="row col-12 justify-content-center">
																			<?php if(isset($row_more)){ if( $row_more->VERIFY_PAN=='true' && $row_more->VERIFY_KYC=='true' ){ ?> 
		...
		$('#KYC_doc').on('change',function(e)
								{
									 ...
									 if(KYC_doc=='Passport')
									 {
										 ...
										 $('#KYC').attr("placeholder", "Enter "+ KYC_doc+" Number (e.g:J8369854)");
									 ...
									 else if(KYC_doc=='Driving Licence')
									 {
										  ...
										  document.getElementById('KYC').value = '';
										   ...
										   $('#KYC').attr("placeholder", "Enter DL Number (e.g: MH14 20160034761)");
									  ...
									  else if(KYC_doc=='Aadhar')
									 {
										   ...
										   document.getElementById('KYC').value = '';
											...
											$('#KYC').attr("placeholder", "Enter "+ KYC_doc+" Number(e.g:3675 9834 6015)");
