  ...
  <form class="form-container">
	...
	<div >
		...
		<?php if($type == 'home') { ?>	
			...
			<div class="row shadow bg-white rounded margin-10 padding-15" style="display:none;">
				<div class="row justify-content-center col-12">
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" >
					<div style="margin-top: 10px;" class="col">
						...
						<div style="margin-left: 35px; margin-top: 8px;" class="col">	
															...
															<input type="text" value="1" name="bank_name" hidden>
													</div>
												</div>	
			</div>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input  placeholder="Enter landmark " class="input-cust-name" type="text" name="resi_landmark" id="resi_landmark" value="<?php if(!empty($form_data))echo $form_data->PROP_ADD_LANDMARK;?>">
  				</div>  			  				
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
					...
					<select required class="input-cust-name resi_prop_type" name="resi_sel_property_type" > 
					  <option value="">Select Property Type *</option>
					  <option value="Owned" <?php if(!empty($form_data))if ($form_data->PROP_ADD_PROP_TYPE == 'Owned') echo ' selected="selected"'; ?>>Owned</option>
					  <option value="Ancestral" <?php if(!empty($form_data))if ($form_data->PROP_ADD_PROP_TYPE == 'Ancestral') echo ' selected="selected"'; ?>>Ancestral</option>
					  </select>
  				</div>  			  							  				
			</div>
			...
			<div class="row shadow bg-white rounded margin-10 padding-15">
					...
					<div style="margin-top: 10px;" class="col">
	  				...
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  					<select required class="input-cust-name" name="loan_availed_for" id="loan_availed_for"> 
							...
							-->
							<option value="Loan Reconsolidation"   <?php if(!empty($form_data))if ($form_data->LOAN_AVAILED_FOR == 'Loan Reconsolidation') echo ' selected="selected"'; ?>>Loan Reconsolidation</option>
							<option value="Machine Purchase"  <?php if(!empty($form_data))if ($form_data->LOAN_AVAILED_FOR == 'Machine Purchase') echo ' selected="selected"'; ?>>Machine Purchase</option>
							<option value="New property Purchase"  <?php if(!empty($form_data))if ($form_data->LOAN_AVAILED_FOR == 'New property Purchase') echo ' selected="selected"'; ?>>New property Purchase</option>
							<option value="Purchase of Business Premise"   <?php if(!empty($form_data))if ($form_data->LOAN_AVAILED_FOR == 'Purchase of Business Premise') echo ' selected="selected"'; ?>>Purchase of Business Premise</option>
							<option value="Working Capital / Business Expansion" <?php if(!empty($form_data))if ($form_data->LOAN_AVAILED_FOR == 'Working Capital / Business Expansion') echo ' selected="selected"'; ?>>Working Capital / Business Expansion</option>
							<option value="Home Renovation"  <?php if(!empty($form_data))if ($form_data->LOAN_AVAILED_FOR == 'Home Renovation') echo ' selected="selected"'; ?>>Home Renovation</option>
							<option value="Shop refurbishment"  <?php if(!empty($form_data))if ($form_data->LOAN_AVAILED_FOR == 'Shop refurbishment') echo ' selected="selected"'; ?>>Shop refurbishment</option>
							</select>
	  				</div> 
				...
				<input style="margin-left: 40px; margin-top: 6px;" type="checkbox" id="is_agree" name="is_agree" value="Yes" cheked><span style="font-size: 12px; margin-top: 5px; margin-left: 8px; color: black; font-weight: bold;">I / We Agree.</span>
