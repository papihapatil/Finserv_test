			...
			<div class="row shadow bg-white rounded margin-10 padding-15">
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="" class="col">
	  				...
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  					<input type="radio" name="withincome" id="withincome"> With income
						<input type="radio" name="withincome" id="withoutincome"> Without income
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="" class="col">
						<span class="align-middle dot-light-theme"><i style=" font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-industry"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">User Type </span>
					</div>			
				
	  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  					<input type="text" name="customertype" id="customertype"  class="input-cust-name">
