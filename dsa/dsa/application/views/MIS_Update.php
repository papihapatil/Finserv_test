  ...
  <div class="tab-content">
	...
	<form action="<?php echo base_url('index.php/Relationship_Officer/Ntbform');?>" method="POST">
            ...
            <div class="row">
                    ...
                    <div class="col-md-4 form-group mt-3 mt-md-0">
                         <label class="exampleFormControlFile1" >Customer Email ID&nbsp;</label>
                         <input type="text" class="form-control " placeholder=""   name="ntb_email">         
                    </div> 
             </div>
             <div class="row">
                    <div class="col-md-4 form-group mt-3 mt-md-0">
	...
	<form action="<?php echo base_url('index.php/Relationship_Officer/Leadform');?>" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group mt-3 mt-md-0">
				...
				<select class="form-control " name="lead_area" id="lead_area"   onchange="myFunction1()" required <?php if($row->ROLE=='14') {echo 'readonly';} else {echo '';} ?>>
        ...
        <div class="row">
            ...
            <div class="col-md-4 form-group mt-3 mt-md-0">
                <label class="exampleFormControlFile1">Customer Address&nbsp;</label><small style="color:red">*</small>
        ...
        <div class="row">
            <div class="col-md-6 form-group mt-3 mt-md-0">
               <label class="exampleFormControlFile1">Lead Assigned By&nbsp;</label><small style="color:red">*</small>
                ...
                <input type="text" class="form-control " readonly placeholder="" required  pattern="^[a-zA-Z][\sa-zA-Z]*" minlength="3" name="lead_ass" value="<?php if(!empty($row)) echo $row->FN." ".$row->LN;?>" <?php if($row->ROLE=='14') {echo 'readonly';} else {echo '';} ?>>  
            </div>
            
            <div class="col-md-6 form-group mt-3 mt-md-0">
                <label class="exampleFormControlFile1">Lead Assigned To&nbsp;</label><small style="color:red">*</small>
              <!--  <input type="text" class="form-control " placeholder="" required  pattern="^[a-zA-Z][\sa-zA-Z]*" minlength="3" name="lead_assito" id="lead_assito" <?php if($row->ROLE=='14') {echo 'readonly';} else {echo '';} ?>>    -->   
				
				<select class="form-control "  name="lead_assito" id="lead_assito" required <?php if($row->ROLE=='14') {echo 'readonly';} else {echo '';} ?>>
				<option selected="selected">Lead Assigned To</option>
...
function myFunction1() {
  ...
  //alert(branch);
   var items="";
  if(window.location.host.includes("http"))url = window.location.host + "/finserv_test/dsa/dsa/index.php/Relationship_Officer/get_branch_lead";
	 else url = window.location.protocol+"//"+window.location.host + "/finserv_test/dsa/dsa/index.php/Relationship_Officer/get_branch_lead";            
	 $.ajax({
		type: "POST",
		url: url,
		data: '{ "branch": "'+branch+'"}',
		...
		success: function (response) {
			...
			{
				//alert(item.FN);
				items +="<option value='"+item.UNIQUE_CODE+"'>" +item.FN +" "+item.LN +"</option>";
			});
		$('#lead_assito').find('option').remove().end()
			.append('<option value="">Lead Assigned To</option>').val();
			$('#lead_assito').append(items);
		}
	  });
}
</script>
