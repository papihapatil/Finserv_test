...
<?php if(!empty($row))	{ if($row->Profile_Status!="Complete" && $row->ROLE==4 )  {  ?>
<ul class="c-sidebar-nav">
<li class="c-sidebar-nav-item">
		<a class="c-sidebar-nav-link" href="<?php echo base_url();?>index.php/Connector">	<svg class="c-sidebar-nav-icon"><i class="fa fa-th-large" style="margin-right: 20px;"></i></svg> Dashboard</a>
   </li>
   <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="<?php echo base_url();?>index.php/connector/profile">
		<svg class="c-sidebar-nav-icon">
			<i class="fa fa-user-circle-o" style="margin-right: 20px;"></i>	
		</svg> Profile</a></li>
		<li class="c-sidebar-nav-item" onClick="showMessage()"><a class="c-sidebar-nav-link" href="">
		<svg class="c-sidebar-nav-icon">
...
<li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="<?php echo base_url();?>index.php/Connector">Dashboard</a></li>
</ul>
...
<form method="POST" action="<?php echo base_url(); ?>index.php/dsa/dsa_update_profile_one_new_action" id="dsa_update_profile_one_new_action">
	<div class="margin-10 padding-5">
		<div style="line-height: 40px; margin-left: 10px; margin-top: 20px;" class="row">
			...
			<a href="<?php echo base_url();?>index.php/connector/update_basic_profile?id=<?php  echo $id ;?>" ><i style="width: 30px; height: 30px;" alt="mahesh" class="fa fa-edit"></i></a>
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
				  <select class="input-cust-name resi_prop_type" name="income_type" > 
					  <option value="">Select</option>
					  <option value="Salaried" <?php if(!empty($row))if ($row->dsa_income_type == 'Salaried') echo ' selected="selected"'; ?>>Salaried</option>
					  <option value="Self-Employeed" <?php if(!empty($row))if ($row->dsa_income_type == 'Self_Employed') echo ' selected="selected"'; ?>>Self-employeed</option>
				</select>
  				</div>  			  				
			</div>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div style="margin-left: 35px; margin-top: 8px;" class="col">
					<select class="input-cust-name resi_prop_type" name="dsa_profession" > 
					  <option value="">Select</option>
					  <option value="Bank_employee" <?php if(!empty($row))if ($row->dsa_profession == 'Bank employee') echo ' selected="selected"'; ?>>Bank employee</option>
					  <option value="Builder" <?php if(!empty($row))if ($row->dsa_profession == 'Builder') echo ' selected="selected"'; ?>>Builder</option>
					  <option value="Contracter" <?php if(!empty($row))if ($row->dsa_profession == 'Contracter') echo ' selected="selected"'; ?>>Contracter</option>
					  <option value="Architecture" <?php if(!empty($row))if ($row->dsa_profession == 'Architecture') echo ' selected="selected"'; ?>>Architecture</option>
					  <option value="Advocate" <?php if(!empty($row))if ($row->dsa_profession == 'Advocate') echo ' selected="selected"'; ?>>Advocate</option>
					  <option value="Real_Agent" <?php if(!empty($row))if ($row->dsa_profession == 'Real_Agent') echo ' selected="selected"'; ?>>Real Agent</option>
					  <option value="Insurance_adviser" <?php if(!empty($row))if ($row->dsa_profession == 'Insurance_adviser') echo ' selected="selected"'; ?>>Insurance adviser</option>
					  <option value="Building_Material_Supplier" <?php if(!empty($row))if ($row->dsa_profession == 'Building_Material_Supplier') echo ' selected="selected"'; ?>>Building Material Supplier</option>  
					  <option value="Developers" <?php if(!empty($row))if ($row->dsa_profession == 'Developers') echo ' selected="selected"'; ?>>Developers</option>  
					  <option value="Other" <?php if(!empty($row))if ($row->dsa_profession == 'Other') echo ' selected="selected"'; ?>>Other</option>
					</select>
					</div>
			</div>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
  				...
  				<div style="margin-top: 0px;" class="col">
					<span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-id-card"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Bank Name</span>
				</div>			
				<div class="w-100"></div>
  				
				<div style="margin-left: 35px; margin-top: 8px;" class="col">
				<input min="1" required placeholder="Enter bank name" class="input-cust-name" type="text" name="bank_name"  id="" value="<?php echo $row->dsa_bank_name;?>">
