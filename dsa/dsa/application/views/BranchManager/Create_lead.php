				    ...
				    <div class="col-sm-3" id="Agency_name">
					   <div class="form-group"> 
						  ...
						  <!-- <input type="text"  name="Location" class="form-control" placeholder="Enter Location" > -->
						   <select required class="form-control" name="Location" id="city_master"> 
...
<script src="<?php base_url()?>/finserv_test/dsa/dsa/js/jquery.min.js"></script>
<script src="<?php echo base_url(); ?>adminn/vendors/@coreui/chartjs/js/coreui-chartjs.bundle.js"></script>
<script src="<?php echo base_url(); ?>adminn/vendors/@coreui/utils/js/coreui-utils.js"></script>
<script src="<?php echo base_url(); ?>adminn/js/main.js"></script>
<script src="<?php base_url()?>/finserv_test/dsa/dsa/js/jquery.min.js"></script>
<script src="<?php base_url()?>/finserv_test/dsa/dsa/js/main.js"></script>
