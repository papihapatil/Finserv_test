...
<div class="row justify-content-center ">
   <div class="col-sm-12">
				  <form class="login100-form validate-form" action="<?php echo base_url(); ?>index.php/Cluster_Manager/add_new_lead" method="POST" enctype="multipart/form-data"  >
				   <center>
   ...
   <div class="col-sm-12">
		...
		<form class="login100-form validate-form" action="<?php echo base_url(); ?>index.php/Cluster_Manager/add_new_single_lead" method="POST" enctype="multipart/form-data">
		   <div class="row">
			   
				   <div class="col-sm-3">
					   <div class="form-group">
						   <label style="margin-left:-58%;font-weight:500">First Name</label>
							  <input required type="text" class="form-control" id="fname"name="fname" placeholder="Enter first name">
						 </div>
				   </div>
				   <div class="col-sm-3">
					   <div class="form-group">
						   <label style="margin-left:-58%;font-weight:500">Last Name</label>
							  <input required type="text" class="form-control" id="lname" name="lname" placeholder="Enter last name">
						 </div>
				   </div>
				   <div class="col-sm-3">
					   <div class="form-group">
						   <label style="margin-left:-58%;font-weight:500">Email ID</label>
				   ...
				   <div class="col-sm-3">
					   <div class="form-group">
						   <label style="margin-left:-79%;font-weight:500">City</label>
							  <input required type="text" class="form-control" id="address" name="address" placeholder="Enter city">
						 </div>
				   </div>
				   <div class="col-sm-3">
					   <div class="form-group">
						   <label style="margin-left:-79%;font-weight:500">Refer By</label>
						  <select class="form-control" aria-label="Default select example" name="Refer_By_Category" id="select_category_lead_2"  >
				   ...
				   <div class="col-sm-3" id="display_option">
					   <div class="form-group">
						   <label style="margin-left:-79%;font-weight:500">Refer By Name</label>
							  <input type="text" id="User_id" value="<?php echo $this->session->userdata('ID'); ?>" hidden>
						   <select class="form-control" aria-label="Default select example"  id="options_display_lead_2" name="Refer_By">
				   ...
				   <input type="text" hidden value=<?php echo $BM_ID; ?> name="BM_ID">
				   <button type="submit" class="btn btn-info" style="width:100%;margin-top:9%;">Add Lead</button>
				   </div>
