        ...
        <div class="">
			<div class="row">
						  ...
						  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right:0px;margin-right:0px;">
						   <label style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">Customer&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=customer">
	        ...
	        <div style="overflow-x:auto;">
				...
				<?php  $i= 1 ; if(!empty($customers)){foreach($customers as $row){  ?>
					<tr>
						...
						<td><a style="margin-left: 8px; " href="<?php echo base_url()?>index.php/Cluster_Manager/GO_No_GO_?ID=<?php echo $row->UNIQUE_CODE;?>" class="btn modal_test"><i class="fa fa-question text-right" style="color:green;"></i></a></td>
