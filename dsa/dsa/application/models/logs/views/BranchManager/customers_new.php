                	...
                	<?php if($userType != 'NONE') { ?>
	                	<?php if($userType != 'DSA_CSR') { ?>
							...
							<!-- <?php if($userType != 'ADMIN') { ?>
		                		<a <?php if($s == 'self'){echo "class='dsa-filter-btn-active'";}else {echo "class='dsa-filter-btn-inactive'";}?> href="<?php echo base_url()?>index.php/dsa/customers?s=self" class="btn-dsa-new-customer" style=" border:1px solid black; margin :2px;padding:2px;font-size:11px;">SELF </a>                	
		                	<?php } ?>			                	
		                <?php } ?>	
                        <?php if($userType != 'ADMIN') { ?>
	                		<a  href="<?php echo base_url()?>index.php/dsa/customers?s=consent" class="btn-dsa-new-customer" style="margin-left: 8px; border:1px solid black; margin :2px;padding:2px;font-size:11px;">Consent</a>
	                	<?php } ?>	 -->
		                <?php if($userType != 'ADMIN') { ?>
