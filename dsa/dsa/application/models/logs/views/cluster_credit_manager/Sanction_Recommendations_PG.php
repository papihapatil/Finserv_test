										...
										<div>
        									<div class="">
												...
												<div class="col-sm-5" style="padding-left:0px;">
																	...
																	<lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">Loan Sanction Recommendations&nbsp;&nbsp;
						   												</div>
													<?php if(isset($data))	{
						 											if(count($data) != 0) 
						  											{  ?>
         ...
         $(document).ready(function(){
             $('#empTable').DataTable({
                 ...
                 'ajax': {
                     ...
                     'url':
					window.location.origin+"/finserv_test/dsa/dsa/index.php/Cluster_credit_manager/sanction_recommendations_list"
                 },
                 'columns': [
                     {data: 'Name'},
                     {data: 'Application_id'},
