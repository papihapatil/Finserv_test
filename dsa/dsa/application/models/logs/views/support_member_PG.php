...
<title>Finaleap | Support Member list</title>
...
<div >
        												<div class="">
															<div class="row">
															<div class="col-sm-3" >
																		<lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Add Support Member
                                                                        &nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=Support_Member">
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                ...
	                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/Support_Member/delete_Support_Member" method="POST" id="change_contact_status">
	                  <div class="form-group">
	                                <label  class="col-12 control-label padding-10">Are you sure you want to DELETE this Support Member?</label>	                         
         ...
         $(document).ready(function(){
             $('#empTable').DataTable({
                 ...
                 'ajax': {
                     ...
                     'url':
window.location.origin+"/dsa/dsa/index.php/Admin/customer_with_paginations_Support"
                 },
                 'columns': [
