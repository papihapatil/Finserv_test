									   ...
									   <div>
										   <div class="">
											   <div class="row">
												   ...
												   <div class="col-sm-2" >
                                                   <input type="text" hidden value="<?php $s=$this->input->get('s'); echo $s;?>" id="filter">

													   <select class="form-control" aria-label="Default select example" name="select_filters" id="select_dropdown_request_scfo">
														   <option value="">Select Filter</option>
														   <option value="all">All</option>
														   <option value="SCFO Pendig for approval"> SCFO Pendig for approval</option>
														   ...
														   <option value="SCFO Approved">SCFO Approved</option>
														   <option value="SendBack By SCFO">SCFO SendBack</option>
														   <option value="SCFO Rejected">SCFO Rejected</option>
        ...
        buttons: [
            'copy', 'csv', 'excel', 'pdf', 'print'
                ...
                'ajax': {
                    ...
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/Supply_chain/listrequest",
					'data':{filter:filter},
                },
