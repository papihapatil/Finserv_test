		...
		<div style="line-height: 40px; margin-left: 10px; margin-top: 20px;" class="row">
			<div style="color: black; font-size: 14px;" class="font-poppins-regular col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
				<?php if($id == $this->session->userdata("ID")) {?>
				    <?php if($row_more->STATUS!='Aadhar E-sign complete')
					{?>
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input disabled  name="aadhar" id="aadhar_number"  value="<?php if(!empty($row_more)){ echo base64_decode($row_more->KYC);}?>">
  				</div>  			  				
			</div>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}" disabled placeholder="PAN number *" class="input-cust-name" type="text" name="pan"  value="<?php echo PAN_NUMBER;?>">
  				</div>  			  				
			</div>
		</div>
