		...
		<div class="row justify-content-center shadow bg-white rounded margin-10 padding-15" id="business_man_layout_doc">
			<div class="card shadow col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12" style="margin-bottom: 10px;"> 
				...
				<div class="row col-12 justify-content-center" >
						...
						<?php if($doc_type=='' ){?>
							<span style="color:black;font-size:16px;padding:10px;margin-bottom:10px;">Extra Documents</span>
					<?php } else {?>
			...
			<div class="card shadow col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12" style="margin-bottom: 10px;"> 
				<div class="row" style="margin: 5px;">
					<div style="width:100%;"> 
						...
						<form  action="<?php echo base_url(); ?>index.php/customer/do_upload" method="post" enctype="multipart/form-data" id="customer_doc">					  		
							<div class="row">
													...
													<div class="row col-12 justify-content-center">
														<div>
															<a href="<?php echo base_url()?>index.php/customer/Loan_application_fees?coapp_id=<?php if(!empty($coapp_id))echo $coapp_id?>&UID=<?php if(!empty($data_row)){echo $data_row->UNIQUE_CODE; } ?>">
																<button class="login100-form-btn" style="background-color: #25a6c6; margin-top: 10px;" id="btn_save">
																	SAVE
																</button></a>						
															</div>		
														</div>				
