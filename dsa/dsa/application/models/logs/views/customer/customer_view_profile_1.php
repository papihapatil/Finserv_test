...
<div class="col-sm-2 block"><span class="block_font_active">14. &nbsp;Disbursed</span></div> 								
	...
	<div class="margin-10 padding-5">
		<div style="line-height: 40px; margin-left: 10px; margin-top: 20px;" class="row">
			...
			<?php if(!empty($row))
			{
				if ( ($row->customer_consent=='true') && ($row_more->STATUS =='Disbursed') || ($row->customer_consent=='true') && ($row_more->STATUS =='PD Completed') || ($row->customer_consent=='true') && ($row_more->STATUS =='Cam details complete') || ($row->customer_consent=='true') && ($row_more->STATUS =='Loan Recommendation Approved') || ($row->customer_consent=='true') && ($row_more->STATUS =='Loan Sanctioned') || ($row->customer_consent=='true') && ($row_more->STATUS =='Sanction Rejected') )
				{
				?>
