...
<div style="line-height: 40px; margin-left: 10px; margin-top: 20px;" class="row">
	...
	<b><?php echo " ".$row->FN." ".$row->LN." ";?></b> Please upload your valid documents
	</div>
		...
		<div class="row justify-content-center shadow bg-white rounded margin-10 padding-15" id="business_man_layout_doc">
			<div class="card shadow col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12" style="margin-bottom: 10px;"> 
				<div class="row" style="margin: 5px;">
					...
					<?php } else if($doc_type=='none' || $doc_type=='kyc'){?>
							<span style="color:black;font-size:16px;padding:10px;margin-bottom:10px;">Upload KYC Document</span>
			...
			<div class="card shadow col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12" style="margin-bottom: 10px;"> 
				<div class="row" style="margin: 5px;">
					<div style="width:100%;"> 
						...
						<form  action="<?php echo base_url(); ?>index.php/customer/do_upload_coapplicant" method="post" enctype="multipart/form-data" id="customer_doc">					  		
							<div class="row">
															...
															if($type->DOC_NAME=="AADHAR CARD")
																	{
																		...
																		if($row->KYC_doc=='Aadhar' && $row->VERIFY_KYC=='true' || $row->KYC_doc_1=='Aadhar' && $row->VERIFY_PAN=='true' )
																		{
															...
															<div>
																<div class="row">
																	<div >
																		...
																		<input hidden id='ID'  type='text' name='ID' value="<?php if(!empty($data_row)){echo $data_row->UNIQUE_CODE; } else { echo $_GET['UID']; } ?>" />
																		<input id='doc_mandatory'  type='text' name='doc_mandatory' hidden  />
																		<input hidden id='role'  type='text' name='Role' value="1" />
																	</div>
										...
										<div class="row col-12 justify-content-center">
											<div>
												<a href="<?php echo base_url()?>index.php/customer/customer_edit_profile_2_income?type=salaried">
													...
													<div class="row col-12 justify-content-center">
														<div>
															<a href="<?php echo base_url()?>index.php/customer/customer_apply_for_loan_next?coapp_id=<?php if(!empty($data_row)){echo $data_row->UNIQUE_CODE; } ?>&UID=<?php if(!empty($data_row)){echo $data_row->CUST_ID; } ?>">
