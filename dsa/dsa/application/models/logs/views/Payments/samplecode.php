...
$data = "T764243|123456|1||c123|999999999|test@gmail.com|30-07-2022|30-10-2022|1000|M|MNTH|||||9713751370GPPGFH";

echo $token = hash($algo, $data);
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).off('click', '#btnSubmit').on('click', '#btnSubmit', function(e) {
			   ...
			   //'accountNo': '1234567',    //Pass this if accountNo is captured at merchant side for eMandate/eSign
