...
<option value="ADHO"  <?php if($_REQUEST['frequency'] == 'ADHO') { echo 'selected'; }	?> > As and when presented </option>
        ...
        <div class="row shadow bg-white rounded margin-10 padding-15">		
			<div style="margin-top: 20px;" class="row col-12 justify-content-center">
					...
					<input  placeholder="ConsumerID *" class="input-cust-name" type="hidden" name="ConsumerID" id="ConsumerID" value="<?php echo $_REQUEST['ConsumerID']; ?>" minlength="3"  <?php //echo $ConsumerID; ?> maxlength="30">
