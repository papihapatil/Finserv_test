...
echo $EMI = $sanction_details->EMI;
echo "
<br>";
$Sanctioned_date = $row->Sanctioned_date;

echo $tenure = $sanction_details->tenure;
echo "
<br>";
echo $payment_recived_date = $sanction_details->payment_recived_date;


$sanctiondatearr = explode("-",$Sanctioned_date);

print_r($sanctiondatearr);

echo $sanctionmonth = $sanctiondatearr[1];

$nextmonth = (int) $sanctionmonth+1;
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
  				...
  				<div style="margin-top: 0px;" class="col">
					<span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-map"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Merchant ID *</span>
				</div>			
				<div class="w-100"></div>
  				
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input  placeholder="ConsumerID *" readonly class="input-cust-name" type="text" name="ConsumerID" id="ConsumerID" value="T764243" minlength="3" maxlength="30">
  				</div>  			  				
...
<option value="ADHO" > As and when presented </option>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input required placeholder="Collection Amount *" class="input-cust-name" type="text" name="CollectionAmount" id="CollectionAmount" value="1" minlength="1" maxlength="30">
  				</div>  			  				
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input required placeholder="Maximum Collection Amount *" class="input-cust-name" type="text"  minlength="1" title="Maximum Collection Amount" name="amount" id="amount" oninput="maxLengthCheck(this)" maxlength="16" value="">
  				</div>  
  				<div class="w-100"></div>
