									...
									<div class="col-md-12">
										<div class="card">	
												...
												<div class="row">
													<div class="col-sm-12">
														...
														<div >
        													<div class="">
																<div class="row">
																	<?php if(isset($job_profiles))
				      												 {
						 											 if(count($job_profiles) != 0) 
						  											{  ?>
						  											<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right:0px;margin-right:0px;">
						   												<lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Total <?php echo count($job_profiles); ?>&nbsp;&nbsp;</lable>
						 										   	</div>
						  											<?php  } 
				          											else
						  											{?>
											...
											<div class="row justify-content-center">
	   												<div class="col-sm-3"><h5 style="margin-left: 10px;">Add New Openings :</h5> 
												    </div>
		                                            <div class="col-sm-4">	
	                                        ...
	                                        <br>
	                                        <br>
											<form action="add_job_openings" method="post">
											<div class="container">
												<div class="row justify-content-center panel panel-default">
													<div class="col-sm-6">	
														<div class="panel-heading"><b>Profile Heading</b>
															<div class="input-group">
         														<input type="text"  class="form-control" value="" name="new_job_openings" placeholder="Enter new job openings" required>
  															</div>
												    	</div>
													</div>	
													<div class="col-sm-6">	
														<div class="panel-heading"><b>Please confirm this is the position we want to hire as priority</b>
															<div class="form-control">
																<label class="radio-inline"><input type="radio" name="priority" value="yes">Yes</label>
																<label class="radio-inline"><input type="radio" name="priority" value="no">No</label>
  															</div>
														</div>
													</div>
													<div class="col-sm-6">	
														<div class="panel-heading"><b>Experience Required</b>
															<div class="" style="padding:10px;">
															    <label class="radio-inline">From <input type="number" name="experience_from"></label>
																<label class="radio-inline">To <input type="number" name="experience_to"></label>
  															</div>
														</div>
													</div>
													<div class="col-sm-6">	
														<div class="panel-heading"><b>Expected joining date</b>
															<div class="" style="padding:10px;">
															    <input type="date"  class="form-control" value="" name="expected_joining_date">
  															</div>
														</div>
													</div>
													<div class="col-sm-6">	
														<div class="panel-heading"><b>Job Locations</b>
															<div class="" style="padding:10px;">
															<input  type="text"  class="form-control" value="" name="job_locations"></input>
  															</div>
														</div>
													</div>
													<div class="col-sm-6">	
														<div class="panel-heading"><b>No of job Positions</b>
															<div class="" style="padding:10px;">
															<input  type="number"  class="form-control" value="" name="job_positions"></input>
  															</div>
														</div>
													</div>
													<div class="col-sm-12">	
														<div class="panel-heading"><b>Skills required</b>
															<div class="" style="padding:10px;">
															<textarea class="form-control" rows="5" id="comment" name="Skills_text"></textarea>
  															</div>
														</div>
													</div>
													<div class="col-sm-12">	
														<div class="panel-heading"><b>Role and Responsibilities</b>
															<div class="" style="padding:10px;">
															<textarea class="form-control" rows="5" id="comment" name="roles_text"></textarea>
  															</div>
														</div>
													</div>
												</div>
											...
											<div class="row justify-content-center">
	   												<div class="col-sm-5"><h5 style="margin-left: 10px;"></h5> 
												    </div>
		                                          
		                                            <button type="submit" class="col-sm-2 btn btn-info">Publish
																		</button>
		                                            <div class="col-sm-5">
													</div>
		                                            <hr>
														...
														<div style="overflow-x:auto;">
															<div class="demo-html">
																<table id="example" class="display" style="width:100%">
																    ...
																    <tbody>
																	    <?php  $i= 1 ; if(!empty($job_profiles)){foreach($job_profiles as $row){  ?>
																	    ...
																	    <tr>
																			...
																			<td><?php echo $row->Exe_from?></td>
																			<td><?php echo $row->Exe_to?></td>
																			<td><?php echo $row->Expected_date?></td>
																			<td><small><?php 

																				$iparr =explode(",",$row->job_locations);
																				$x=1;
																			
																			    for($z=0; $z<count($iparr) ; $z++)
																				{
																					if($iparr[$z]!=''){
																					echo $x."]  ".$iparr[$z]."<br />";
