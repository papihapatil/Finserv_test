 							...
 							<tr>
    						    <th scope="col"> 
    						   		<i class="fa fa-star fa-lg" style="color:red;"></i>
    						   		 <th scope="col">Files for Calling</th>
								</th>
					...
					<table class="table">
 						...
 						<tbody>
 							<tr>
    						    <th scope="col"> 
    						   		<i class="fa fa-star fa-lg" style="color:red;"></i>
    						   		 <th scope="col">Reverted Files</th>
								</th>
   								<th scope="col"><?php echo $Total_reverted_files;?></th>
								<th><a style="margin-left: 8px; " href="<?php echo base_url();?>index.php/Disbursement_OPS/RF" class="btn modal_test"><i class="fa fa-edit text-right" style="color:blue;"></i></a></th>
						    </tr>
  						</tbody>
					</table>
