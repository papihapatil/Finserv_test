<body style="background-color: #f2f2f2; width: 100%;">
	...
	<div class="row justify-content-center">
		<div >
			<div class="row shadow bg-white rounded margin-10 padding-15">
				<form  action="<?php echo base_url(); ?>index.php/Newlogin/mobile_otp_verify" method="POST">
	...
	<div style="margin-top: 10px;" class="container-login100-form-btn">
		<form  action="<?php echo base_url(); ?>index.php/Newlogin/resendOtp" method="POST" id="resend">
