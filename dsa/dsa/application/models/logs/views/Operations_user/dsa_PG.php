...
<div >
        <div class="">
			<div class="row">
				...
				<?php     } 
						...
						{ ?>
				          ...
				          <?php if( $row->ROLE !=8 ) {?>
							...
							<lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Add DSA&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=dsa_rockers_agents_for_biss">
						   <i class="fa fa-plus "style='font-size:24px; color:green;'></i></a></lable>
							...
							<div class="col-sm-2" style="padding-left:0px;margin-left:-5%;">
								      <lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Total <?php //echo count($data); ?>&nbsp;&nbsp; DSA </lable>
				...
				<select class="form-control" aria-label="Default select example" name="select_filters" id="filter">
			...
			var filter = document.getElementById("filter").value;
             ...
             $('#empTable').DataTable({
                 ...
                 'ajax': {
                     ...
                     'url':window.location.origin+"/dsa/dsa/index.php/Admin/operations_user_dsa_list_pagination",
					 'data':{filter:filter},
                 },
                 'columns': [
