...
<body style=" font-family:'Courier New';" >
	...
	<p style="font-size: 15px; font-weight:800;color:darkgray">CAM FOR <?php if(!empty($row)){echo ucwords($row->FN)." ".ucwords($row->MN)." ".ucwords($row->LN);}?></p>
			...
			<tr style="border: 1px solid #ddd; border-top:1px solid;border-left:1px solid; border-right:1px solid;">
				...
				<tr style="border: 1px solid #ddd;border-left:1px solid; border-right:1px solid;">
					<td style="border: 1px solid;font-size:10px;"><span style="color:black;font-weight:bold;">LOAN AMOUNT</span></td>
					 ...
					 <td style="border: 1px solid;font-size:10px;"><?php if(isset($data_credit_analysis->final_loan_amount)){ echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $data_credit_analysis->final_loan_amount);} else {if(!empty($data_credit_analysis)){ echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $data_credit_analysis->final_loan_amount);}}?></td>
					
					<td></td>
					<td style="border: 1px solid;font-size:10px;"><span style="color:black;font-weight:bold;">LOAN TENURE(YEARS)</span></td>
					<td style="border: 1px solid;font-size:10px;"><?php if(isset($data_credit_analysis->final_tenure)){ echo $data_credit_analysis->final_tenure ;} else {if(!empty($data_credit_analysis)){ echo $data_credit_analysis->final_tenure;}}?></td>
		        </tr>
				<tr style="border: 1px solid #ddd;border-bottom:1px solid;border-left:1px solid; border-right:1px solid;">
					...
					<td style="border: 1px solid;font-size:10px;"><?php if(isset($data_credit_analysis->final_roi)){ echo $data_credit_analysis->final_roi; }else{}?></td>
		        </tr>
			</tbody>
		</table>
<br>
		...
		<table style="width:100%;position:fixed" cellpadding="1" style="margin-top:20px;  width: 100%;">
			<tbody style="margin-top: 5rem">
				...
				<tr style="border: 1px solid #ddd;border-bottom:1px solid;border-left:1px solid; border-right:1px solid;">
					...
					<td style="border: 1px solid;text-align: right;font-size:10px;"><?php if(!empty($data_credit_analysis)) echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $data_credit_analysis->gross_profit) ; $net_gross_profit =(($data_credit_analysis->gross_profit)/12); ?></td>
		        </tr>
			</tbody>
		</table>
	...
	<!------------------------------------------------------------------------------------------------------------------------------------------------------- -->
			...
			<tbody style="margin-top: 5rem">
				<tr style="border: 1px solid #ddd; border-top:1px solid;border-left:1px solid; border-right:1px solid;">
					...
					<td style="border: 1px solid;text-align: right;font-size:10px;"><?php $Assessed_Income=($Applicant_total_income_+$CoApplicant_total_income+$additional_income_from_pd); echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",round($Assessed_Income));?></td>
				...
				<tr style="border: 1px solid #ddd;border-left:1px solid; border-right:1px solid;">
					...
					<td style="border: 1px solid;font-size:10px;"><?php if(!empty($Total_Value)){echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $Total_Value);}?></td>
				    <td style="border: 1px solid;font-size:10px;"><span style="color:black;font-weight:bold;">CONSTRUCTIONS VALUE</span></td>
					<td style="border: 1px solid;font-size:10px;"><?php if(!empty($Construction_value)){echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $Construction_value);}?></td>
		        </tr>
				<tr style="border: 1px solid #ddd;border-left:1px solid; border-right:1px solid;">
					<td style="border: 1px solid;font-size:10px;"><span style="color:black;font-weight:bold;">LAND VALUE</span></td>
					<td style="border: 1px solid;font-size:10px;"><?php if(!empty($Land_value)){echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $Land_value);}?></td>
				    <td style="border: 1px solid;font-size:10px;"><span style="color:black;font-weight:bold;">AGREEMENT VALUE OF THE PROPERTY</span></td>
					<td style="border: 1px solid;font-size:10px;"><?php if(!empty($Agreement_value)){echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $Agreement_value);}?></td>
		        </tr>
				<tr style="border: 1px solid #ddd;border-left:1px solid; border-right:1px solid;">
