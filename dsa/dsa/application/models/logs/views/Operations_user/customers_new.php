					...
					<tr>
						...
						<th>PD</th>
							 <th>Sanction Letter</th> 
																		<th>MITC Letter</th>
						<th>BUREAU</th>
						<!--<th>Send To Vendors</th>-->
					
						<th>Loan Disbursement Form</th>
        ...
        $(document).ready(function(){
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
					...
					'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/Operations_user/customers_with_pagination",
					'data':{filter:filter},
                },
                'columns': [
