...
<?php
    ...
    if (isset($message)) {
               echo '<script> swal("success!", "CAM generated successfully", "success").then(function() {  window.location.replace("/dsa/dsa/index.php/Operations_user/customers");});</script>';
		...
		<div style="line-height: 40px; margin-left: 10px; margin-top: 20px;" class="row">
           ...
           <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12"></div>
			...
			<div class="source" style="padding-bottom:15px;">
			   <span class="dropdown" style="margin-left:-70%;margin-top:-10%;margin-bottom:5%;padding-left:10px;height:40px;">Source [<?php if(isset($Sourcing_Type)){echo $Sourcing_Type;}?>]:&nbsp;<?php if(isset($Sourcing_name)){echo $Sourcing_name;}?></span>
				...
				<div class="dropdown">
        			...
        			<ul class="dropdown-menu">
						<?php $i=1; foreach($documents as $doc)	{  ?>
							<li id="<?php echo $doc->DOC_NAME;?>"><?php echo $doc->DOC_TYPE;?></li>
	   					<?php $i++;} ?> 
        			</ul>
					<ul class="dropdown-menu">
						<?php $i=1; foreach($documents as $doc)	{  ?>
			...
			<div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					...
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
	  					<div class="input-cust-name" style=" margin-top: 8px;">
							...
							<div class="row">
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
									<input  type="radio" name="Sale_Deed" value="yes" <?php if(!empty($row_more))if ($row_more->Sale_Deed == 'yes') echo ' checked="true"'; ?> > yes
								</div>
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
									<div class="dis">
									<input   type="radio" name="Sale_Deed" value="no" <?php if(!empty($row_more))if ($row_more->Sale_Deed == 'no') echo ' checked="true"'; ?> > no
								</div>
						 </div>
							</div>	
						</div>  
					   ...
					   <div style="margin-left: 35px;  margin-top: 8px;" class="col">
				      <span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-user"></i></span> <span style="color: black; font-size: 12px; font-weight: bold; margin-left: 8px;">Self Occupied</span>
					</div>
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
	  					<div class="input-cust-name" style=" margin-top: 8px;">
							<div class="row">
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
									<input  type="radio" name="Self_occupied" value="yes" <?php if(!empty($row_more))if ($row_more->Self_occupied == 'yes') echo ' checked="true"'; ?> > yes
								</div>
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
								<div class="dis">
									<input  type="radio" name="Self_occupied" value="no" <?php if(!empty($row_more))if ($row_more->Self_occupied == 'no') echo ' checked="true"'; ?> > no
								</div>
						 </div>
							</div>
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
						...
						<div class="w-100"></div>
						<div style="margin-left: 35px;  margin-top: 8px;" class="col">
							<input   class="input-cust-name" type="number" id="Land_value" name="Land_value"  value="<?php if(!empty($row_more)){echo $row_more->Land_value;}?>" onkeyup="Cal_Total_Value()">
						</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
						...
						<div class="w-100"></div>
						<div style="margin-left: 35px;  margin-top: 8px;" class="col">
							<input   class="input-cust-name" type="number" id="Construction_value" name="Construction_value"  value="<?php if(!empty($row_more)){echo $row_more->Construction_value;}?>" onkeyup="Cal_Total_Value()">
						</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
						...
						<div class="w-100"></div>
						<div style="margin-left: 35px;  margin-top: 8px;" class="col">
							<input   class="input-cust-name" type="number" name="Agreement_value"  value="<?php if(!empty($row_more)){echo $row_more->Agreement_value;}?>">
						</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
						...
						<div class="w-100"></div>
						<div style="margin-left: 35px;  margin-top: 8px;" class="col">
							<input  class="input-cust-name" type="date" name="Date_of_Agreement" id="Date_of_Agreement" value="<?php if(!empty($row_more)){ if($row_more->Date_of_Agreement){ echo $row_more->Date_of_Agreement;}}?>" readonly placeholder="Date Of Agreement" >
						</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
						...
						<div class="w-100"></div>
						<div style="margin-left: 35px;  margin-top: 8px;" class="col">
							<input   class="input-cust-name" type="number" name="LTV"  value="<?php if(!empty($row_more)){echo $row_more->LTV;}?>">
						</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
						...
						<div class="w-100"></div>
						<div style="margin-left: 35px;  margin-top: 8px;" class="col">
							<input   class="input-cust-name" type="number" name="LTV_new"  value="<?php if(!empty($row_more)){echo $row_more->LTV_new;}?>">
						</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					 <div style="margin-left: 35px;  margin-top: 8px;" class="col">
					...
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
	  					<div class="input-cust-name" style=" margin-top: 8px;">
							<div class="row">
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
									<input  type="radio" name="Legal_report" value="yes" <?php if(!empty($row_more))if ($row_more->Legal_report == 'yes') echo ' checked="true"'; ?> > yes
								</div>
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
								<div class="dis">
									<input   type="radio" name="Legal_report" value="no"  <?php if(!empty($row_more))if ($row_more->Legal_report == 'no') echo ' checked="true"'; ?>> no
								</div>
						 </div>
							</div>	
						</div>  
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
						...
						<div class="w-100"></div>
						<div style="margin-left: 35px;  margin-top: 8px;" class="col">
							<input   class="input-cust-name" type="text" name="FOIR"  value="<?php if(!empty($data_credit_analysis)){ if($data_credit_analysis->foir){ echo $data_credit_analysis->foir;}}?>">
						</div>
				</div>
...
<!------------Personal Details--------------------- -->
	...
	<div class="row shadow bg-white rounded margin-10 padding-15" >
				<div class="row col-12 justify-content-center">
					<div>
					<a href="<?php echo base_url()?>index.php/Operations_user/customers">
