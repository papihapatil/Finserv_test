									   ...
									   <div>
										   <div class="">
											   <div class="row">
												   ...
												   <div class="col-sm-3">
													   <lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Add Request&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/retailers/addnewrequest?type=request">
                                                   ...
                                                   <input type="text" hidden value="<?php echo $s;?>" id="filter">
													  ...
													  <!-- <select class="form-control" aria-label="Default select example" name="select_filters_invoice_retailer" id="select_filters_invoice_retailer">
...
function demo()
  ...
  icon: "success",
			...
			<?php $_SESSION['message'] = ''; $_SESSION['title'] = ''; } ?>
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
                    ...
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/retailers/listrequest",
					'data':{filter:filter},
                },
