									   ...
									   <div>
										   <div class="">
											   <div class="row">
												   ...
												   <div class="col-sm-2" >
                                                   <input type="text" hidden value="<?php if(isset($s)){echo $s;}?>" id="filter">
                                                               ...
                                                               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                                   <div style=" margin-top: 8px;" class="col">
                                                                    <label for="email" style="font-size: 16px; color: black; font-weight: bold;">End Date</label>
                                                                     <input  class="form-control"  type="date" name="End_Date" value="<?php if(!empty($_REQUEST['End_Date'] )){echo $_REQUEST['End_Date']; }?>" id="End_Date"  >
                                                                  </div>  
                                                               </div> 
															   <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                                                                    <div style=" margin-top: 8px;" class="col">
																		...
																		<!-- <select class="form-control"  name="status" id="status">
																		 ...
																		 <select class="form-control" aria-label="Default select example" name="status" id="select_filters_invoice_retailer_reports">
        ...
        buttons: [
            'copy', 'csv', 'excel', 'pdf', 'print'
                ...
                'ajax': {
                    ...
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/retailers/listreport",
				
					'data':{ Start_Date: "<?php if(!empty($_REQUEST['Start_Date'])){echo $_REQUEST['Start_Date'];} ?>", End_Date : "<?php if(!empty($_REQUEST['End_Date'])){echo $_REQUEST['End_Date'];} ?>", Bank_name : "<?php if(!empty($_REQUEST['Bank_name'])){echo $_REQUEST['Bank_name'];} ?>", convinincecharges : "<?php if(!empty($_REQUEST['convinincecharges'])){echo $_REQUEST['convinincecharges'];} ?>", netdisbursed : "<?php if(!empty($_REQUEST['netdisbursed'])){ echo $_REQUEST['netdisbursed'];} ?>", retailername : "<?php if(!empty($_REQUEST['retailername'])){echo $_REQUEST['retailername'];} ?>",status : "<?php if(!empty($_REQUEST['status'])){echo $_REQUEST['status'];} ?>"} , 
                },
