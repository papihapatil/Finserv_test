...
<form method="POST" action="<?php echo base_url(); ?>index.php/retailers/updatepayment" enctype='multipart/form-data' >
	<div class="margin-10 padding-5">
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			<div class="row justify-content-center col-12">
				<span style="margin-top: 15px; font-size: 16px; color: black; font-weight: bold;">Manage Payment</span>
<input type="file" name="file" class="form-control">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  					...
  					<input  required placeholder="Enter invoice amount*"  disabled  class="input-cust-name" type="text"  title="Please enter invoice amount" name="invoiceamount" oninput="maxLengthCheck(this)" maxlength="10" value="<?php echo $invoice->invoiceamount;?>">
  				</div> 
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div style="margin-top: 20px;" class="col">
				<span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:15px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-university"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Loan Tenure *</span>
				</div>			
				<div class="w-100"></div>
				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
					<select  required class="input-cust-name" name="loantenure" > 
					<option value="">Select Status *</option>
					<option <?php if($invoice->invoicestatus == '0') { echo " selected ";  } ?>  value="0">Immidiate (Self)</option>
					<option <?php if($invoice->invoicestatus == '15') { echo " selected ";  } ?>  value="15">15 Days</option>
					<option  <?php if($invoice->invoicestatus == '20') { echo " selected ";  } ?> value="20">20 Days</option>
					
					<option  <?php if($invoice->invoicestatus == '30') { echo " selected ";  } ?> value="30">30 Days</option>
					
					
					
					<option  <?php if($invoice->invoicestatus == '60') { echo " selected ";  } ?> value="60">60 Days</option>
  			...
  			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
					<select disabled required class="input-cust-name" name="invoicestatus" > 
					<option value="">Select Status *</option>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
			<link href="http://localhost/dsa/dsa/adminn/css/style.css" rel="stylesheet">
            <link href="http://localhost/dsa/dsa/css/style1.css" rel="stylesheet">
			<link href="http://localhost/dsa/dsa/adminn/vendors/@coreui/chartjs/css/coreui-chartjs.css" rel="stylesheet">
			<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
