...
<form method="POST" action="<?php echo base_url(); ?>index.php/retailers/update_request" enctype='multipart/form-data' >
	<div class="margin-10 padding-5">
		<div style="line-height: 40px; margin-left: 10px; margin-top: 20px;" class="row">
			<div style="color: black; font-size: 14px;" class="font-poppins-regular col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
			<input  type="text" name="requestid" value="<?php  echo $this->input->get('requestid')?>" hidden>
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			...
			<div style="margin-top: 0px;" class="col">
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  					...
  					<input  required placeholder="Enter invoice amount*" class="input-cust-name" type="text"  title="Please enter invoice amount" name="invoiceamount"  oninput="maxLengthCheck(this)" maxlength="10" value="<?php echo $Request->invoiceamount;?>" >
  				</div> 
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  				<input  required placeholder="Enter invoice amount*" class="input-cust-name" type="text"  title="Please enter invoice amount" name="interestrate" id="interestrate" oninput="maxLengthCheck(this)" maxlength="10" readonly value="<?php echo $product_details->interestrate;?>" readonly>
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  					<input  required placeholder="Enter invoice issued by *" type="hidden" class="input-cust-name"  title="Please enter invoice issued by name" name="invoiceissuedby" value="test<?php echo $Request->invoiceissuedby;?>" readonly>
  				<input  required placeholder="Total amount *" type="text" readonly class="input-cust-name"  title="Please enter invoice issued by name" name="totalamount" id="totalamount" value="<?php echo $Request->fundingamount;?>" readonly>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  					<input  required placeholder="Enter Product *" class="input-cust-name" type="hidden" name="product" value="<?php echo $Request->product;?>" minlength="8" maxlength="75">
					<input  required placeholder="Enter Product *" class="input-cust-name" type="text" readonly name="loanproduct" value="<?php echo $product_details->name;?>" minlength="8" maxlength="75" readonly>
  				</div> 
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  					<input  required placeholder="Enter Funding/ Disb. Amount *" class="input-cust-name"  title="Please enter invoice issued by name" name="funding" id="funding" value="<?php echo $Request->disbursedamount;?>" >
  				</div> 
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  				<input  required placeholder="Total charges *" type="text" readonly class="input-cust-name"  title="Please enter invoice issued by name" name="totalcharges" id="totalcharges" value="<?php echo $Request->totalcharges;?>" readonly>
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  				<input  required placeholder="Enter invoice amount*" class="input-cust-name" type="text"  title="Please enter invoice amount" name="processingfeetype"  id="processingfeetype" oninput="maxLengthCheck(this)" maxlength="10" readonly value="<?php echo $product_details->processingfeetype;?>" readonly>
  			...
  			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
					<input  required  max="<?php echo date('Y-m-d');?>" class="input-cust-name" type="date" name="invoicedate" id="invoicedate" value="<?php echo $Request->invoicedate;  ?>" >
				</div>
			  	<div class="w-100"></div>
				...
				<div class="w-100"></div>
				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
				<select  required class="input-cust-name" name="loantenure" id="loantenure" readonly>
				<option value="">Select </option>
				<?php foreach($tenure as $row) { ?>
				
				<option value="<?php echo $row; ?>" <?php if($Request->tenure==$row){ echo 'selected'; }?> ><?php echo $row; ?> Days</option>
				...
				<div class="w-100"></div>
				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
					<select  required class="input-cust-name" name="DistributorList" readonly> 
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  				<input  required placeholder="Enter invoice amount*" class="input-cust-name" type="text"  title="Please enter invoice amount" name="processingfee" id="processingfee" oninput="maxLengthCheck(this)" maxlength="10" readonly value="<?php echo $product_details->processingfee;?>" readonly>
			...
			<div style="margin-top: 20px;" class="col">
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  				<input  required placeholder="Enter Remarks*" class="input-cust-name" type="text"  title="Please enter remarks" name="remarks"  id="remarks" oninput="maxLengthCheck(this)" maxlength="160"  value="<?php echo $Request->remark;?>" >

  				</div> 
			</div>
			<?php  if($Request->status=='Revert By Distributor'){?>
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			  <div style="margin-top: 20px;" class="col">
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  				<input  required placeholder="Enter Remarks*" class="input-cust-name" type="text"  title="Please enter remarks"  oninput="maxLengthCheck(this)" maxlength="160"   value="<?php echo $Request->remark_by_distributor;?>" readonly>
...
<form method="POST" action="<?php echo base_url(); ?>index.php/retailers/update_request_new" enctype='multipart/form-data' >
	<div class="margin-10 padding-5">
		<div style="line-height: 40px; margin-left: 10px; margin-top: 20px;" class="row">
			<div style="color: black; font-size: 14px;" class="font-poppins-regular col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  					<input  required placeholder="Enter Product *" class="input-cust-name" type="hidden" name="product"  minlength="8" maxlength="75">
					<input  required placeholder="Enter Product *" class="input-cust-name" type="text" readonly name="loanproduct" value="<?php echo $product_details->name;?>" minlength="8" maxlength="75">
  				</div> 
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  					<input  required placeholder="Enter Funding/ Disb. Amount *" class="input-cust-name"  title="Please enter invoice issued by name" name="funding" id="funding" value="<?php echo $Request->fundingamount;?>" >
  				</div> 
  			...
  			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div style="margin-top: 20px;" class="col">
					...
					<div class="w-100"></div>
					<div style="margin-left: 20px;  margin-top: 8px;" class="col">
					<input  required placeholder="Enter Remarks*" class="input-cust-name" type="text"  title="Please enter remarks"  oninput="maxLengthCheck(this)" maxlength="160"   value="<?php echo $Request->remark_by_distributor;?>" readonly>
		...
		<?php if($Request->status=='SendBack By Distributor'){?>
		    <div style="margin-top: 20px;" class="row col-12 justify-content-center">
				<div >
