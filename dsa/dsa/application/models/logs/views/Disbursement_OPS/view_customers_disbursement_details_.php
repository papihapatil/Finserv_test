													...
													<br>
																...
																<div class="col-sm-10" style="border:1px solid gray;">
																	...
																	<div id="loan_application_form_" style="display:none">
																		<br>
																		<h4 id="">Upload POST SANCTIONED DOCUMENTS</h4>
																		<div style="overflow-x:auto;">
																			<table class="table table-bordered" >
																				<thead>
																					<td>DOCUMENT TYPE</td>
																				...
																				<tbody>
																					<tr>
																						<td><i class="fa fa-upload" data-toggle="modal" data-target="#loan_application_form_model"></i>&nbsp;&nbsp;Loan Application Form </td>
																					...
																					<tr>
																						<td><i class="fa fa-upload" data-toggle="modal" data-target="#loan_application_form_model"></i>&nbsp;&nbsp;Signed Loan Agreement</td>
																				...
																				<tr>
																					<td><i class="fa fa-upload" data-toggle="modal" data-target="#loan_application_form_model"></i>&nbsp;&nbsp;Signed Sanction Letter</td>
																				...
																				<tr>
																					<td><i class="fa fa-upload" data-toggle="modal" data-target="#loan_application_form_model"></i>&nbsp;&nbsp;Signed MITC Letter</td>
																				...
																				<tr>
																					<td><i class="fa fa-upload" data-toggle="modal" data-target="#loan_application_form_model"></i>&nbsp;&nbsp;Bank signature verification</td>
																				   ...
																				   <?php
																					...
																					<tr>
																					<td><i class="fa fa-upload" data-toggle="modal" data-target="#loan_application_form_model"></i>&nbsp;&nbsp;Vernacular Declaration</td>
																				...
																				<tr>
																					<td><i class="fa fa-upload" data-toggle="modal" data-target="#loan_application_form_model"></i>&nbsp;&nbsp;Dual name declatarion</td>
																				...
																				<tr>
																					<td><i class="fa fa-upload" data-toggle="modal" data-target="#loan_application_form_model"></i>&nbsp;&nbsp;End use letter</td>
																				...
																				<tr>
																					<td><i class="fa fa-upload" data-toggle="modal" data-target="#loan_application_form_model"></i>&nbsp;&nbsp;Pre EMI letter</td>
