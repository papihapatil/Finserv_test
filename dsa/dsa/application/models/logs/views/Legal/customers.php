        ...
        $(document).ready(function(){
            $('#empTable').DataTable({
                ...
                'ajax': {
                    ...
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/Legal/customers_PG"
                },
            ...
            $('#empTable').DataTable().column(0).visible(false);
			 $('#empTable').DataTable().column(3).visible(false);
			$('#empTable').DataTable().column(4).visible(false);
        });
        </script>
