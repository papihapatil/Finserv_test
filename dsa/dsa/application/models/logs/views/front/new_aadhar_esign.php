...
<?php
  ...
  $message = $this->session->flashdata('sucess');   if (isset($message)) {
		if($message=='sucess'){
			...
			// {
				echo '<script> swal("success!", "mail sent successfully.", "success");</script>';
			...
			<div class="container">
				...
				<?php $message = $this->session->flashdata('sucess');   if (isset($message)) {?>
								...
								<!--<div class="alert alert-success" role="alert">
							    	<?php echo 'Mail send Sucessfully'; ?>
				...
				<div class="card border-light mb-3" style="max-width: 80rem;">
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<!-- Contact Form -->
								<form  method="post" action="<?php echo base_url('index.php/front/check_payment_details_new_aadhar_esign')?>" enctype="multipart/form-data">
									<div class="row">
								...
								<div>
									...
									<div class="form-group text-center">
										<!--<button type="submit"  id="btn-credit" class="btn btn-lg btn-primary col-3">SUBMIT</button>--->
...
<!--<script type="text/javascript">
	$(document).ready(function(){ 
		...
		$('#btn-credit').click(function(e){
			...
			var url = "<?php echo site_url('front/save_credit_bureau')?>";
			...
			$.ajax({
				...
				success:function(data){
					 swal("success!", "Data Save Sucessfully!", "success");
								...
								e.preventDefault();
									 ...
									 $.ajax({
											...
											success:function(data){
												...
												if(obj.status==1)
												{
													swal("success!", " Verified OTP Sucessfully.No need to verify OTP", "success");
