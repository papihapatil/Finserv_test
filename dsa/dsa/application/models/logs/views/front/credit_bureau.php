...
<?php
  ...
  $message = $this->session->userdata('check_payment');   if (isset($message)) {
        ...
        echo '<script>  swal({
							  ...
							  text: "You have to pay '.$credit_buerau_price.'Rs for Credit Bureau",
							  icon: "success",
							  buttons: true,
							  dangerMode: false,
							})
	...
	<div class="header-content">
		<div class="form-2">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<h2>Credit Bureau Information</h2>
					</div> <!-- end of col -->
				</div> <!-- end of row -->
				...
				<div class="card border-light mb-3" style="max-width: 80rem;">
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<!-- Contact Form -->
								<form id="credit-form" action="<?= base_url('index.php/front/check_payment_details')?>" method="post">
									<div class="row">

										<div class="col-sm-4">
											<div class="form-group">
											
												<label for="">First Name </label><label style="color :red;">*</label>
										...
										<div class="col-sm-4">
											<div class="form-group">
												<label for="">Last Name</label><label style="color :red;">*</label>
										...
										<div class="col-sm-4">
											<div class="form-group">
												<label for="">Gender</label><label style="color :red;">*</label>
										...
										<div class="col-sm-4">
											<div class="form-group">
												<label for="">Pan Number </label><label style="color :red;">*</label>
												<input type="text" name="pan" class="form-control" id="pan" placeholder="e.g. COKPG9558B" pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}" required  value="<?php if(isset($this->session->userdata['userdata']['pan_number'])){echo $this->session->userdata['userdata']['pan_number'];}?>">
												<span style="font-size:10px;" class="text-muted">(Five characters, Four digits and again One character)</span>
												<div class="help-block with-errors"></div>
											</div>
										</div>
										...
										<div class="col-sm-3">
											<div class="form-group">
												<label for="">Address Line 1 </label><label style="color :red;">*</label>
										...
										<div class="col-sm-3">
											<div class="form-group">
												...
												placeholder="Enter Address Line 2" value="<?php if(isset($this->session->userdata['userdata']['address2'])){echo $this->session->userdata['userdata']['address2'];}?>" >
												<div class="help-block with-errors"></div>
											</div>
										</div>
										...
										<div class="col-sm-3">
											<div class="form-group">
												...
												placeholder="Enter Address Line 3" value="<?php if(isset($this->session->userdata['userdata']['address3'])){echo $this->session->userdata['userdata']['address3'];}?>" >
												<div class="help-block with-errors"></div>
											</div>
										</div>
										...
										<div class="col-sm-3">
											<div class="form-group">
												...
												<label for="">Date Of Birth</label><label style="color :red;">*</label>
										...
										<div class="col-sm-3">
											<div class="form-group">
												<label for="">Pincode</label><label style="color :red;">*</label>
										...
										<div class="col-sm-3">
											<div class="form-group">
												<label for="">Mobile </label><label style="color :red;">*</label>
