			...
			<div class="row col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				<div class="col">
					...
					<div style="margin-left: 35px; margin-top: 0px;" class="col">
						...
						<input  hidden style="margin-top: 8px;" placeholder="Last Name *" class="input-cust-name" type="text" name="ID" id="ID" minlength="3" maxlength="30" required  value="<?php echo $row->UNIQUE_CODE;?>" oninput="validateText(this)">
	  				</div>
	  				<div class="w-100"></div>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
	  				...
	  				<?php } else { ?>
	  						<input style="margin-top: 1px;" required placeholder="Address Line 1 *" class="input-cust-name" type="text" name="per_add_1"  id="per_add_1" minlength="3" maxlength="30">
	  					<input style="margin-top: 8px;" placeholder="Address Line 2 " class="input-cust-name" type="text" name="per_add_2"  id="per_add_2" minlength="3" maxlength="30">
	  					<input style="margin-top: 8px;" placeholder="Address Line 3" class="input-cust-name" type="text" name="per_add_3"  id="per_add_3" minlength="3" maxlength="30">
	  				<?php } ?>
  				</div>  	
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div id="per_city_div" style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input placeholder="City *" class="input-cust-name" name="per_city" id="per_city" value="<?php if(!empty($row_more))echo $perAddPresent? $row_more->PER_ADDRS_CITY : $row_more->RES_ADDRS_CITY ;?>" minlength="3" maxlength="30">
  				</div>  			  				
			</div>
