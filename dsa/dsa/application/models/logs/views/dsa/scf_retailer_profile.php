...
<form method="POST" action="<?php echo base_url(); ?>index.php/dsa/dsa_update_profile_one_new_action" id="retailer_update_profile_one_new_action" enctype="multipart/form-data">
    ...
    <div class="row shadow bg-white rounded margin-10 padding-15" style="margin: 20px;">
        ...
        <div class="row  col-12">
            ...
            <span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-map-signs"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Do you have GST Number</span>
				<div class="radio" style="padding-left: 40px;">
					
				    <input class="radio" type="radio" name="gst_avail" value="yes" id="gst_yes" required > <label class="exampleFormControlFile1" >Yes</label>
				</div>
			</div>
			<div class="col-sm-3" style="padding-left: 40px;">
             <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; "></span>
				<div class="radio">
					<input class="radio" type="radio" name="gst_avail" value="no" id="gst_no" required > <label class="exampleFormControlFile1" > NO </label>
				</div>
			</div>
        </div>
            
            <div class="row  col-12" id="gst_availble" style="display:none">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" >
                    <div style="margin-top: 0px;" class="col">
                        ...
                        <textarea  type="text"   class="input-cust-name"    name="Buisness_add" id="Buisness_add" style="height:100px"   readonly><?php if(isset($row)){ echo $row->dsa_address_line_1; } ?></textarea>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" >
                        <div style="margin-top: 0px;" class="col">
                            ...
                            <input  type="text"   class="input-cust-name"     name="Buisness_con" id="Buisness_con"   style="text-transform:uppercase" value="<?php if(isset($row)){ echo $row->Buisness_con; } ?>" readonly >
                        </div>
                </div>
            ...
            <div class="row  col-12" id="gst_notavailble" style="display:none">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" >
                    <div style="margin-top: 0px;" class="col">
                        ...
                        <label class="" for="" style="font-size: 12px;">&nbsp;</label>
                        <textarea  type="text"   class="input-cust-name"    name="Buisness_add" id="Buisness_add_2" style="height:100px"   ><?php if(isset($row)){ echo $row->dsa_address_line_1; } ?></textarea>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" >
                    <div style="margin-top: 0px;" class="col">
                        <span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-map-signs"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Current Business address *</span>
                            ...
                            <textarea  type="text"   class="input-cust-name"    name="Buisness_add_current" id="Buisness_add_current_2" style="height:100px"   ><?php if(isset($row)){ echo $row->dsa_address_line_2; } ?></textarea>
                        </div>	
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" >
                        <div style="margin-top: 0px;" class="col">
                            ...
                            <select name="Buisness_con_2" id="Buisness_con_2" class="form-control">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" id="prop_con_2"  style="margin-top: 21px;">
                         <!--<a class="btn btn-primary " id="add_propriter" style="color:white;"  data-toggle="modal" data-target="#myModal5" >Add Propriter</a>-->
                </div>
            </div>
            <div class="row  col-12">
                <div class="col-sm-3"  style="padding-left: 30px;">
                <span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-map-signs"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Do you have Buisness pan</span>
                    <div class="radio" style="padding-left: 40px;">
                        
                        <input class="radio" type="radio" name="pan_avail" value="yes" id="pan_yes" required> <label class="exampleFormControlFile1">Yes</label>
                    </div>
                </div>
                <div class="col-sm-3" style="padding-left: 40px;">
                <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; "></span>
                    <div class="radio">
                        <input class="radio" type="radio" name="pan_avail" value="no" id="pan_no"  required> <label class="exampleFormControlFile1"> NO </label>
                    </div>
                </div>
            </div>
            <div class="row  col-12" id="pan_available" style="display:none">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    <div style="margin-top: 0px;" class="col">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    <div style="margin-top: 0px;" class="col">
                        <span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-map-signs"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; "> Firm Name AS Per Pan Number * </span>
                            <input  placeholder="Name on PAN *" class="input-cust-name"   type="text" name="nameonpan" id="nameonpan" title="" <?php if(!empty($row)){ if( $row->verify_retailer_dis_pan=='true'){echo 'readonly ';} }?> value="<?php echo $row->nameonpan; ?><?php /*if(isset($row->PAN_NUMBER)){ echo  preg_replace("/(?!^).(?!$)/", "*", $row->PAN_NUMBER);} */?>"  >
                    </div>  																	
                </div>
...
<script>
            ...
            $('#gst_yes').click(function (e)
            {
                $("#gst_availble").css("display", "block");
                $("#gst_notavailble").css("display", "none");
                $("#GST_number").attr('required','true');
                $("#Buisness_add").attr('required','true');
                $("#Buisness_add_current").attr('required','true');
                $("#Buisness_name").attr('required','true');
                $("#Buisness_con").attr('required','true');

                $("#Buisness_add_2").removeAttr("required");
                $("#Buisness_add_current_2").removeAttr("required");
                $("#Buisness_con_2").removeAttr("required");
               
            });
            $('#pan_yes').click(function (e)
            {
                $("#pan_available").css("display", "block");

                $("#pan").attr('required','true');
                $("#verify_pan_status").attr('required','true');
                $("#nameonpan").attr('required','true');
                $("#verify_pan_response_bis").attr('required','true');
               
            });
            $('#pan_no').click(function (e)
            {
                $("#pan_available").css("display", "none");
                $("#pan").removeAttr("required");
                $("#verify_pan_status").removeAttr("required");
                $("#nameonpan").removeAttr("required");
                $("#verify_pan_response_bis").removeAttr("required");
               
            });
            $('#gst_no').click(function (e)
            {
                $("#gst_availble").css("display", "none");
                $("#gst_notavailble").css("display", "block");
                $("#GST_number").removeAttr("required");
                //$("#GST_number").removeAttr("required");
               
                $("#Buisness_add").removeAttr("required");
                $("#Buisness_add_current").removeAttr("required");
                $("#Buisness_name").removeAttr("required");
                $("#Buisness_con").removeAttr("required");
                $("#Buisness_add_2").attr('required','true');
                $("#Buisness_add_current_2").attr('required','true');
                $("#Buisness_con_2").attr('required','true');
            ...
            $('#Buisness_con_2').on('change', function() { 
                var bis_con=$('#Buisness_con_2').val();
                            if(bis_con=='PRIVATE LIMITED COMPANY')
                                {
                                $('#prop_con_2').html(
                                '<a class="btn btn-primary " id="add_propriter" style="color:white;"  data-toggle="modal" data-target="#myModal5" >Add Directors</a>'
                               ...
                               else if(bis_con=='PARTNERSHIP')
                               {
                                $('#prop_con_2').html(
                                '<a class="btn btn-primary " id="add_propriter" style="color:white;"  data-toggle="modal" data-target="#myModal5" >Add proprietor</a>'
                                );
                                $('#prop_name').html(
                                   '<b>proprietor name</b>'
                               ...
                               else if(bis_con=='PROPRIETORSHIP')
                               {
                                $('#prop_con_2').html(
                                '<a class="btn btn-primary " id="add_propriter" style="color:white;"  data-toggle="modal" data-target="#myModal5" >Add proprietor</a>'
                                );
            ...
            $('#continue3').on('click',function(e)
            {
                ...
                if ($("#gst_yes").prop("checked")) 
                {
                        if(verify_GST_status=='true')
                                {
                                ...
                                {
                                    e.preventDefault();
                                    swal("Warning!", "Please Verify GST Document", "warning");
                                    
                                }
                  
                    }
                    if ($("#pan_yes").prop("checked")) 
                    {
                            if(verify_pan_status=='true')
                                    ...
                                    {
                                        e.preventDefault();
                                        swal("Warning!", "Please Verify PAN Number", "warning");
