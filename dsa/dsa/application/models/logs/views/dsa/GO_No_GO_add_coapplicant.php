...
<div class="row shadow bg-white rounded margin-10 padding-15" style="padding-right:20px;">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input required placeholder="Enter landmark *" class="form-control" type="text" name="resi_landmark" id="resi_landmark" value="<?php if(isset($Coapplicant_row))echo $Coapplicant_row->RES_ADDRS_LANDMARK;?>" minlength="3" maxlength="30">
  				</div>  			  				
				...
				<div style="margin-left: 35px; margin-top: 8px;" class="col">
					<select required class="form-control resi_prop_type" name="resi_sel_property_type" > 
						...
						<option value="Self Owned" <?php if(!empty($Coapplicant_row))if ($Coapplicant_row->RES_ADDRS_PROPERTY_TYPE == 'Self Owned') echo ' selected="selected"'; ?>>Self Owned</option>
					    <option value="Parental/Ancestral" <?php if(!empty($Coapplicant_row))if ($Coapplicant_row->RES_ADDRS_PROPERTY_TYPE == 'Parental/Ancestral') echo ' selected="selected"'; ?>>Parental/Ancestral</option>
					    <option value="Rental personal Family" <?php if(!empty($Coapplicant_row))if ($Coapplicant_row->RES_ADDRS_PROPERTY_TYPE == 'Rental personal Family') echo ' selected="selected"'; ?>>Rental personal Family</option>
					    <option value="Shared Rental Accomodation" <?php if(!empty($Coapplicant_row))if ($Coapplicant_row->RES_ADDRS_PROPERTY_TYPE == 'Shared Rental Accomodation') echo ' selected="selected"'; ?>>Shared Rental Accomodation</option>
					</select>
