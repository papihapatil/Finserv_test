<div style="line-height: 40px; margin-left: 10px; margin-top: 20px;" class="row">
			...
			<div class="card shadow col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12" style="margin-bottom: 10px;"> 
				...
				<?php if($error!=''){?> 
						...
						<?php } else if($doc_type=='business'){?>	
							<span style="color:black;font-size:16px;padding:10px;margin-bottom:10px;">Upload Business Proof Document</span>
						<?php } else if($doc_type=='employment'){?>	
							<span style="color:black;font-size:16px;padding:10px;margin-bottom:10px;">Upload Employment Proof Document</span>
						<?php }?>
						...
						<div class="row col-12 justify-content-center">
							...
							<?php if($doc_type=='residential' && !empty($documents_type)){?><label class='doctype'>Residential Proof<?php if($doc_type=='residential'){ foreach($doc_types as $doc_t){if($doc_t->DOC_MASTER_TYPE=='residential'){?><spna style="margin-left:3px;padding-left:2px;padding-right:2px;"class="fullCircle"><i class="fa fa-check" style="color:green;"></spna> </i><?php } else if($doc_type=='residential'|| $doc_count >2){ ?><spna style="margin-left:3px;padding-left:2px;padding-right:2px;"class="fullCircle"><i class="fa fa-cloud-upload" style="color:green;"></spna></i><?php } } } }?></label>
							<?php if($doc_type=='income'  && !empty($documents_type) ){?><label class='doctype'>Income Proof<?php if($doc_type=='income'){ foreach($doc_types as $doc_t){if($doc_t->DOC_MASTER_TYPE=='income'){?> <spna style="margin-left:3px;padding-left:2px;padding-right:2px;"class="fullCircle"><i class="fa fa-check" style="color:green;"></spna></i><?php  break;} else if($doc_type=='income'){ ?><spna style="margin-left:3px;padding-left:2px;padding-right:2px;"class="fullCircle"><i class="fa fa-cloud-upload" style="color:green;"></spna></i><?php }} }}?></label>
			...
			<div class="card shadow col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12" style="margin-bottom: 10px;"> 
				<div class="row" style="margin: 5px;">
					<div style="width:100%;"> 
						...
						<form  action="<?php echo base_url(); ?>index.php/customer/do_upload_dsa_document" method="post" enctype="multipart/form-data">					  		
						<div class="row">
								...
								<div class="row">
									<div >
										<label style="font-size: 12px;" for='file-upload' class='custom-file-upload'>
							  			...
							  			<input id='file-upload' type='file' name='userfile[]' multiple />
		...
		<?php if(!empty($row))if($row->DOC_MASTER_TYPE == "income" || $row->DOC_MASTER_TYPE == "INCOME" || $row->DOC_MASTER_TYPE == "residential"  ) {?>
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                ...
	                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/customer/delete_doc" method="POST" id="doc_delete_dsa_form">
