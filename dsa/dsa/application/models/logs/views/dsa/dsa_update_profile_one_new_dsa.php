			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
  			...
  			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
					...
					<input  class="input-cust-name" type="text" name="dob" id="dob" value="<?php if(!empty($row->DOB)){echo $DOB;}?>" readonly>
				</div>
			  	<div class="w-100"></div>
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input pattern="^\d{4}\s\d{4}\s\d{4}$" required placeholder="Aadhar *" class="input-cust-name" maxlength="14" title="Please enter valid 12 digit aadhar number" type="text" name="aadhar" id="aadhar_number" oninput="aadharValidate(this)" value="<?php echo $AADHAR_NUMBER;?>">
  				</div>  			  				
			</div>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				...
  				<div style="margin-left: 35px; margin-top: 8px;" class="col">
  					<input pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}" required placeholder="PAN number *" class="input-cust-name" type="text" name="pan" title="Please enter valid PAN number"    value="<?php echo $PAN_NUMBER;?>" style="text-transform:uppercase">
  				</div>  			  				
			</div>
		</div>
