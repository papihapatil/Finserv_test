...
<form method="POST" action="<?php echo base_url(); ?>index.php/dsa/dsa_update_profile_one_new_action" id="dsa_update_profile_one_new_action">
	<div class="margin-10 padding-5">
		...
		<?php $s=$this->input->get('id'); if($s==''){$s=$this->session->userdata('ID');} if($s==$this->session->userdata('ID')){?>
			...
			<a href="<?php echo base_url();?>index.php/dsa/update_basic_profile?id=<?php  echo $id ;?>" ><i style="width: 30px; height: 30px;" alt="mahesh" class="fa fa-edit"></i>Edit</a>
	...
	<?php if(!empty($row))	{if($row->ROLE==27 || $row->ROLE==29 )  { $dsa_BANK_DETAILS=json_decode($row->dsa_BANK_DETAILS_JSON, true);?>
													...
													<div class="row shadow bg-white rounded margin-10 padding-15">
													   ...
													   <div class="row shadow bg-white rounded margin-10 padding-15">
														...
														<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
														 	<div style="margin-top: 0px;" class="col">
															   <span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-map-signs"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Retailer</span>
															</div>	
                											<div class="w-100"></div>
  													  		<div style="margin-left: 35px; margin-top: 8px;" class="col">
																<input  placeholder="Retailer remark"  <?php if($userType != 'retailer') { ?> readonly <?php } ?>  class="input-cust-name" type="text"  name="Remark_Retailer" id="Remark_Retailer"  value="<?php if(!empty($row)){echo $row->retailerremark;} ?>">
															</div>  			  				
														</div>
			                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
														 	<div style="margin-top: 0px;" class="col">
															   <span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-map-signs"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Distributor</span>
															</div>	
                											<div class="w-100"></div>
  													  		<div style="margin-left: 35px; margin-top: 8px;" class="col">
  																<input  placeholder="Distributor remark" <?php if($userType != 'distributor') { ?> readonly <?php } ?> class="input-cust-name" type="text"  name="Remark_Distributor" id="Remark_Distributor"   value="<?php if(!empty($row)){echo $row->distributorremark;} ?>">
															</div>  			  				
														</div>
														<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
														 	<div style="margin-top: 0px;" class="col">
															   <span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-map-signs"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">SCF Manager</span>
															</div>	
                											<div class="w-100"></div>
  													  		<div style="margin-left: 35px; margin-top: 8px;" class="col">
																<input  placeholder="SCF manager remark" <?php if($userType != 'supplychainmanager') { ?> readonly <?php } ?> class="input-cust-name" type="text"  name="Remark_Scf" id="Remark_Scf"   value="<?php if(!empty($row)){echo $row->scfremark;} ?>">
															</div>  			  				
														</div>
													</div>
		...
		<?php if(!empty($row))	{if($row->ROLE==29 || $row->ROLE==27 )  {  ?>
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="docs">
																...
																<?php $i++; } ?>
																			...
																			<div class="row justify-content-center col-12 padding-15">		<?php

		//	print_r($row->SCFSTATUS);												
			if($userType == 'distributor')
			{
																			if(isset($row->STATUS) && ($row->STATUS=='Approved' || $row->STATUS=='Reject' || $row->STATUS=='SendBack') )
			{
				echo $approve_btn='<div><a style="margin-left: 8px;"  class="btn btn-success disabled"> Distributor '.$row->STATUS.' </a> </div>';
			}
			else{
			...
			<div >
			<input type="button"  name="Confirm" value="SendBack" id="SendBack" onclick="approve_status('SendBack','<?php echo $row->UNIQUE_CODE; ?>');"  class="login100-form-btn btn btn-primary" >
					
					<input type="button"  name="Confirm" value="Approve" onclick="approve_status('Approved','<?php echo $row->UNIQUE_CODE; ?>');" id="Approve" class="login100-form-btn btn btn-success" >
					
					<input type="button"  name="Confirm" value="Reject" onclick = "approve_status('Reject','<?php echo $row->UNIQUE_CODE; ?>');" id="reject" class="login100-form-btn btn btn-danger" >
			</div>
			...
			if($userType == 'supplychainmanager')
			{
																			if(isset($row->SCFSTATUSE) && ($row->SCFSTATUSE=='Approved' || $row->SCFSTATUSE=='Reject' || $row->SCFSTATUSE=='SendBack') )
			{
				$approve_btn='<div><a style="margin-left: 8px;"  class="btn btn-success disabled">SCFO '.$row->SCFSTATUSE.'</a></div>';
				
				//$approve_btn='<a style="margin-left: 8px;"  name="'.$i.'" id="'.$row->UNIQUE_CODE.'" class="btn btn-success " onclick="approve_scf_status(this)">Approve</a>';
			}
			else{
				?>
				
							
			<!--<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="div44" >
														<div style="margin-top: 0px;" class="col">
			...
			-->
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="div45">
				<input type="button"  name="Confirm" value="SendBack" id="SendBack" onclick="approve_scf_status('SendBack','<?php echo $row->UNIQUE_CODE; ?>');" class="login100-form-btn btn btn-primary" >
					
					<input type="button"  name="Confirm" value="Approve" id="Approve" onclick = "approve_scf_status('Approved','<?php echo $row->UNIQUE_CODE; ?>');" class="login100-form-btn btn btn-success" >
					
					<input type="button"  name="Confirm" value="Reject" id="reject" onclick="approve_scf_status('Reject','<?php echo $row->UNIQUE_CODE; ?>');" class="login100-form-btn btn btn-danger" >
...
function approve_status_old($this)
		{
		...
		function approve_status(status,userid)
		{
			...
			var distributor_remark = $("#Remark_Distributor").val();
			var customer_id=userid;
			$.ajax({
			  type:'POST',
			   url:'<?php echo base_url("index.php/Distributor/update_retailer_status"); ?>',
			  
			  data:{'id':customer_id,'STATUS':status,'distributor_remark':distributor_remark},
			  success:function(data)
			  {
		...
		function approve_scf_status(status,userid)
		{
			...
			var scfremark = $("#Remark_Scf").val();
			var customer_id=userid;
			$.ajax({
			  type:'POST',
			   url:'<?php echo base_url("index.php/Distributor/update_retailer_status_scf"); ?>',
			  
			  data:{'id':customer_id,'SCFSTATUSE':status,'scfremark':scfremark},
			  success:function(data)
			  {
