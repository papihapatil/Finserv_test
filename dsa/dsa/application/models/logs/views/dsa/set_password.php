...
<?php
  ...
  $message = $this->session->flashdata('sucess');   if (isset($message)) {
		if($message=='sucess'){
				...
				echo '<script> swal("success!", "Sign on Successful. \n Password Change Required ", "success");</script>';
	...
	?>
<form id="updatepassword" class="login100-form validate-form" action="<?php echo base_url()?>index.php/dsa/updatepassword_dsa" method="POST">
	<div class="card-body">
	...
	<p class="text-muted"></p>
     ...
     <span>
		Password should contain 8 characters and have atleast one number and one special character
	</span>                   
