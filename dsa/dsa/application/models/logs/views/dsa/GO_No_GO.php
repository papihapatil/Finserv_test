...
?>
																		...
																		?>
																		<div class="col-sm-6">
																			   <textarea hidden class="form-control" id="remarks" name="remarks" rows="2" placeholder="Add Remarks"></textarea>
																			   <input hidden type="text" name="applicant_id" id="applicant_id"value="<?php if(!empty($row2)) echo $row2->UNIQUE_CODE;?>">
																			   <input hidden type="text" name="applicant_name" id="applicant_name"value="<?php if(!empty($row2)) echo "  ".$row2->FN."  ".$row2->LN;?>">
																			   	<input hidden type="text" name="customer_id" id="customer_id"  value="<?php echo $row2->UNIQUE_CODE;?>">
							 														<input hidden type="text" name="dsa_id" id="dsa_id"value="<?php if(!empty($row)) echo $row->UNIQUE_CODE;?>">
																			    <input hidden type="text" name="dsa_name" id="dsa_name" value="<?php if(!empty($row)) echo $row->FN."  ".$row->LN;?>">
																		</div>
