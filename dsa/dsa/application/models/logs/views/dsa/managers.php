            ...
            <div class="row">
            	<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8">
                    <div class="screen-title" style="margin-bottom:10px;">
                    	<small class="screen-title-txt">DSA Managers </small> 
                    </div>                    
                </div>            	
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-4 margin-top-15">
                	<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=manager" class="btn-dsa-new-customer">Add New Manager</a>
            	</div>
            </div>
        </div>
</div>
	            ...
	            <div class="row">
	            	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
	                    <div class="screen-title" style="margin:100px;">
	                    	<small style="border-radius: 10px; padding: 15px; background-color: white;" class="full-black-color">Unable to find any managers.
