...
<div class="font-faticon w3-container margin-top-10 black-color">
  ...
  <div class="w3-bar w3-custom-header-color-one">
    ...
    <button class="w3-bar-item w3-button tablink w3-light-red"><a class="black-color" href="<?php echo base_url()?>index.php/dsa/customer_moreinfo?id=<?php echo $id;?>">MORE INFO</a></button>
