...
<div class="row">
		...
		<div >
			...
			<div class="row">
			    <div class="col-sm-3">
					<a style="margin-left: 9px; background-color: #25a6c6;margin :2px;padding:6px;" href="<?php echo base_url()?>index.php/dsa/new_customer?type=connector" class="btn btn-info" style="background-color: #25a6c6;">Add CSR </a>
                </div>
  				<div class="col-sm-4">
					<div class="screen-title" style="margin-bottom:40px;">                    	
					<form id="credit_saction_form" action="<?= base_url('index.php/dsa/csr')?>" method="post">
...
<select class="form-control" aria-label="Default select example" name="select_filters">
		...
		<option value="all">All CSR's</option>
...
<?php if(count($csrs) != 0) {?>
	<div class="row justify-content-center">
		<div class="screen-title" style="margin-bottom:1%;">
			<h5 style="border-radius: 10px; padding: 15px; background-color: #dcdcdc;"><?php echo count($csrs); ?> Record Found </h5>
    	</div>
		<div class="screen-title" style="margin-left:5%; margin-top:1%;">
		    ...
		    <?php $excelData = json_decode(json_encode($csrs), true);?>
        </div>	
    </div>   
<?php } else{?>
<div class="row justify-content-center">
	<div class="screen-title" style="margin-top:10%;">
		<h5 style="border-radius: 10px; padding: 15px; background-color: #ccc;"><?php echo count($csrs); ?> Record Found </h5> 
	</div>                    
</div> 
<div class="row justify-content-center">
	<div class="screen-title" style="margin-top:2%;">
		<small style="border-radius: 10px; padding: 15px; background-color: white;">CSRS not available in selected filter, please change filter value.</small> 
	</div>                    
</div>            	
<?php }
?>
...
<?php foreach($csrs as $row){?>
	...
	<div class="row justify-content-center" >
		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<a href="<?php echo base_url()?>index.php/dsa/manger_profile_dsa?type=csr&customer_link=true&id=<?php echo $row->UNIQUE_CODE;?>">
				<div class="card mb-3">
