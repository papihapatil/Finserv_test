...
body {
  font-family: Arial, sans-serif;
			...
			<body>
                ...
                <p style="font-size:12px;"> Invoice number <?php echo $request_info->invoicenumber; ?> has been reverted by Supply chain manager with remarks<b>'<?php echo $request_info->remark_by_scfo ?>'</b> </p>
