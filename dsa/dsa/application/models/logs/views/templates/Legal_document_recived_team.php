'<!DOCTYPE html>
  ...
  font-family: Arial, sans-serif;
			...
			<p style="font-size:12px;"> Kindly note that Legal Report for Mr/Mrs. <b><?php echo strtoupper($cust_info->FN).' '.strtoupper($cust_info->LN); ?></b> has been published on our portal under the section Customers > Vendors Report >  </p>
