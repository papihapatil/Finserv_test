			 ...
			 table,td,th{
				 ...
				 body {
					font-family: Arial, sans-serif;
							  ...
							  <p style="font-size:13px;">Thanks you for the Legal Report  of  Mr/Mrs. <b><?php echo  strtoupper($cust_info->FN).' '.strtoupper($cust_info->LN); ?></b>  </p>
							  ...
							  <p style="font-size:13px;">Reason:<?php echo $credit_comment_fi ?></p>
							   <p style="font-size:13px;">Thank You in advance for consideration.</p>
				                   ...
				                   <p style="font-size:13px;">Finaleap Finserv.Pvt.Ltd </p>
								  </body>
								  </html>