...
<body>
&nbsp;Dear Disbursement OPS, 
<div class="container"><br>
 &nbsp;&nbsp;&nbsp; 
 We have handed over / Transfer funds to the customer <?php if(isset($PayeeName)) echo $PayeeName;?> for the amount RS.<?php if(isset($Amount)) echo $Amount;?>  <br><br><br>
