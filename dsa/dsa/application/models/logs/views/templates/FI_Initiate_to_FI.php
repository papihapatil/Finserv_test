...
body {
  font-family: Arial, sans-serif;
			...
			<p style="font-size:12px;"> We would like to inform you that required documents for FI Report of Mr/Mrs. <b>'<?php echo strtoupper($cust_info->FN).' '.strtoupper($cust_info->LN) ?>'</b> has been successfully uploaded on our portal under the section Customers   </p>
			<p style="font-size:12px;"> We solicit your co-operation and request you to provide FI Report at the earliest..</p>
