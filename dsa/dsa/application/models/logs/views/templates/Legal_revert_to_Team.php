<!DOCTYPE html>
			 ...
			 body {
				font-family: Arial, sans-serif;
						  ...
						  <p style="font-size:12px;">This is to inform you that Legal Report request has been on hold due to queries raised by agency in the case of Mr/Mrs. <b><?php echo strtoupper($cust_info->FN).' '.strtoupper($cust_info->LN)?></b>  </p>
