                                    ...
                                    <div class="col-sm-12">
										<div>
											<div class="container">
												...
												<Form action="<?php echo base_url('index.php/RCU/Revert_customer');?>" method="post">
												<div class="row">
												...
												<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
														<div style=" margin-top: 8px;" class="col">
																 ...
																 <textarea name="Comment_by_cpa" class="form-control" id="Comment"  readonly><?php if(!empty($Legal_docs_info)){  echo $Legal_docs_info->credit_comment_RCU; }?></textarea>
														</div>
											</div>
												...
												<div class="text-center">
													<center>
													<?php if(!empty($Legal_docs_info)){if($Legal_docs_info->RCU_status=='Revert From RCU')
													{?>
													<button type="submit" class="btn btn-primary disabled" id="revert_RCU" disabled>Revert To Finaleap</button>
													<?php } else { ?>

													   
													   <button type="submit" class="btn btn-primary" id="revert_RCU">Revert</button>
													<?php } }else{?>
														<button type="submit" class="btn btn-primary" id="revert_RCU">Revert</button>
														<?php } ?>
													</center>
