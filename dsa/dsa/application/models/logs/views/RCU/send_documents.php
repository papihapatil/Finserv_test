                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
											...
											<Form action="<?php echo base_url('index.php/RCU/do_upload_RCU_doc_RCU');?>" method="post" enctype="multipart/form-data" id="RCU_send_doc">
												...
												<?php $i=1;  foreach($documents as $row){?>
													...
													<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
														<div class="row " style="border: 1px solid #edeff1; margin-left:13px; margin-right:13px">
															...
															<div class="col-sm-1"> 	
															<a style="margin-left: 8px; " href="<?php echo base_url();?>index.php/RCU/delete_RCU_doc/<?php echo $row->id; ?>/<?php if(!empty($cust_info)){ echo $cust_info->UNIQUE_CODE;} ?>"><i class="fa fa-trash text-right" style="color:red;"></i></a>
											...
											<Form action="<?php echo base_url('index.php/RCU/RCU_remark');?>" method="post" enctype="multipart/form-data"  id="Remark">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
													...
													<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
															...
															<?php if($this->session->userdata("USER_TYPE")=='RCU'){?>
																<div style=" margin-top: 8px;" class="col">
																	 ...
																	 <br>
																	 <input type="radio" id="html" name="remark" value="Positive" <?php if(isset($Applicant_data)){if($Applicant_data->RCU_remark=='Positive'){  echo 'checked="checked"';}} ?>>
			                                                         <label for="html">Positive </label>
																	 <input type="radio" id="html" name="remark" value="Negative" <?php if(isset($Applicant_data)){if($Applicant_data->RCU_remark=='Negative'){  echo 'checked="checked"';}} ?> required>
			                                                         <label for="html">Negative</label>
																	 <input type="radio" id="html" name="remark" value="Referred" <?php if(isset($Applicant_data)){if($Applicant_data->RCU_remark=='Referred'){  echo 'checked="checked"';}} ?>required>
	 ...
	 $.ajax({
         ...
         success:function(data){
							 ...
							 if(obj.Legal_required=='yes')
							 {
								 ...
								 var url = window.location.origin+"/finaleap_finserv/dsa/dsa/index.php/Legal/get_legal_by_bank";
									$.ajax({
										 type:'POST',
										 url:url,
							 ...
							 if(obj.Technical_required=='yes')
							 {
								 ...
								 var url = window.location.origin+"/finaleap_finserv/dsa/dsa/index.php/Technical/get_Technical_by_bank";
								$.ajax({
									 type:'POST',
									 url:url,
...
<script type="text/javascript">
	$("#RCU_send_doc").submit(function(e) {
									...
									var content='<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">'+
														'<div class="row " style="border: 1px solid #edeff1; margin-left:13px; margin-right:13px">'+
															'<div class="col-sm-10"><a href="'+value.path+'" target="_blank">  <i class="fa fa-file-text" style="color:green" aria-hidden="true"></i> &nbsp; <label for="email" style="font-size: 13px; color: black; font-weight: bold;">'+ value.Doc_name +'</label></a></div>'+
																...
																'<div class="col-sm-1">'+	
															       '<a style="margin-left: 8px; " href="'+window.location.origin+'/finaleap_finserv/dsa/dsa/index.php/RCU/delete_RCU_doc/'+value.id+'/'+unique_code+'"><i class="fa fa-trash text-right" style="color:red;"></i></a>'+
															'</div>'+			
														'</div></div>';
