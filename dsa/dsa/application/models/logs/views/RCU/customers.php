...
<?php
  $result = $this->session->flashdata('result');   if (isset($result)) {
	   if($result=='1'){
			   ...
			   {
			   echo '<script> swal("success!", "Document Deleted Sucessfully", "success");</script>';
																...
																<thead>
																	<tr>
																	  ...
																	  <th >Application id</td>
																	   ...
																	   <th>RCU Remark</th>
																	   <th>View Details</th>
																	   <?php if($this->session->userdata("USER_TYPE")=='RCU'||$this->session->userdata("USER_TYPE")=='FI' ){?>
																	   <th>Upload RCU Document</th>
																	   <?php } ?>
        ...
        $(document).ready(function(){
            $('#empTable').DataTable({
                ...
                'ajax': {
                    ...
                    'url': window.location.origin+"/finaleap_finserv/dsa/dsa/index.php/RCU/customers_PG"
                },
