    ...
    <div >
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
            ...
            <a href="javascript:window.history.go(-1);">
             <button style="margin-top: 10px; margin-right: 245px;" class='uploadbutton'>Back</button>    
           </a>
                      ...
                      <?php 
					   ...
					   ?>
						...
						<a href="<?php echo base_url();?>index.php/logout">
                          <button style="margin-top: 10px; margin-left: 190px;" class='uploadbutton'>Logout</button>    
                        </a>
                    </div>
            </div>
        ...
        <?php } ?>
	<!-------for RO------------------>
		<?php if($userType == 'Chief_Risk_Officer') {?>
			

	
            <div class="w3-sidebar w3-bar-dark w3-card w3-animate-right side-nav-scroll" style="display:none;right:0;" id="rightMenu">
              <button onclick="closeRightMenu()" class="w3-bar-item w3-button w3-large">Close &times;</button> <hr class="hr-margin">
              <a href="<?php echo base_url();?>index.php/Chief_Risk_Officer" class="w3-bar-item w3-button w3-medium"><i class="fa fa-th-large" style="margin-right: 10px;"></i>Dashboard</a>
		 </div>
