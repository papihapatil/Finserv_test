        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link page-scroll"  id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Hi , <?php if(isset($user_details)) echo $user_details->User_name ;?></a>

                </li>
              

                <li class="nav-item">
                    <a class="nav-link page-scroll" href="<?php echo base_url();?>index.php/admin/IDCCR_login">Logout</a>
                </li>
            </ul>
