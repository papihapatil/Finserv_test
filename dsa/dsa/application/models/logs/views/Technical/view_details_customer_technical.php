                                    ...
                                    <div class="col-sm-12">
										<div>
											...
											<?php } ?>
												...
												<Form action="<?php echo base_url('index.php/Credit_manager_user/Update_Legal_user_doc');?>" method="post">
												<div class="row">
													...
													<input type="text" id="credit_id" name="credit_id" value="<?php echo $Legal_docs_info->Credit_id; ?>" hidden >
													<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
														 <div style=" margin-top: 8px;" class="col">
												...
												<?php  foreach($documents as $row){?>
														...
														<div class="row " style="border: 1px solid #edeff1; margin-left:13px; margin-right:13px">
															...
															<div class="col-sm-1"> 	
                                                                ...
                                                                <a href="<?php echo base_url($row->path); ?>" target="_blank" download> <i class="fa fa-download" aria-hidden="true"></i>	</a>																
															</div>
												...
												<div class="text-center">
													<center>
													   ...
													   <button type="submit" class="btn btn-primary" id="revert">Revert</button>
													</center>
												</div>
