                                ...
                                <div class="row">
                                    <div class="col-sm-12">
											...
											<div class="container">
												...
												<h3>Send Documents  </h3><h4 style="color:green;"><?php if(isset($cust_info)){echo $cust_info->FN.' '.$cust_info->LN;} ?></h4>
												</div>
											...
											<Form action="<?php echo base_url('index.php/FI/do_upload_FI_doc_FI');?>" method="post" enctype="multipart/form-data" id="FI_send_doc">
												<div class="row">
												...
												<?php $i=1;  foreach($documents as $row){?>
													...
													<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
														<div class="row " style="border: 1px solid #edeff1; margin-left:13px; margin-right:13px">
															...
															<div class="col-sm-1"> 	
															<a style="margin-left: 8px; " href="<?php echo base_url();?>index.php/FI/delete_FI_doc/<?php echo $row->id; ?>"><i class="fa fa-trash text-right" style="color:red;"></i></a>
											...
											<Form action="<?php echo base_url('index.php/FI/FI_remark');?>" method="post" enctype="multipart/form-data"  id="Remark">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			...
			                                                         <label for="html">Referred</label>
															...
															<?php if($this->session->userdata("USER_TYPE")=='FI'){?>
																<div style=" margin-top: 8px;" class="col">
																	 <label for="email" style="font-size: 16px; color: black; font-weight: bold;"> Remark </label>
																	 <br>
																	 <input type="radio" id="html" name="remark" value="Positive" <?php if(isset($Applicant_data)){if($Applicant_data->fi_remark=='Positive'){  echo 'checked="checked"';}} ?>>
			                                                         <label for="html">Positive </label>
																	 <input type="radio" id="html" name="remark" value="Negative" <?php if(isset($Applicant_data)){if($Applicant_data->fi_remark=='Negative'){  echo 'checked="checked"';}} ?> required>
			                                                         <label for="html">Negative</label>
																	 <input type="radio" id="html" name="remark" value="Referred" <?php if(isset($Applicant_data)){if($Applicant_data->fi_remark=='Referred'){  echo 'checked="checked"';}} ?>required>
			                                                         <label for="html">Referred</label>
															</div>
															<?php } ?>
															<div style=" margin-top: 8px;" class="col">
									...
									var content='<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">'+
														'<div class="row " style="border: 1px solid #edeff1; margin-left:13px; margin-right:13px">'+
															'<div class="col-sm-10"><a href="'+value.path+'" target="_blank">  <i class="fa fa-file-text" style="color:green" aria-hidden="true"></i> &nbsp; <label for="email" style="font-size: 13px; color: black; font-weight: bold;">'+ value.Doc_name +'</label></a></div>'+
																...
																'<div class="col-sm-1">'+	
															       '<a style="margin-left: 8px; " href="'+window.location.origin+'/finserv_test/dsa/dsa/index.php/FI/delete_FI_doc/'+value.id+'/'+Application_Id+'"><i class="fa fa-trash text-right" style="color:red;"></i></a>'+
															'</div>'+			
														'</div></div>';
