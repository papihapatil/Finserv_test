...
function Get_Total_no_of_sanction_letters()
  {
  ...
  function Get_sanction_letters($searchValue)
  {
  ...
  function Get_sanction_letters_With_Page($searchValue,$columnName,$columnSortOrder,$row,$rowperpage)
  {
         $this->db->select('*');
            $this->db->from('sanction_letter_values');
            $this->db->order_by("sanction_letter_values.ID", "desc");
  ...
  function get_area_managers_CM($id)
		...
		public function get_all_ntbvisit($id,$userType)
	{
		...
		public function current_month1($Start_Date,$End_Date,$id){
			...
			public function get_all_leadvisit($id,$userType)
	{
		    $this->db->select('count(*) as count ');
		...
		public function get_all_customers_Admin_filters2($id,$searchValue,$Start_Date,$End_Date)
			{
            $this->db->select('count(*) as count');
		 ...
		 public function get_all_customers_Admin_filter_paginations2($id,$searchValue,$columnName,$columnSortOrder,$row,$rowperpage,$Start_Date,$End_Date)
			{
              $this->db->select('*');
             $this->db->from('leadvisit');
			$this->db->where('RO_ID', $id);
		...
		public function current_month2($Start_Date,$End_Date,$id){
			...
			public function get_all_bureau($id,$Start_Date,$End_Date)
	{
		...
		public function get_all_customers_Admin_bureau($searchValue,$Start_Date,$End_Date,$id)
			{
            $this->db->select('count(*) as count');
           	$this->db->from('USER_DETAILS');
			$this->db->where('RO_ID', $id);
		...
		public function get_all_bureau1($id,$userType,$Start_Date,$End_Date)
	{
    ...
    return $row;
     ...
     public function get_address_by_mobileno($mobileno,$address)
	 {
		$response = array();
		$this->db->select('*');
		$this->db->where("MOBILE", $mobileno);
		$this->db->where("RES_ADDRS_LINE_1", $address);		
		$this->db->from('USER_DETAILS');
		$this->db->join('CUSTOMER_MORE_DETAILS','CUSTOMER_MORE_DETAILS.ID= USER_DETAILS.UNIQUE_CODE'); 
		$q = $this->db->get();
		$row = $q->row();
	    $executedQuery = $this->db->last_query();
		 print_r($executedQuery);
