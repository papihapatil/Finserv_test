					...
					<tr>
						...
						<td><?php if( $row['status']==''|| $row['status']==NULL)
							{?>
									...
									<a style="margin-left: 8px; " data-toggle="modal" data-id = "<?php echo $row['id'];?>" data-target="#deleteModel" class="btn btn-info modal_test <?php if($this->session->userdata('ID')!=$row['Lead_Assign_To']){echo 'disabled';} ?>">Change Contact Status</a>
							...
							<?php }  else if( $row['status']=='Hold'){?>
										  <a style="margin-left: 8px; " data-toggle="modal" data-id = "<?php echo $row['id'];?>" data-target="#deleteModel" class="btn btn-info modal_test disabled">Hold</a> 
										   <a style="margin-left: 8px;" data-toggle="modal" data-id = "<?php echo $row['id'];?>" data-target="#deleteModel" class="btn btn-info modal_test <?php if($this->session->userdata('ID')!=$row['Lead_Assign_To']){echo 'disabled';} ?> "> Convert to Customer</a>
							<?php } ?>
						</td>
					</tr>
				<?php $i++; }} ?>
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                ...
	                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/BranchManager/Change_Contact_Status" method="POST" id="change_contact_status">
