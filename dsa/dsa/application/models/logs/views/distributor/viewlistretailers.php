										   ...
										   <div class="">
											   <div class="row">
                                                   ...
                                                   <input type="text" hidden value="<?php echo $s;?>" id="filter">
													   ...
													   <select class="form-control" aria-label="Default select example" name="select_filters" id="select_dropdown_filters_retailer_distributor">
        ...
        $(document).ready(function(){
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
                    ...
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/Distributor/viewlistretailers",
					'data':{filter:filter},
                },  dom: 'Bfrtip',
        buttons: [
