	...
	<div class="margin-10 padding-5">
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  					<input  required placeholder="Enter product code *" class="input-cust-name" type="text" name="product_code" value="<?php echo $productcode; ?>" readonly >
  				</div> 
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  					<input  required placeholder="Enter product name *" class="input-cust-name" type="text" name="name" value="" minlength="6" maxlength="75">
  				</div>
  			...
  			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="w-100"></div>
  				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
  					...
  					<input  required placeholder="Enter interst rate per annum *" class="input-cust-name" type="text"  title="Please enter interest rate" name="interestrate" oninput="maxLengthCheck(this)" maxlength="10" value="">
  				</div> 
		...
		<!--<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">    
				...
				<span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-birthday-cake"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Tenure (Comma separated) *</span>
				</div>			
				<div class="w-100"></div>
				<div>
				
				&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; <input  required  max="" class="input-cust-name" type="text" name="tenure" id="tenure" value="" >
				<!--&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; <input type="checkbox" name="tenure2[]" value="7"> 7 &nbsp; &nbsp;<input type="checkbox" name="tenure2[]" value="15"> 15  &nbsp; &nbsp;<input type="checkbox" name="tenure2[]" value="30"> 30  &nbsp; &nbsp;<input type="checkbox" name="tenure2[]" value="45"> 45 
				</div>
        </div>-->
		<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				<div class="w-100"></div>
				...
				<div style="margin-top: 8px;" class="col">
				<span class="align-middle dot-light-theme"><i style="margin-top: 8px; font-size:11px;color:#25a6c6; text-align: center; width: 100%;" class="fa fa-birthday-cake"></i></span> <span style="color: black; font-size: 12px; margin-left: 8px;  font-weight: bold; ">Tenure (Comma separated) 7,14,15,21,28,30,45,60,90*</span>
				</div>			
				<div class="w-100"></div>
				<div style="margin-left: 35px;  margin-top: 8px;" class="col">
					<input  required   class="input-cust-name" type="text" name="tenure" id="tenure" value="" >
				</div>
        </div>
		<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
			...
			<div style="margin-top: 8px;" class="col">
			  ...
			  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="processing_fees_Type" style="display:none;">
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="processing_fees_amt" style="display:none;">
					...
					<div class="w-100"></div>
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
						<input   min="0" class="input-cust-name" type="number" name="proceesing_fees_in_amt" id="proceesing_fees_in_amt" value="" >
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="processing_fees_per" style="display:none;">
					...
					<div class="w-100"></div>
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
						<input   min="0.0001" max="100" class="input-cust-name" type="text" name="proceesing_fees_in_per" id="proceesing_fees_in_per" value="" >
					</div>
				</div>	
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="processing_fees_start_date" >
					...
					<div class="w-100"></div>
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
					<input  class="input-cust-name" type="date" name="start_date" id="start_date" required >
					</div>
				</div>	
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" id="processing_fees_End_date" >
					...
					<div class="w-100"></div>
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
					<input  class="input-cust-name" type="date" name="End_date" id="End_date" required >
					</div>
				</div>	
            </div>
...
<script type="text/javascript">
 ...
 $( "#tenure" ).change(function() 
 {
	 ...
	 const tenurearr = tenure.split(",");

	 
	 //alert(tenurearr[0]);
	 flag = true;
	 for (let i = 0; i < tenurearr.length; i++) {
		var days= tenurearr[i];
		...
		else if(days == 90)
		{
			...
			alert('Invalid tenure. Please insert correct tenure days.');
			return false;
		}
