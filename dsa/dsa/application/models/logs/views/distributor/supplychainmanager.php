									   ...
									   <div>
										   <div class="">
											   <div class="row">
												   ...
												   <div class="col-sm-3">
													   <lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Add Supply Chain Manager&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=supplychainmanager">
        ...
        $(document).ready(function(){
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
                    ...
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/distributor/listsupplychainmanager",
					'data':{filter:filter},
                },
