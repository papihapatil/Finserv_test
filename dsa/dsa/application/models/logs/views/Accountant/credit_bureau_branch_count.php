		                                    ...
		                                    <div >
    		                                    <div class="container">
			                                        <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <form id="credit_saction_form" action="<?= base_url('index.php/Accountant/credit_bureau_reports')?>" method="post">
...
<script>
    function get_idccr_DateFilter_Counts()
    {
               ...
               window.location.replace("/dsa/dsa/index.php/Accountant/credit_bureau_branch_count?B="+filter_branch_name+"&SD="+Start_Date+"&ED="+End_Date); 
    }
</script>
