                                                ...
                                                <div class="col-sm-12">
													<div >
        												<div class="">
															<div class="row">
																<div class="col-sm-3">
																	<lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Add Disbursement OPS User&nbsp;&nbsp;<a  href="<?php echo base_url()?>index.php/dsa/new_customer?type=Disbursement_OPS">
         ...
         $(document).ready(function(){
			...
			var location = document.getElementById("location").value;
             ...
             $('#empTable').DataTable({
                 ...
                 'ajax': {
                     //'url':'ajaxfile.php'
                     'url':window.location.origin+"/finserv_test/dsa/dsa/index.php/Admin/Disbursement_OPS_Pagination",
