...
<div >
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12 margin-top-15" style="margin-bottom: 20px;">
                	Filter By : 
                	...
                	<?php if($userType != 'NONE') { ?>
	                	<?php if($userType != 'DSA_CSR') { ?>
		                	...
		                	<a <?php if($s == 'all'){echo "class='dsa-filter-btn-active'";}else {echo "class='dsa-filter-btn-inactive'";}?> href="<?php echo base_url()?>index.php/admin/View_Lead?s=all" class="btn-dsa-new-customer">ALL </a>
...
<?php foreach($customers as $row){?>
	...
	<div class="row justify-content-center">
		...
		{?>
				...
				<a style="margin-left: -16px; margin-top:-10px;" data-toggle="modal" data-id = "<?php echo $row->id;?>" data-target="#deleteModel" class="btn btn-info modal_test">Change Contact Status</a>
		...
		<?php }  else if( $row->status=='Hold'){?>
					  ...
					  <a style="margin-left: 8px; margin-top:-10px;" data-toggle="modal" data-id = "<?php echo $row->id;?>" data-target="#deleteModel" class="btn btn-info modal_test "> Convert to Customer</a>
		<?php } else if( $row->status=='consent'){?>
			<a style="margin-left: 8px; margin-top:-10px;" data-toggle="modal" data-id = "<?php echo $row->id;?>" data-target="#deleteModel" class="btn btn-info modal_test disabled"> Convert to Customer with Consent</a>
