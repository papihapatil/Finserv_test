					...
					<div class="row">
								...
								<div class="card-body">
									<div class="row">
        								...
        								<div class="">
													...
													<?php if(isset($data))
										       {
												  ...
												  {  ?>
						  							<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right:0px;margin-right:0px;">
						   								<lable style=" padding: 7px;border:1px solid #ccc;font-weight:bold;">  Total <?php echo count($data); ?>&nbsp;&nbsp;<a href="<?=base_url('index.php/admin/download_Excel_user?data_for=DSA')?>">
						  					 ...
						  					 {?>
						   							<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right:0px;margin-right:0px;" >
						  							 <lable style=" padding: 7px;border:1px solid #ccc;font-weight:bold;">Total <?php echo count($data); ?>&nbsp;&nbsp;</lable>
				    	   						</div>
							<?php     } 
			            } 
						else
						{ ?>
							...
							<?php   }   ?>
												...
												<div class="col-sm-2" >
													<div class="add">
													<lable style=" padding: 7px;border:1px solid #ccc;font-weight:bold;">  Add DSA&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=dsa_rockers_agents_for_biss">
  	...
  	<div class="row">
		    ...
		    <div style=" margin-top: 8px;" class="col">
				  <label for="email" style="font-size: 16px; color: black; font-weight: bold;">Date Range</label>
					  <select class="form-control"  name="Admin_dsa_filter" id="Admin_dsa_filter">
		  ...
		  <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
			  <div style=" margin-top: 8px;" class="col">
			    <label for="email" style="font-size: 16px; color: black; font-weight: bold;">Start Date</label>
					<input  class="form-control Start_Date"  type="date" name="Start_Date" id="DSA_Start_Date_filter">
				</div>  
		  </div> 
		  <input type="text" hidden value="<?php if(isset($_GET['Start_Date'])){echo $_GET['Start_Date'];}?>" id="start_date1">
			<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
			  <div style=" margin-top: 8px;" class="col">
				...
				<input  class="form-control"  type="date" name="End_Date" id="DSA_End_Date_filter"  >
			  </div>  
			</div> 
			...
			<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
			  <div style=" margin-top: 8px;" class="col">
				    ...
				    <select class="form-control" aria-label="Default select example" name="select_filters" id="select_filters_admin_DSA">
				   	    <option>Select Filter</option>
						<option value="all" <?php if(isset($filter_by)){if($filter_by=='all'){echo 'selected';}} ?>>All DSA</option> 
		  ...
		  <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
		  	 <div style=" margin-top: 8px;" class="col">
				    ...
				    <select class="form-control" aria-label="Default select example" name="select_RO_Name" id="filters_by_ro_admin_DSA">
			 ...
			 <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
				    ...
				    <select class="form-control" aria-label="Default select example" name="select_location" id="filters_by_location_admin_DSA">
...
<script>
         ...
         $(document).ready(function(){
			...
			//alert(Reffered_by);
             $('#empTable').DataTable({
                 ...
                 'ajax': {
                     //'url':'ajaxfile.php'
                     'url':window.location.origin+"/finserv_test/dsa/dsa/index.php/Admin/customer_with_paginations_admin_DSA",
       ...
       var value=$("#Admin_dsa_filter").val();
      // alert(value);
...

		{
				...
				$('#DSA_Start_Date_filter').val(firstDay);
				$('#DSA_Start_Date_filter').prop('readonly', true);
				var lastDay =
				...
				$('#DSA_End_Date_filter').val(lastDay);
				$('#DSA_End_Date_filter').prop('readonly', true);
		}
		...
		if(value=='Select_Range')
		{
			...
			$('#DSA_Start_Date_filter').val(Start_Date);
			$('#DSA_End_Date_filter').val(End_Date);
