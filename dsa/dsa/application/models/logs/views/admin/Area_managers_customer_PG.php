...
<div class="c-body">
       ...
       $(document).ready(function(){
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
                    //'url':'ajaxfile.php'
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/admin/Area_managers_customer_PG",
					'data':{filter:filter,Start_Date:Start_Date,End_Date:End_Date,Reffered_by:Reffered_by,location:location,login_id:login_id},
                },
