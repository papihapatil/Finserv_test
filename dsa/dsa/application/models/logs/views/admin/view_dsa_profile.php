...
<form method="POST" action="" id="dsa_update_profile_one_new_action">
	<div class="margin-10 padding-5">
		...
		<div class="row shadow bg-white rounded margin-10 padding-15">
			<div class="row justify-content-center col-12">
				<span style="margin-top: 15px; font-size: 16px; color: black; font-weight: bold;">Personal Details</span>
