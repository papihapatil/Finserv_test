...
<div >
        <div class="container">
            <div class="row">
				...
				<a style="margin-left: 9px; background-color: #25a6c6;margin :2px;padding:6px;" href="<?php echo base_url()?>index.php/admin/new_admin_bank"  class="btn btn-info" style="background-color: #25a6c6;">Add New Document Type</a>
          	</div>
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                ...
	                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/admin/delete_admin_bank" method="POST" id="admin_bank_delete_form">
