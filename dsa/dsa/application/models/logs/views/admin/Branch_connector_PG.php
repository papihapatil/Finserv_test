												...
												<div class="row">
													...
													<div class="col-sm-1" style="text-align:right;padding-right:0px;margin-left:5%;">
													  ...
													  <div class="col-lg-2 col-md-2 col-lg-2 col-xs-2" >
														...
														<select class="form-control" aria-label="Default select example" name="select_filters" id="select_filters_connector_all_branch">
	   ...
	   <script>
        $(document).ready(function(){
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
                    //'url':'ajaxfile.php'
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/Admin/Branch_connector_PG",
					'data':{filter:filter},
                },
