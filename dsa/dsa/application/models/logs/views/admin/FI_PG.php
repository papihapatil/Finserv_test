...
<div >
        <div class="">
			<div class="row">
							...
							<lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Add FI &nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=FI">
         ...
         $(document).ready(function(){
             $('#empTable').DataTable({
                 ...
                 'ajax': {
                     //'url':'ajaxfile.php'
                     'url':
window.location.origin+"/finserv_test/dsa/dsa/index.php/Admin/customer_with_paginations_FI"
                 },
                 'columns': [
