...
<title>Finaleap | Relationship Officers List</title>
															...
															<div class="row">
																<?php if(isset($data))
						 										 ...
						 										 if(count($data) != 0) 
																	...
																	<div class="col-sm-2" >
																		<select class="form-control" aria-label="Default select example" id="select_dropdown_filters_relationship_officers_admin">
																			<option>Select Filter</option>
																			<option value="all">All Relationship Officers</option> 
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                ...
	                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/admin/delete_RelationshipOfficer" method="POST" id="change_contact_status">
