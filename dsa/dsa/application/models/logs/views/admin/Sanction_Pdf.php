...
<body style=" font-family:'Courier New';">
    ...
    <div class="row ">
		<div style="font-size: 15px;margin-top: -9px;text-align: center;font-family: 'Abel', sans-serif;" >
	...
	<table>
        <tbody>
          <tr>
            <td class="w-25 classtd_heading p_tag	" style="font-family: 'Abel', sans-serif">Application No</td>
            <td class="w-25 classtd_heading p_tag" style="font-family: 'Abel', sans-serif"><?php if(!empty($data_row_applied_loan)) { echo $data_row_applied_loan->Application_id ; }?></td>
            <td class="w-25 classtd_heading"></td>
            <div style="border:1px solid black;">
            <td class="w-25 classtd_heading p_tag" style="font-family: 'Abel', sans-serif;border:1px solid black;text-align: center;"><h5>Fees Paid are Non-Refundable<h5></td>
            </div>
          </tr>
          <tr>
            <td class="w-25 classtd_heading p_tag	" style="font-family: 'Abel', sans-serif">Date</td>
            <td class="w-25 classtd_heading p_tag" style="font-family: 'Abel', sans-serif"><?php if(!empty($Sanction_letter_details)) {/*echo $Sanction_letter_details->last_updated ;*/ 
            	echo $date = date("M j, Y", strtotime($Sanction_letter_details->last_updated));}?></td>
            <td class="w-25 "></td>
            	<td class="w-25 classtd_heading" style="color:white;font-family: 'Abel', sans-serif" ><h5>Fees Paid are Non-Refundable<h5></td>
          </tr>
        </tbody>
    </table>
	  ...
	  <table >
												    <tbody>
												      ...
												      <tr>
												      	...
												      	<td class="w-25 p_tag" style="font-family: 'Abel', sans-serif"><?php if($row->GENDER == 'male') echo "MR. "; else echo "Ms. ";?><?php if(!empty($row)) { if(!empty($row)) echo strtoupper($row->FN)." ".strtoupper($row->MN)." ".strtoupper($row->LN); }?></td>
												      ...
												      <?php
												      	...
												      	<td class="w-25 " style="font-family: 'Abel', sans-serif"><?php if($coapplicant->GENDER == 'male') echo "MR. "; else echo "Ms. ";?><?php if(!empty($coapplicant)) { if(!empty($coapplicant)) echo strtoupper($coapplicant->FN)." ".strtoupper($coapplicant->MN)." ".strtoupper($coapplicant->LN); }?></td>
												      	<td class="w-25 classtd_heading p_tag"></td>
												      	<td class="w-25 classtd_heading p_tag"></td>
												      </tr>
															<?php   $i++;
    ...
    <p class="p_tag" style="margin-top: -10px;" >&nbsp;&nbsp;&nbsp;&nbsp;With reference to the Loan Application submitted by you and are pleased to sanction the facility on ₹<?php if(!empty($Sanction_letter_details)) {echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",$Sanction_letter_details->total_loan_amount) ;} echo "( ".  ucfirst($first_value_result)." Only ) " ;?> , with the conditions given below</p>
  	                      <table class="table table-bordered p_tag" style="border:1px solid black;">
												    <tbody>
												      <tr style="border:1px solid black;">
												          <td class="classtd_heading " style="border:1px solid black;"><b> Nature Of Facility</b></td>
												          <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) {echo strtoupper($Sanction_letter_details->nature_of_facility) ;}?></td>
												      </tr>
												      <tr style="border:1px solid black;">
												        <td class="classtd_heading" style="border:1px solid black;"><b>Purpose Of Loan </b></td>
												        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) {echo $Sanction_letter_details->purpose_of_loan ;}?></td>
												     </tr>
												     <tr style="border:1px solid black;">
												        <td class="classtd_heading" style="border:1px solid black;"><b>Interest Type</b></td>
												        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) {echo $Sanction_letter_details->Interest_type ;}?></td>
												      </tr>
												      <tr style="border:1px solid black;">
												        <td class="classtd_heading" style="border:1px solid black;"><b>FFPL PLR</b></td>
												        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) {echo $Sanction_letter_details->ffpl_plr."%" ;}?></td>
												      </tr>
												       <tr style="border:1px solid black;">
												        <td class="classtd_heading" style="border:1px solid black;"> <b>Rate Of Interest</b></td>
												       ...
												       <tr style="border:1px solid black;">
												        <td class="classtd_heading" style="border:1px solid black;"><b>Loan Amount (INR)</b></td>
												        <td style="border:1px solid black;">
												        	<table class="table table-bordered" style="border:1px solid black;">
																<tbody>
																      <tr style="border:1px solid black;">
																        <td class="classtd_heading" style="border:1px solid black;"><b>Loan Amount</b></td>
																        <td class="classtd_heading" style="border:1px solid black;"><b>Cersai</b></td>
																        <td class="classtd_heading" style="border:1px solid black;"><b>Proprty Insurance</b></td>
																        <td class="classtd_heading" style="border:1px solid black;"><b>Credit Shield</b></td>
																        <td class="classtd_heading" style="border:1px solid black;"><b>Total Loan Amount</b></td>
																      </tr>
																       <tr style="border:1px solid black;">
																        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) {echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",($Sanction_letter_details->loan_amount)-1180) ;} else { echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",$data_row_applied_loan->DESIRED_LOAN_AMOUNT) ;}?></td>
																        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) {echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",1180) ;}?></td>
																        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) {echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",$Sanction_letter_details->property_insurance) ;}?></td>
																        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) {echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",$Sanction_letter_details->credit_shield) ;}?></td>
																        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) {echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",$Sanction_letter_details->total_loan_amount);}?></td>
																      </tr>
												        		</tbody>
												        	</table>
												        </td>
												        ...
												        <tr style="border:1px solid black;"> 
												        <td class="classtd_heading" style="border:1px solid black;"><b>Tenure (In Months)</b></td>
												        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) echo $Sanction_letter_details->tenure; ?></td>
												      </tr>
												       <tr style="border:1px solid black;">
												        <td class="classtd_heading" style="border:1px solid black;"><b>EMI (Equated Monthly Instalment) INR</b></td>
												        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",$Sanction_letter_details->EMI); ?></td>
												      </tr>
												       <tr style="border:1px solid black;">
												        <td class="classtd_heading" style="border:1px solid black;"><b>EMI Due Date</b></td>
												        <td style="border:1px solid black;"><?php if(!empty($get_all_values->value_1)) echo $get_all_values->value_1; //else if(!empty($Sanction_letter_details)) echo $Sanction_letter_details->Emi_due_date; ?></td>
												      </tr>
												       <tr style="border:1px solid black;">
												        <td class="classtd_heading" style="border:1px solid black;"><b>Total Processing Fees (Inclusive Of Gst) INR</b></td>
												        ...
												        <td style="border:1px solid black;">
												        	<?php 
		  														...
		  														$points = ($point) ?
		   														 "." . $words[$point / 10] . " " . 
		         												 $words[$point = $point % 10] : '';
												        	if(!empty($Sanction_letter_details)) { echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,",$Sanction_letter_details->processing_fees). "(".ucfirst($processing_fee_result)." only )" ;} ?>
												      </td>
												      </tr>
												     
												      <tr style="border:1px solid black;">
												        <td class="classtd_heading" style="border:1px solid black;"><b>Mortgaged property address</b></td>
												        <td style="border:1px solid black;"><?php  if(!empty($Sanction_letter_details)) {echo $Sanction_letter_details->property_address ;} ?></td>
												      </tr>
												      <tr>

												        <td class="classtd_heading" style="border:1px solid black;"><b>All Other Charges</b></td>
												        <td style="border:1px solid black;">
												          As per MITC
												        </td>
												      </tr>
												       ...
												       <tr style="border:1px solid black;">
												        <td class="classtd_heading" style="border:1px solid black;"><b>Repayment</b></td>
												        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) { echo $Sanction_letter_details->repayment;} else {echo "For Partially Disbursed Case: Pre-EMI will be charged from 1st Disbursement till Loan is not fully disbursed or up to 12 months from 1st disbursement date whichever earlier.
												      ...
												      <tr style="border:1px solid black;"> 
												        <td class="classtd_heading" style="border:1px solid black;"><b>Security </b></td>
												        <td style="border:1px solid black;"><?php if(!empty($Sanction_letter_details)) {echo $Sanction_letter_details->Security ;} else { echo "1st Charge by way of registered mortgage (in the form and manner as prescribed by FFPL)";}?></td>
												      </tr>
												      ...
												      <?php 
												       if(isset($getCustomerSanction_recommendation_details)) 
													   {
															if(!empty($getCustomerSanction_recommendation_details->sanction_conditions))
															{
																...
																<textarea   class="form-control p_tag" name="sanction_conditions" id="sanction_conditions" type="text" row="100"  style="height:200px;"><?php if(isset($getCustomerSanction_recommendation_details)) echo $getCustomerSanction_recommendation_details->sanction_conditions;?><?php if(isset($getCustomerSanction_recommendation_details)) echo $getCustomerSanction_recommendation_details->additional_sanction_conditions;?></textarea>
												       ...
												       if(isset($getCustomerSanction_recommendation_details)) 
													   {
															if(!empty($getCustomerSanction_recommendation_details->sanction_conditions))
															{
																...
																<textarea  name="legal_conditions" id="legal_conditions" type="text"row="100"  style="height:200px;"><?php if(isset($getCustomerSanction_recommendation_details)) echo $getCustomerSanction_recommendation_details->legal_conditions;?><?php if(isset($getCustomerSanction_recommendation_details)) echo $getCustomerSanction_recommendation_details->additional_legal_conditions;?></textarea>
				  		 										<?php
															}
													   }
...
In the event of a serious medical condition or poor results from your life insurance medical exam, there tends to be a rejection of the policy. In those circumstances, the loan facility may be cancelled.</p>
       	...
       	<b ><p class="classtd_heading">Customer Service: </p></b>
												...
												<table class="table table-bordered p_tag"style="border:1px solid black;">
												    <tbody>
												    	 <tr style="border:1px solid black;">
														<td style="border:1px solid black;">Customer care number</td>
														<td style="border:1px solid black;">+91-9511912883 / 91-20-29517282</td>
													  </tr>
												      <tr style="border:1px solid black;">
														<td style="border:1px solid black;">Official working hours</td>
														<td style="border:1px solid black;"><p>9.30 AM – 6.30 PM : Monday – Friday </p> <p>10.00 AM – 1.30 PM : Saturday (Except 2nd and 4th Saturday )</p> </td>
													  </tr>
	...
	<img  style="height: auto;" src="<?php echo base_url()?>images/sunil_sign.png" />
												  ...
												  <table class="table table-bordered	" style="border:1px solid black;">
												    <tbody>
												      ...
												      <td class="w-25 classtd_heading p_tag" style="border:1px solid black;"></td>
												      	<td class="classtd_heading p_tag" style="border:1px solid black;">Name</td>
												      	<td class="classtd_heading p_tag" style="border:1px solid black;">Signature</td>
												      	<td class="classtd_heading p_tag" style="border:1px solid black;">Date</td>
												      </tr>
												      <tr style="border:1px solid black;">
												      	<td class="w-25 classtd_heading p_tag" style="border:1px solid black;">APPLICANT</td>
												      	<td class="w-25 p_tag" style="border:1px solid black;"><?php if(!empty($row)) { if(!empty($row)) echo strtoupper($row->FN)." ".strtoupper($row->LN); }?></td>
												      	<td class="w-25 classtd_heading p_tag" style="border:1px solid black;"></td>
												      	<td class="w-25 classtd_heading p_tag" style="border:1px solid black;"></td>
												      </tr>
		  											 ...
		  											 <?php 
														 if(!empty($data_row_PD_details->Coapplicant_details_JSON))
														 {
															...
															foreach($reference_array as $value) 
															{
															  ...
															  ?>
															  			<tr style="border:1px solid black;">
						  								         		<td class="w-25 classtd_heading p_tag" style="border:1px solid black;">
						  								           	...
						  								           	<td class="w-25 p_tag" style="border:1px solid black;">
						  								          	...
						  								          	<td class="w-25 p_tag" style="border:1px solid black;"></td>
												      ...
												      <?php
												      	...
												      	<td class="w-25 p_tag" style="border:1px solid black;"><?php if(!empty($coapplicant)) { if(!empty($coapplicant)) echo strtoupper($coapplicant->FN)." ".strtoupper($coapplicant->LN); }?></td>
												      	<td class="w-25 classtd_heading p_tag"style="border:1px solid black;" ></td>
												      	<td class="w-25 classtd_heading p_tag" style="border:1px solid black;"></td>
												      </tr>
															<?php   $i++;
