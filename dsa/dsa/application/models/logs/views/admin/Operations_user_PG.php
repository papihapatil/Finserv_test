                                                ...
                                                <div class="col-sm-12">
													<div >
        												<div class="">
															<div class="row">
																<div class="col-sm-3">
																	<lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Add Operations User&nbsp;&nbsp;<a  href="<?php echo base_url()?>index.php/dsa/new_customer?type=Operations_user">
													...
													<div class="row">
														<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
		    												<div style=" margin-top: 8px;" class="col">
					 											...
					 											<select class="form-control"  name="Admin_operations_user_filter" id="Admin_operations_user_filter">
		  												...
		  												<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
			  												<div style=" margin-top: 8px;" class="col">
																...
																<input  class="form-control Start_Date"  type="date" name="Start_Date" id="operations_Start_Date_filter">
															</div>  
		  												</div> 
														...
														<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
			 												<div style=" margin-top: 8px;" class="col">
																...
																<input  class="form-control"  type="date" name="End_Date" id="operations_End_Date_filter"  >
			  												</div>  
														</div> 
														...
														<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
															<div style=" margin-top: 8px;" class="col">
			        											<label for="email" style="font-size: 16px; color: black; font-weight: bold;">Filter</label>
				    												<select class="form-control" aria-label="Default select example" name="select_filters" id="select_filters_admin_operations">
		    											...
		    											<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
			        											...
			        											<label for="email" style="font-size: 16px; color: black; font-weight: bold;">Location</label>
				    												<select class="form-control" aria-label="Default select example" name="select_location" id="filters_by_location_admin_operations">
				   	  													<option value="" >Select </option> 
																	    <?php
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                ...
	                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/admin/delete_Operational_user" method="POST" id="change_contact_status">
	                  <div class="form-group">
	                                <label  class="col-12 control-label padding-10">Are you sure you want to DELETE this Operational User ?</label>	                         
         ...
         $(document).ready(function(){
			...
			var location = document.getElementById("location").value;
             ...
             $('#empTable').DataTable({
                 ...
                 'ajax': {
                     //'url':'ajaxfile.php'
                     'url':window.location.origin+"/finserv_test/dsa/dsa/index.php/Admin/customer_with_paginations_Operation",
...
var value=$("#Admin_operations_user_filter").val();
      // alert(value);
		...
		if(value=='Select_Range')
		{
			...
			$('#operations_Start_Date_filter').val(Start_Date);
			$('#operations_End_Date_filter').val(End_Date);
