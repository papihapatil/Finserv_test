							 ...
							 $.ajax({
										...
										success:function(data)
										{
											...
											if(obj.msg=='success')
											{
											     ...
											     swal("success!", "Status added successfully", "success").then( function() {  window.location.replace("/finserv_test/dsa/dsa/index.php/Admin/Sanction_recommendations_admin?ID="+obj.customer_id+"&CM="+obj.CM_ID); });
