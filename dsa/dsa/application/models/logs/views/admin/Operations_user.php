															...
															<div class="row">
																<?php if(isset($data))
						 										 ...
						 										 if(count($data) != 0) 
																	...
																	<div class="col-sm-2" >
																		<select class="form-control" aria-label="Default select example" name="select_filters" id="select_dropdown_filters_OUsers_admin">
																			<option>Select Filter</option>
																			<option value="all">All Operations User</option> 
