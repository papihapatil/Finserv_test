<input hidden  type="text" name="login_id" id="login_id" value="<?php echo $login_id ;?>">
<div class="c-body">
<main class="c-main">
...
<div >
        												<div class="">
															<div class="row">
															<div class="col-sm-6" >
																	<!--	<lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;">  Add Relationship Officer Manager&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/dsa/new_customer?type=Relationship_Officer">
	...
	<div class="row">
		    ...
		    <div style=" margin-top: 8px;" class="col">
				  <label for="email" style="font-size: 16px; color: black; font-weight: bold;">Date Range</label>
					  <select class="form-control"  name="Admin_BM_filter" id="Admin_BM_filter">
		  ...
		  <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
			  <div style=" margin-top: 8px;" class="col">
			    <label for="email" style="font-size: 16px; color: black; font-weight: bold;">Start Date</label>
					<input  class="form-control Start_Date"  type="date" name="Start_Date" id="BM_Start_Date_filter">
				</div>  
		  </div> 
		  <input type="text" hidden value="<?php if(isset($_GET['Start_Date'])){echo $_GET['Start_Date'];}?>" id="start_date1">
			<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
			  <div style=" margin-top: 8px;" class="col">
				...
				<input  class="form-control"  type="date" name="End_Date" id="BM_End_Date_filter"  >
			  </div>  
			</div> 
			...
			<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
			  <div style=" margin-top: 8px;" class="col">
				    ...
				    <select class="form-control" aria-label="Default select example" name="select_filters" id="select_filters_admin_BM">
		    ...
		    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
				    ...
				    <select class="form-control" aria-label="Default select example" name="select_location" id="filters_by_location_admin_BM">
         ...
         $(document).ready(function(){
			...
			var location = document.getElementById("location").value;
             ...
             $('#empTable').DataTable({
                 ...
                 'ajax': {
                     //'url':'ajaxfile.php'
                     'url':window.location.origin+"/finserv_test/dsa/dsa/index.php/Admin/Area_managers_RO_PG",
					 'data':{filter:filter,Start_Date:Start_Date,End_Date:End_Date,location:location,login_id:login_id},
   ...
   var value=$("#Admin_BM_filter").val();
      // alert(value);
...

		{
				...
				$('#BM_Start_Date_filter').val(firstDay);
				$('#BM_Start_Date_filter').prop('readonly', true);
				var lastDay =
				...
				$('#BM_End_Date_filter').val(lastDay);
				$('#BM_End_Date_filter').prop('readonly', true);
		}
		...
		if(value=='Select_Range')
		{
			...
			$('#BM_Start_Date_filter').val(Start_Date);
			$('#BM_End_Date_filter').val(End_Date);
