...
<div class="c-body">
       ...
       $(document).ready(function(){
		   var Start_Date=document.getElementById("start_date1").value;
            ...
            $('#empTable').DataTable({
                ...
                'ajax': {
                    //'url':'ajaxfile.php'
                    'url': window.location.origin+"/finserv_test/dsa/dsa/index.php/Relationship_Officer/Todayexisting_sourings",
		  ...
		  $( "#Start_Date_filters" ).change(function()
      {
       ...
       var range=$('#Billing_months').val();
         ...
         window.location.replace("/finserv_test/dsa/dsa/index.php/Relationship_Officer/Todayexisting_souring?Start_Date="+Start_Date+"&End_Date="+End_Date+"&range="+range);
  ...
  
      {
        ...
        var el_down = document.getElementById("Start_Date");
          ...
          //$('#End_Date').prop('readonly', true);
                  window.location.replace("/finserv_test/dsa/dsa/index.php/Relationship_Officer/Todayexisting_souring?Start_Date="+firstDay+"&End_Date="+lastDay+"&range="+range);
      }
      if(value=='Previous_Month')
