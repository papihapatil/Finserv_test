										...
										<div>
        									<div class="">
												...
												<div class="col-sm-5" style="padding-left:0px;">
																	...
																	<lable style=" padding: 10px;border:1px solid #ccc;font-weight:bold;"> Rejected Customers &nbsp;&nbsp;
						   												</lable></a>
																	</div>
													<?php if(isset($data))	{
						 											if(count($data) != 0) 
...
<script type="text/javascript">
   ...
   var select_dropdown_filters_HR_admin = document.getElementById('select_dropdown_filters_HR_admin').value;
       // alert(select_dropdown_filters_HR_admin);
		   ...
		   {
	         window.location.replace("/finaleap_finserv/dsa/dsa/index.php/admin/HR?s=all");
		   }
		   else if(select_dropdown_filters_HR_admin == 'Complete')
		   {
			       window.location.replace("/finaleap_finserv/dsa/dsa/index.php/admin/HR?s=Complete");
		   }
		   else if((select_dropdown_filters_HR_admin == 'Incomplete'))
		   {
			       window.location.replace("/finaleap_finserv/dsa/dsa/index.php/admin/HR?s=Incomplete");
         ...
         $(document).ready(function(){
             $('#empTable').DataTable({
                 ...
                 'ajax': {
                     //'url':'ajaxfile.php'
                     'url':
window.location.origin+"/finaleap_finserv/dsa/dsa/index.php/Admin/customer_with_paginations_Rejected_customers"
                 },
                 'columns': [
