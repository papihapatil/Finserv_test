...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
	...
	<form  action="<?= base_url('index.php/credit_manager_user/save_fi')?>" method="post" enctype="multipart/form-data">
	  	<div class="row">
					...
					<?php if(isset($data_row_file_path->fi_file_name))
						...
						?>
					     ...
					     ?>
							 ...
							 <input  readonly  type="file" class="form-control" name="file"  placeholder="">select file
						 <?php }
						 ?></div>
			</div>
			<div class="col-sm-4"></div>
