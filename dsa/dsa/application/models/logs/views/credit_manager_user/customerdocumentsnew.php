				...
				<div class="row" style="margin: 5px;">
					...
					<div class="row col-12 justify-content-center">
						<div class="row" style="margin-left:0px;margin-bottom:6px;">
							...
							<label class='doctype'>Employment/Business Proof<?php if($doc_type=='business' || $doc_type=='employment' )if(empty($save)){?> <spna style="margin-left:3px;padding-left:2px;padding-right:2px;"class="fullCircle"><i class="fa fa-cloud-upload" style="color:green;"></spna></i><?php } else if($doc_type=='business' || $doc_type=='employment' || $doc_count ==4 ){ ?><spna style="margin-left:3px;padding-left:2px;padding-right:2px;"class="fullCircle"><i class="fa fa-check" style="color:green;"></spna></i><?php }?></label>
										...
										<div class="row col-12 justify-content-center">
											<div>
												<a href="<?php echo base_url()?>index.php/customer/customer_edit_profile_2_income?type=salaried">
													...
													<div class="row col-12 justify-content-center">
														<div>
															<a href="<?php echo base_url()?>index.php/customer/Loan_application_fees?coapp_id=<?php if(!empty($coapp_id))echo $coapp_id?>&UID=<?php if(!empty($data_row)){echo $data_row->UNIQUE_CODE; } ?>">
												...
												success:function(data){
													...
													$.each(data, function(a,b){
														...
														select.append("<option value=" ">Select</option>"+
															"<option value="+b.DOC_NAME+">"+b.DOC_NAME+"</option>");
