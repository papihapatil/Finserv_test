			...
			<div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
						...
						<div class="w-100"></div>
						<div style="margin-left: 35px;  margin-top: 8px;" class="col">
							<input   class="input-cust-name" type="date" name="Date_of_Agreement"  value="<?php if(!empty($row_more)){ if($row_more->Date_of_Agreement){ echo $row_more->Date_of_Agreement;}}?>">
						</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
					<div style="margin-left: 35px;  margin-top: 8px;" class="col">
