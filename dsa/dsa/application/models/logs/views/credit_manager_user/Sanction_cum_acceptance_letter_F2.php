	    	...
	    	<div class="row  shadow bg-white rounded margin-10 padding-15" id="border_style">
					<div class="wizard-form" >
						<div class="wizard-header"style="padding:20px;">
							...
							<form class="form-register" action="<?php echo base_url()?>index.php/credit_manager_user/submit_sanction_letter_form_two" method="post">
		        	  	<input type="text" name="customer_id" id="customer_id"  value="<?php echo $row->UNIQUE_CODE;?>" hidden>
                 			...
                 			<div class="row shadow bg-white rounded margin-10 padding-15 " style="padding:25px;" >
				            		...
				            		?>
										...
										<!----------------------------------------------------------------------------------------------------------------------- -->
											<div class="col-sm-12">	
												...
												<textarea  readonly class="form-control p_tag"  row="100"  style="height:200px;"><?php if(isset($getCustomerSanction_recommendation_details)) echo $getCustomerSanction_recommendation_details->sanction_conditions;?></textarea>
				  		                     </div> 
                                            <div class="col-sm-12">		
												<h4 style="font-weight:800"><b>Approved	Legal Conditions	</b></h4><hr>								 
											    <textarea readonly class="form-control p_tag" row="100"  style="height:200px;"><?php if(isset($getCustomerSanction_recommendation_details)) echo $getCustomerSanction_recommendation_details->legal_conditions;?></textarea>
											</div>
											...
											<div class="col-sm-12">
													...
													if(!empty($Conditions_to_Loan_Sanction_JSON->second_condition)) { echo $Conditions_to_Loan_Sanction_JSON->second_condition ;} else { echo "2. Registered Mortgage of property no –". $data_row_applied_loan->PROP_ADD_LINE_1." ".$data_row_applied_loan->PROP_ADD_LINE_2." ".$data_row_applied_loan->PROP_ADD_LINE_3." in favor of Finaleap Finserv Pvt Ltd ( FFPL )"; } ?>" style="font-size: 18px;"></p>
														<?php
                                ...
                                <table class="table table-bordered" id="data_table3">
												...
												<!--		<p><input type="text" class="form-control" id="sixth_condition" name="sixth_condition" value="<?php 
													if(!empty($Conditions_to_Loan_Sanction_JSON->sixth_condition)) { echo $Conditions_to_Loan_Sanction_JSON->sixth_condition ;} ?>" style="font-size: 18px;"></p>-->
...
<?php
 ...
 if( !empty($Sanction_letter_details->admin_comments))
 {
														...
														if(!empty($Sanction_letter_details))
														{
																...
																if($Sanction_letter_details->Letter_ID!=="")
																{
																	...
																	<div class="col-sm-12" style="">
																		...
																		<a class="dropdown-item" href="<?php echo base_url()?>index.php/credit_manager_user/Sanction_cum_acceptance_letter?ID=<?php echo $row->UNIQUE_CODE;?>&CM=<?php echo $CM_ID;?>"><button class="login100-form-btn" style="font-weight:700;background-color:#3760e5;color:white;padding:15px;padding-left:55px;padding-right:55px;border-radius:25px;border:none;">Approved by Admin </button></a>
