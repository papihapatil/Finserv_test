...
<div class="card p-4">
<form id="forgot_verify_otp_form" class="login100-form validate-form" action="<?php echo base_url()?>index.php/forgotpassword/verify_otp_action" method="POST">
	<div class="card-body">
	<h1>Verify OTP</h1>
	<p class="text-muted">enter OTP here</p>
