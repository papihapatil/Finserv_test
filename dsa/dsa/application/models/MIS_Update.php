  ...
  <div class="tab-content">
            ...
            <div class="row">
					...
					<div class="col-md-4 form-group mt-3 mt-md-0">
                        <label class="exampleFormControlFile1">Pincode&nbsp;</label><small style="color:red">*</small>
                         <input type="text"class="form-control " placeholder="" id="pincode" required  name="pincode"> 
                    </div>
					<div class="col-md-4 form-group mt-3 mt-md-0">
                        <label class="exampleFormControlFile1">City&nbsp;</label><small style="color:red">*</small>
                        <input type="text" class="form-control " placeholder="" id="city" required  name="city"> 
                    </div>
            </div>
            <div class="row">
                    <div class="col-md-6 form-group mt-3 mt-md-0">
	...
	<form action="<?php echo base_url('index.php/Relationship_Officer/Ntbform');?>" method="POST">
            ...
            <div class="row">
             ...
             <div class="row">
					...
					<div class="col-md-4 form-group mt-3 mt-md-0">
                        <label class="exampleFormControlFile1">Pincode&nbsp;</label><small style="color:red">*</small>
                         <input type="text"class="form-control " placeholder="" id="pincode1" required  name="pincode"> 
                    </div>
					<div class="col-md-4 form-group mt-3 mt-md-0">
                        <label class="exampleFormControlFile1">City&nbsp;</label><small style="color:red">*</small>
                        <input type="text" class="form-control " placeholder="" id="city1" required  name="city"> 
                    </div>
            </div>
	...
	<form action="<?php echo base_url('index.php/Relationship_Officer/Existingform');?>" method="POST">
            ...
            <div class="row">
                  ...
                  <div class="col-md-6 form-group mt-3 mt-md-0">
                        <label class="exampleFormControlFile1">Customer Name&nbsp;</label><small style="color:red">*</small>
                        <input type="text" class="form-control " placeholder="" required id="name" pattern="^[a-zA-Z][\sa-zA-Z]*" minlength="3"  name="exit_name"> 
                  </div>
           ...
           <div class="row">
                 ...
                 <div class="col-md-12 form-group mt-3 mt-md-0">
                    <label class="exampleFormControlFile1">Address of Meeting&nbsp;</label><small style="color:red">*</small>
                    <textarea class="form-control " placeholder="" required id="äddress" name="exit_add"> </textarea>
                  </div>
	...
	<form action="<?php echo base_url('index.php/Relationship_Officer/Leadform');?>" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group mt-3 mt-md-0">
                <label class="exampleFormControlFile1" >Area of Lead&nbsp;</label><small style="color:red">*</small>
